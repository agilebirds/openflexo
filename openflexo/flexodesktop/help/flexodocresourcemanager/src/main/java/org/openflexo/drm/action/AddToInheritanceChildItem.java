...
public class AddToInheritanceChildItem extends FlexoAction 
{
    ...
    public static FlexoActionType actionType = new FlexoActionType ("add_inheritance_child",FlexoActionType.newMenu,FlexoActionType.defaultGroup,FlexoActionType.ADD_ACTION_TYPE) {
    ...
    AddToInheritanceChildItem (FlexoModelObject focusedObject, Vector globalSelection, FlexoEditor editor)
    {
