...
/**
 * Utility class containing all icons used in context of all generation module
 * (common resources for code, source and doc generators)
 * 
 * @author sylvain
 *
 */
public class GeneratorIconLibrary extends IconLibrary {
	...
	public static final ImageIcon INTERESTING_FILES_VIEW_MODE_ICON = new ImageIconResource("Icons/Generator/ViewMode/InterestingFilesViewMode.gif");
	public static final ImageIcon GENERATION_MODIFIED_VIEW_MODE_ICON = new ImageIconResource("Icons/Generator/ViewMode/GenerationModifiedViewMode.gif");
	...
	public static final ImageIcon CONFLICTING_FILES_VIEW_MODE_ICON = new ImageIconResource("Icons/Generator/ViewMode/ConflictingFilesViewMode.gif");
	public static final ImageIcon NEED_REINJECTING_VIEW_MODE_ICON = new ImageIconResource("Icons/Generator/ViewMode/NeedReinjectingViewMode.gif");
	public static final ImageIcon GENERATION_ERROR_VIEW_MODE_ICON = new ImageIconResource("Icons/Generator/ViewMode/GenerationErrorViewMode.gif");
	...
	public static final ImageIcon WRITE_TO_DISK_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/WriteToDiskIcon-disabled.gif");
	...
	public static final ImageIcon DISMISS_UNCHANGED_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/DismissUnchangedIcon-disabled.gif");
	public static final ImageIcon ACCEPT_FROM_DISK_ICON = new ImageIconResource("Icons/Generator/Actions/AcceptFromDiskIcon.gif");
	public static final ImageIcon ACCEPT_FROM_DISK_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/AcceptFromDiskIcon-disabled.gif");
	...
	public static final ImageIcon ACCEPT_AND_REINJECT_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/AcceptAndReinjectIcon-disabled.gif");
	...
	public static final ImageIcon REINJECT_IN_MODEL_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/ReinjectInModelIcon-disabled.gif");
	...
	public static final ImageIcon IMPORT_IN_MODEL_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/ImportInModelIcon-disabled.gif");
	public static final ImageIcon SYNCHRONIZE_CODE_GENERATION_ICON = new ImageIconResource("Icons/Generator/Actions/SynchronizeCodeGenerationIcon.gif");
	...
	public static final ImageIcon GENERATE_CODE_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/GenerateCodeIcon-disabled.gif");
	...
	public static final ImageIcon FORCE_REGENERATE_CODE_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/ForceRegenerateCodeIcon-disabled.gif");
	public static final ImageIcon MARK_AS_MERGED_ICON = new ImageIconResource("Icons/Generator/Actions/MarkAsMergedIcon.gif");
	public static final ImageIcon MARK_AS_MERGED_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/MarkAsMergedIcon-disabled.gif");
	...
	public static final ImageIcon REGISTER_NEW_CG_RELEASE_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/RegisterNewReleaseIcon-disabled.gif");
	public static final ImageIcon REVERT_REPOSITORY_TO_VERSION_ICON = new ImageIconResource("Icons/Generator/Actions/RevertRepositoryToVersionIcon.gif");
	public static final ImageIcon REVERT_REPOSITORY_TO_VERSION_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/RevertRepositoryToVersionIcon-disabled.gif");
	public static final ImageIcon REVERT_TO_HISTORY_VERSION_ICON = new ImageIconResource("Icons/Generator/Actions/RevertToHistoryVersionIcon.gif");
	public static final ImageIcon REVERT_TO_HISTORY_VERSION_DISABLED_ICON = new ImageIconResource("Icons/Generator/Actions/RevertToHistoryVersionIcon-disabled.gif");
