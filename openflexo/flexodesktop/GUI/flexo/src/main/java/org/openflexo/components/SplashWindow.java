...
public class SplashWindow extends JWindow {
    ...
    public SplashWindow(Frame f, UserType userType, int waitTime) {
		...
		JLabel urlLabel = new JLabel("<html><u>www.flexoBPM.com</u></html>", SwingConstants.RIGHT);
        urlLabel.addMouseListener(new MouseAdapter() {
            ...
            {
                ToolBox.openURL("http://www.flexoBPM.com");
            }
        });
		...
		JLabel copyrightLabel = new JLabel("(c) Copyright Agile Birds sprl, 2010, all rights reserved", SwingConstants.RIGHT);
