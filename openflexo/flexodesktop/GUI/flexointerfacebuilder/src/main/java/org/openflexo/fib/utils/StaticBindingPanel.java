...
class StaticBindingPanel extends JPanel
{
				...
				selectValueCB.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (selectValueCB.getSelectedItem().equals(TRUE))
							_bindingSelectorPanel._bindingSelector.setEditedObject(new BooleanStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),true));
						else if (selectValueCB.getSelectedItem().equals(FALSE))
							_bindingSelectorPanel._bindingSelector.setEditedObject(new BooleanStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),false));
					}
				});
				add(selectValueCB);
			}
				...
				integerValueChooser.addChangeListener(new ChangeListener() {
					...
					public void stateChanged(ChangeEvent e)
					{
						...
						if (v instanceof Integer)
							_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),(Integer)v));
						else if (v instanceof Long)
							_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),(Long)v));
						else if (v instanceof Short)
							_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),(Short)v));
						else if (v instanceof Byte)
							_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),(Byte)v));
						else if (v instanceof Character)
							_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),(Character)v));
					}
				});
			...
			typeCB.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (typeCB.getSelectedItem().equals(BOOLEAN))
						...
						_bindingSelectorPanel._bindingSelector.setEditedObject(new IntegerStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),0));
					else if (typeCB.getSelectedItem().equals(FLOAT))
						_bindingSelectorPanel._bindingSelector.setEditedObject(new FloatStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),0));
					else if (typeCB.getSelectedItem().equals(STRING))
						_bindingSelectorPanel._bindingSelector.setEditedObject(new StringStaticBinding(_bindingSelectorPanel._bindingSelector.getBindingDefinition(),_bindingSelectorPanel._bindingSelector.getBindable(),""));
				}
			});
			if (typeCB != null) {
	...
	private EvaluationType kindOf(Type type)
	{
		...
		else return TypeUtils.kindOfType(type);
	}
