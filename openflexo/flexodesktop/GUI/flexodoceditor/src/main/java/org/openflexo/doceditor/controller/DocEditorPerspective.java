...
public class DocEditorPerspective extends FlexoPerspective<TOCObject>
 {
	...
	public ImageIcon getSelectedIcon()
	 ...
	 {
		 if ((proposedObject instanceof TOCObject) 
				 && hasModuleViewForObject(proposedObject)) {
	 ...
	 {
		 return ((object instanceof TOCEntry)
				 || (object instanceof TOCRepository)
				 || (object instanceof TOCData));
	 }
