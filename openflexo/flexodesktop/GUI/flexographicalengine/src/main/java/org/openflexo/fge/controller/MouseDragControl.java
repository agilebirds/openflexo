...
public class MouseDragControl extends MouseControl
{
	...
	public MouseDragControl(String aName, MouseButton button, boolean shiftPressed, boolean ctrlPressed, boolean metaPressed, boolean altPressed) 
	{
	...
	public MouseDragControl(String aName, MouseButton button, MouseDragControlAction action, boolean shiftPressed, boolean ctrlPressed, boolean metaPressed, boolean altPressed) 
	{
		this(aName,button,shiftPressed,ctrlPressed,metaPressed,altPressed);
		this.action = action;
	}
	
	public MouseDragControl(String aName, MouseButton button, MouseDragControlActionType actionType, boolean shiftPressed, boolean ctrlPressed, boolean metaPressed, boolean altPressed) 
	{
		this(aName,button,shiftPressed,ctrlPressed,metaPressed,altPressed);
	...
	public MouseDragControlActionType getActionType()
	{
		...
		else return MouseDragControlActionType.NONE;
	}
	...
	public void setActionType(MouseDragControlActionType actionType)
	{
		...
		else action = MouseDragControlActionType.NONE.makeAction();
	}
