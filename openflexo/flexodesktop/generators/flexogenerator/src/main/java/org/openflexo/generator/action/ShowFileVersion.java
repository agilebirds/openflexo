...
public class ShowFileVersion extends FlexoGUIAction<ShowFileVersion,CGFile,CGObject>
{
    ...
    public static class ShowFileVersionActionType extends FlexoActionType<ShowFileVersion,CGFile,CGObject>
    {
        ...
        protected ShowFileVersionActionType (
        		String actionName, ContentSourceType source)
        {
        ...
        {
            if (!isVisibleForSelection(file,globalSelection)) return false;
            if (_source == ContentSourceType.PureGeneration) {
            	...
            	return (file.getRepository().getManageHistory() 
            			&& file.getResource().isLoaded()
    ...
    public static final ShowFileVersionActionType showPureGeneration = new ShowFileVersionActionType("pure_generation",ContentSourceType.PureGeneration);
    public static final ShowFileVersionActionType showGeneratedMerge = new ShowFileVersionActionType("generated_merge",ContentSourceType.GeneratedMerge);
    public static final ShowFileVersionActionType showContentOnDisk = new ShowFileVersionActionType("content_on_disk",ContentSourceType.ContentOnDisk);
    public static final ShowFileVersionActionType showResultFileMerge = new ShowFileVersionActionType("result_file_merge",ContentSourceType.ResultFileMerge);
    public static final ShowFileVersionActionType showLastGenerated = new ShowFileVersionActionType("last_generated_version",ContentSourceType.LastGenerated);
    public static final ShowFileVersionActionType showLastAccepted = new ShowFileVersionActionType("last_accepted_version",ContentSourceType.LastAccepted);
    public static final ShowFileVersionActionType showHistoryVersion = new ShowFileVersionActionType("history_version",ContentSourceType.HistoryVersion);
