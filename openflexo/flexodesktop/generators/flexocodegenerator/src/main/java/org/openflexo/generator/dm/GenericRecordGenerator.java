...
public class GenericRecordGenerator extends JavaClassGenerator
{
	...
	public VelocityContext defaultContext()
    {
        ...
        else context.put("primaryKeyAttributeName","<undefined>");
	...
	{
		// Java file
    	javaResource  = (EOEntityJavaFileResource)resourceForKeyWithCGFile(ResourceType.JAVA_FILE, GeneratorUtils.nameForRepositoryAndIdentifier(repository, getIdentifier()));
