...
public class ReinjectInModel extends MultipleFileGCAction<ReinjectInModel>
{
	...
	public static final MultipleFileGCActionType<ReinjectInModel> actionType 
	= new MultipleFileGCActionType<ReinjectInModel> ("reinject_in_model",
	...
	protected void doAction(Object context) throws GenerationException, SaveResourceException, FlexoException
    {
    	...
    	makeFlexoProgress(FlexoLocalization.localizedForKey("reinjecting_in_model") +  " "
    			+ getFilesToReinjectInModel().size() + " "
