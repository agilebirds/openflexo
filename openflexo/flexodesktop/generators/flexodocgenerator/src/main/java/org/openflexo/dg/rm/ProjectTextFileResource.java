 ...
 * 
 */
public class ProjectTextFileResource extends TextFileResource<DGTextGenerator<FlexoProject>,DGTextFile> implements GenerationAvailableFileResource, FlexoObserver
{
    ...
    {
    	return repository.getName()+".PROJECT_TEXT."+project.getProjectName();
    }
    ...
    public boolean needsMemoryGeneration() {
    	...
    	return super.needsMemoryGeneration();
    }
}
