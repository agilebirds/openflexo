	...
	public void update(FlexoObservable observable, DataModification dataModification)
	{
		if (observable == getProcess()) {
			if (dataModification instanceof AttributeDataModification) {
				if (((AttributeDataModification)dataModification).getAttributeName().equals("name") && !getCGFile().getFileName().equals(DGJSGenerator.nameForProcess(getProcess(), getGenerator().getRepository()))) {
