...
public class ShareProject extends CVSAction<ShareProject,FPSObject> 
{
    ...
    public static FlexoActionType<ShareProject,FPSObject,FPSObject> actionType 
    = new FlexoActionType<ShareProject,FPSObject,FPSObject> 
	...
	protected void doAction(Object context) throws FlexoAuthentificationException
    {
    	...
    	try {
    		_newProject = SharedProject.shareProject(
    				getRepositoryList(getFocusedObject()), 
    				getProjectDirectory(), 
       				getRepository(),
       				getModuleName(),
    				getVendorTag(),
	...
	{
		if (_logMessage == null) _logMessage = FlexoLocalization.localizedForKey("project_shared_on")+" "+new Date();
		return _logMessage;
	}
	...
	{
		if (_releaseTag == null) _releaseTag = "start";
		return _releaseTag;
	}
	...
	{
		if (_vendorTag == null) _vendorTag = System.getProperty("user.name");
		return _vendorTag;
	}
	...
	public void setRemoveExistingCVSDirectories(
			boolean removeExistingCVSDirectories) 
	{
