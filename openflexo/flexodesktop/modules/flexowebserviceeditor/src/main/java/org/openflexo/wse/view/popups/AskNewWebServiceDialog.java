...
public class AskNewWebServiceDialog extends FlexoDialog implements ActionListener
{
    ...
    public static final File EXTERNAL_REPOSITORY_ICON_FILE = new FileResource(
            "Resources/DM/SmallExternalRepository.gif");

    public static final File DM_REPOSITORY_ICON_FILE = new FileResource(
            "Resources/DM/SmallRepository.gif");

    public static final File DM_EOREPOSITORY_ICON_FILE = new FileResource(
            "Resources/DM/SmallEORepository.gif");
    ...
    public AskNewWebServiceDialog(CreateNewWebService flexoAction, Frame owner)
    {
        ...
        externalWSButton = new JRadioButtonWithIcon(FlexoLocalization
                .localizedForKey("ws_external_webservice"), DM_REPOSITORY_ICON_FILE, true);
        externalWSButton.addActionListener(this);
        externalWSButton.setActionCommand(CreateNewWebService.EXTERNAL_WS);

        internalWSButton = new JRadioButtonWithIcon(FlexoLocalization
                .localizedForKey("ws_internal_webservice"), DM_REPOSITORY_ICON_FILE);
        internalWSButton.addActionListener(this);
        internalWSButton
                .setActionCommand(CreateNewWebService.INTERNAL_WS);
    ...
    protected void selectWebServiceType(String wsType)
    {
        ...
        if (wsType.equals(CreateNewWebService.INTERNAL_WS)) {
            webserviceDescriptionTA.setText(FlexoLocalization
    ...
    protected boolean checkWebServiceOKForCreation()
    {
        ...
        if (_flexoAction.getProject().getFlexoWSLibrary().getWSServiceNamed(newWebServiceName) != null) {
            FlexoController.showError(FlexoLocalization
                    .localizedForKey("wsgroup_already_registered"));
            return false;
        }
        if (currentChoice.equals(CreateNewWebService.EXTERNAL_WS)) {
            ...
            if (newWSDLFile != null) {
                ...
                FlexoController.showError(FlexoLocalization
                        .localizedForKey("please_supply_a_valid_wsdl_file"));
                return false;
            }
    ...
    public static int displayDialog(CreateNewWebService flexoAction, FlexoProject project,
            Frame owner)
    {
