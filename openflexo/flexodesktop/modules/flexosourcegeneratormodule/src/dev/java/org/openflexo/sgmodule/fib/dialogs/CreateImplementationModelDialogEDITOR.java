...
public class CreateImplementationModelDialogEDITOR extends ProjectDialogEDITOR {
	...
	public static void main(String[] args)
	{
		FIBAbstractEditor editor = new FIBAbstractEditor() {
			public Object[] getData() 
			{
				...
				CreateImplementationModel action = CreateImplementationModel.actionType.makeNewAction(project.getGeneratedSources(), null,editor);
				return makeArray(action);
			}
			public File getFIBFile() {
				return SGCst.CREATE_IMPLEMENTATION_MODEL_DIALOG_FIB;
			}
		};
		editor.launch();
	}
