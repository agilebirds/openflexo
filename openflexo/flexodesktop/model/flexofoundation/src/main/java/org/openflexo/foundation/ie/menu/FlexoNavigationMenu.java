...
*/
     ...
     * object is contained relating to storing scheme: here it's the
	...
	public String getUserProfilePageName() {
		if(getUserProfileOperation()==null || getUserProfileOperation().getComponentInstance()==null)return null;
	   ...
	   public OperationNode getUserProfileOperation()
	    ...
	    public Hashtable<IEObject, Hashtable<String,String>> getLocalizableObjects(){
	    	...
	    	while (en.hasMoreElements()) {
				...
				if(props!=null)reply.put(menu, props);
			}
	    	return reply;
	    }
