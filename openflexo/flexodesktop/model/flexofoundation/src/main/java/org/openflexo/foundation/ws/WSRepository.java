...
public class WSRepository extends WSObject implements FlexoObserver
	{
	    ...
	    private static final Logger logger = FlexoLogger.getLogger(WSRepository.class.getPackage()
	            .getName());
	    ...
	    /**
	     * deletes the WSRepository BUT do not delete the underlying WSDLRepository.
	     * it is the wsgroup's responsibility to decide wheither the WSDLRepository
	     * should be deleted.
	     */
	    @Override
		public void delete(){
	    	if (logger.isLoggable(Level.FINE)) logger.fine("delete: WSRepository "+getName());
