...
public interface StorageResourceData extends FlexoResourceData {
    ...
    /**
     * Save the resource related to this object (save the object) using RM
     * scheme
     * 
    ...
    /**
     * Return a boolean indicating if resource related to this object is
     * modified
     * 
     * @return
     */
     ...
     *      resource, in order that the ResourceManager handles and propagates
     *      this notification
     * 
