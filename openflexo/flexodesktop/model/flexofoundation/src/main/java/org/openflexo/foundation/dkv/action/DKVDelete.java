...
public class DKVDelete extends FlexoUndoableAction<DKVDelete,DKVObject,DKVObject>
{
    ...
    public static FlexoActionType<DKVDelete,DKVObject,DKVObject> actionType = new FlexoActionType<DKVDelete,DKVObject,DKVObject>("delete", FlexoActionType.editGroup, FlexoActionType.DELETE_ACTION_TYPE) {
