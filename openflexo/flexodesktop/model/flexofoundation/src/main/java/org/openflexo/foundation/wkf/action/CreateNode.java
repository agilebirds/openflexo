...
public class CreateNode extends FlexoUndoableAction<CreateNode,WKFObject,WKFObject>
{
    ...
    private static enum CreatedNodeType
    {
    	...
    	{
    		return (this == BEGIN_ACTIVITY
    				|| this == END_ACTIVITY
       				|| this == NORMAL_ACTIVITY);
    	}

       	boolean concernActivity()
    	{
    		return (this == BEGIN_OPERATION
    				|| this == END_OPERATION
       				|| this == NORMAL_OPERATION);
    	}
    ...
    public static class CreateNodeActionType extends FlexoActionType<CreateNode,WKFObject,WKFObject>
    {
        ...
        protected CreateNodeActionType (
        		String actionName, CreatedNodeType type)
        {
    ...
    public static final CreateNodeActionType createActivityBeginNode = new CreateNodeActionType("create_begin_node",CreatedNodeType.BEGIN_ACTIVITY);
    public static final CreateNodeActionType createActivityEndNode = new CreateNodeActionType("create_end_node",CreatedNodeType.END_ACTIVITY);
    public static final CreateNodeActionType createActivityNormalNode = new CreateNodeActionType("create_normal_activity_node",CreatedNodeType.NORMAL_ACTIVITY);
    public static final CreateNodeActionType createOperationBeginNode = new CreateNodeActionType("create_begin_node",CreatedNodeType.BEGIN_OPERATION);
    public static final CreateNodeActionType createOperationEndNode = new CreateNodeActionType("create_end_node",CreatedNodeType.END_OPERATION);
    public static final CreateNodeActionType createOperationNormalNode = new CreateNodeActionType("create_normal_operation_node",CreatedNodeType.NORMAL_OPERATION);
    public static final CreateNodeActionType createActionBeginNode = new CreateNodeActionType("create_begin_node",CreatedNodeType.BEGIN_ACTION);
    ...
    public static final CreateNodeActionType createActionNormalNode = new CreateNodeActionType("create_normal_action_node",CreatedNodeType.NORMAL_ACTION);

    static {
        FlexoModelObject.addActionForClass (createActivityBeginNode, FlexoProcess.class);
        FlexoModelObject.addActionForClass (createActivityEndNode, FlexoProcess.class);
        FlexoModelObject.addActionForClass (createActivityNormalNode, FlexoProcess.class);
        FlexoModelObject.addActionForClass (createOperationBeginNode, AbstractActivityNode.class);
        FlexoModelObject.addActionForClass (createOperationEndNode, AbstractActivityNode.class);
        FlexoModelObject.addActionForClass (createOperationNormalNode, AbstractActivityNode.class);
        FlexoModelObject.addActionForClass (createActionBeginNode, OperationNode.class);
        FlexoModelObject.addActionForClass (createActionEndNode, OperationNode.class);
        FlexoModelObject.addActionForClass (createActionNormalNode, OperationNode.class);
     }
	...
	protected void doAction(Object context) throws InvalidArgumentException
    {
		...
		if (getFocusedObject() instanceof FlexoProcess && !((FlexoProcess)getFocusedObject()).isImported()) {
			...
			if (pg == null) {
				CreateExecutionPetriGraph createPg = CreateExecutionPetriGraph.actionType.makeNewEmbeddedAction((PetriGraphNode)getFocusedObject(), null, this);
				createPg.doAction();
    	...
    	if (getCreatedNodeType() == CreatedNodeType.BEGIN_ACTIVITY
       			&& pg instanceof ActivityPetriGraph) {
                ...
                ((ActivityPetriGraph) pg).addToNodes(newNode);
       			...
       			&& pg instanceof OperationPetriGraph) {
                ...
                ((OperationPetriGraph) pg).addToNodes(newNode);
       			...
       			&& pg instanceof ActionPetriGraph) {
