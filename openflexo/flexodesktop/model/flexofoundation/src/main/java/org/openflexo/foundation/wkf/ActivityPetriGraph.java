...
public final class ActivityPetriGraph extends FlexoPetriGraph
{
    ...
    /**
     * Returns all the activity nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
     * This is done recursively on all nodes.
    ...
    /**
     * Returns all the sub-process nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
     * This is done recursively on all nodes.
    ...
    /**
     * Returns a sorted vector of all the abstract activity nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
     * This is done recursively on all nodes.
    ...
    /**
     * Returns a sorted vector of all the activity nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
     * This is done recursively on all nodes.
    ...
    /**
     * Returns a sorted vector of all the sub-process nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
     * This is done recursively on all nodes.
    ...
    /**
     * Returns all nodes of this petrigraph of the AbstractActivityNode. This method is not recursive and does not returned nodes
     * that are defined in petrigraphs of LOOPOperator or SelfExecutableActivity.
     * @return
     */
    ...
    /**
     * Returns all nodes of this petrigraph of the SubProcessNode. This method is not recursive and does not returned nodes
     * that are defined in petrigraphs of LOOPOperator or SelfExecutableActivity.
     * @return
     */
    ...
    /**
     * Returns the level of this Petri Graph (which is
     * {@link FlexoLevel.ACTIVITY}).
     *
