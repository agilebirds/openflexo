...
public class EOJoin extends EOObject
{
    ...
    public EOJoin(EORelationship relationship, EOAttribute source, EOAttribute destination) throws IllegalArgumentException, InvalidJoinException
    {
        this(relationship);
    ...
    public void setSourceAttribute(EOAttribute sourceAttribute) throws IllegalArgumentException, InvalidJoinException
    {
        if (relationship != null) {
            if (sourceAttribute!=null && sourceAttribute.getEntity() != relationship.getEntity())
                throw new IllegalArgumentException("The source attribute that has been set is not from the source entity of the relationship");
            checkJoinValidity(sourceAttribute,destinationAttribute);
        }
