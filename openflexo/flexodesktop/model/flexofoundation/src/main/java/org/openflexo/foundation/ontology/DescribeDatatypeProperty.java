...
import com.hp.hpl.jena.ontology.OntResource;
	...
	public class DescribeDatatypeProperty {
	    ...
	    /**
	     * <p>Describe the given ontology property in texttual form. 
	     * 
	     * @param out The print stream to write the description to
	     * @param property The ontology property to describe
	     */
	    ...
	    /**
	     * <p>Render a description of the given property to the given output stream.</p>
