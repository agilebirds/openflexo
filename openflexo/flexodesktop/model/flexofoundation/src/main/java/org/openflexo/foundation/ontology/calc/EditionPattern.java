...
import org.openflexo.foundation.ontology.calc.dm.EditionSchemeInserted;
import org.openflexo.foundation.ontology.calc.dm.EditionSchemeRemoved;
...
public class EditionPattern extends CalcObject implements StringConvertable<EditionPattern> {
	...
	{
		return Inspectors.CED.EDITION_PATTERN_INSPECTOR;
	}
