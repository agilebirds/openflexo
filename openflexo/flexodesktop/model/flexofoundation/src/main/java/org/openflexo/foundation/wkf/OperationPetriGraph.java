...
public final class OperationPetriGraph extends FlexoPetriGraph
{
	...
	public OperationNode createNewBeginNode(String nodeName)
    {
        ...
        beginNode.setNodeName(getProcess().findNextInitialName(nodeName == null ? beginNode.getDefaultName() : nodeName, getAbstractActivityNode()));
	...
	public OperationNode createNewEndNode(String nodeName)
    {
       ...
       /* endNode.setPosX(200);
        ...
        endNode.setNodeName(getProcess().findNextInitialName(nodeName == null ? endNode.getDefaultName() : nodeName, getAbstractActivityNode()));
    ...
    /**
	 * Returns all the Operation nodes that are in this petrigraph and the ones embedded by LOOPOperator and SelfExecutableNode.
