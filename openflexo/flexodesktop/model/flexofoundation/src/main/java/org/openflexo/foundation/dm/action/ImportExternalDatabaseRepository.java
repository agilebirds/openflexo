...
public class ImportExternalDatabaseRepository extends CreateDMRepository 
{
    ...
    public static FlexoActionType<ImportExternalDatabaseRepository,DMObject,DMObject> actionType 
    = new FlexoActionType<ImportExternalDatabaseRepository,DMObject,DMObject> (
