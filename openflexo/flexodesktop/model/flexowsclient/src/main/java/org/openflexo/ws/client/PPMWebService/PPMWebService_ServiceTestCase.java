...
public class PPMWebService_ServiceTestCase extends junit.framework.TestCase {
    ...
    public void testPPMWebServiceWSDL() throws Exception {
        ...
        java.net.URL url = new java.net.URL(new org.openflexo.ws.client.PPMWebService.PPMWebService_ServiceLocator().getPPMWebServiceAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new org.openflexo.ws.client.PPMWebService.PPMWebService_ServiceLocator().getServiceName());
    ...
    public void test1PPMWebServiceGetRoles() throws Exception {
        ...
        try {
            binding = (org.openflexo.ws.client.PPMWebService.PPMWebServiceSoapBindingStub)
                          new org.openflexo.ws.client.PPMWebService.PPMWebService_ServiceLocator().getPPMWebService();
        }
    ...
    public void test7PPMWebServiceUploadPrj() throws Exception {
        ...
        try {
            ...
            value = binding.uploadPrj(new org.openflexo.ws.client.PPMWebService.CLProjectDescriptor(), null, new java.lang.String(), new java.lang.String());
        }
        catch (org.openflexo.ws.client.PPMWebService.PPMWebServiceAuthentificationException e1) {
            throw new junit.framework.AssertionFailedError("PPMWebServiceAuthentificationException Exception caught: " + e1);
        }
