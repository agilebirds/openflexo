...
public abstract class BooleanBinaryOperator extends BinaryOperator {
	...
	public static final BooleanBinaryOperator AND = new LogicalBinaryOperator() {
		...
		{
			if (rightArg == BooleanConstant.FALSE) return BooleanConstant.FALSE;
			if (rightArg == BooleanConstant.TRUE) return leftArg;
		...
		{
			if (leftArg == BooleanConstant.FALSE) return BooleanConstant.FALSE;
			if (leftArg == BooleanConstant.TRUE) return rightArg;
			return super.evaluate(leftArg, rightArg);
		}
	};
	...
	public static final BooleanBinaryOperator OR = new LogicalBinaryOperator() {
		...
		public Expression evaluate(Expression leftArg, Constant rightArg) throws TypeMismatchException
		{
			if (rightArg == BooleanConstant.FALSE) return leftArg;
			if (rightArg == BooleanConstant.TRUE) return BooleanConstant.TRUE;
			return super.evaluate(leftArg, rightArg);
		}
		@Override
		public Expression evaluate(Constant leftArg, Expression rightArg) throws TypeMismatchException
		{
			if (leftArg == BooleanConstant.FALSE) return rightArg;
			if (leftArg == BooleanConstant.TRUE) return BooleanConstant.TRUE;
			return super.evaluate(leftArg, rightArg);
		}
	};
	...
	public static final BooleanBinaryOperator EQUALS = new ComparisonBinaryOperator() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException 
		{
			...
			if (leftArg instanceof BooleanConstant && rightArg instanceof BooleanConstant) {
				return ((((BooleanConstant)leftArg).getValue() == ((BooleanConstant)rightArg).getValue()) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof ArithmeticConstant && rightArg instanceof ArithmeticConstant) {
				return ((((ArithmeticConstant)leftArg).getArithmeticValue() == ((ArithmeticConstant)rightArg).getArithmeticValue()) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((((DateConstant)leftArg).getDate().equals(((DateConstant)rightArg).getDate())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((((DurationConstant)leftArg).getDuration().equals(((DurationConstant)rightArg).getDuration())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof StringConstant && rightArg instanceof StringConstant) {
				return ((((StringConstant)leftArg).getValue().equals(((StringConstant)rightArg).getValue())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof EnumConstant && rightArg instanceof EnumConstant) {
				return ((((EnumConstant)leftArg).getName().equals(((EnumConstant)rightArg).getName())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof EnumConstant && rightArg instanceof StringConstant) {
				return ((((EnumConstant)leftArg).getName().equals(((StringConstant)rightArg).getValue())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			//System.out.println("leftArg="+leftArg+" of "+leftArg.getEvaluationType());
			//System.out.println("rightArg="+rightArg+" of "+rightArg.getEvaluationType());
			if (rightArg == ObjectSymbolicConstant.NULL) {
				if (leftArg == ObjectSymbolicConstant.NULL) return Constant.BooleanConstant.TRUE;
				if (leftArg instanceof StringConstant 
						&& ((StringConstant)leftArg).getValue().equals("null")) return Constant.BooleanConstant.TRUE;
				return Constant.BooleanConstant.FALSE;
			}
			if (leftArg == ObjectSymbolicConstant.NULL) {
				if (rightArg == ObjectSymbolicConstant.NULL) return Constant.BooleanConstant.TRUE;
				if (rightArg instanceof StringConstant 
						&& ((StringConstant)rightArg).getValue().equals("null")) return Constant.BooleanConstant.TRUE;
				return Constant.BooleanConstant.FALSE;
			}
		...
		@Override
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType) throws TypeMismatchException {
	...
	public static final BooleanBinaryOperator NOT_EQUALS = new ComparisonBinaryOperator() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException {
			...
			return (EQUALS.evaluate(leftArg, rightArg) == Constant.BooleanConstant.FALSE?Constant.BooleanConstant.TRUE:Constant.BooleanConstant.FALSE);
		}
		@Override
		public String getName() {
	...
	public static final BooleanBinaryOperator LESS_THAN = new ComparisonBinaryOperator() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((((DateConstant)leftArg).getDate().before(((DateConstant)rightArg).getDate())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((((DurationConstant)leftArg).getDuration().lessThan(((DurationConstant)rightArg).getDuration())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			throw new TypeMismatchException(this,leftArg.getEvaluationType(),rightArg.getEvaluationType(),EvaluationType.ARITHMETIC_FLOAT,EvaluationType.ARITHMETIC_INTEGER,EvaluationType.DATE,EvaluationType.DURATION);
		}
		@Override
		public String getName() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((((DateConstant)leftArg).getDate().before(((DateConstant)rightArg).getDate()))
						|| (((DateConstant)leftArg).getDate().equals(((DateConstant)rightArg).getDate())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((((DurationConstant)leftArg).getDuration().lessOrEqualsThan(((DurationConstant)rightArg).getDuration())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			throw new TypeMismatchException(this,leftArg.getEvaluationType(),rightArg.getEvaluationType(),EvaluationType.ARITHMETIC_FLOAT,EvaluationType.ARITHMETIC_INTEGER,EvaluationType.DATE,EvaluationType.DURATION);
		}
		@Override
	...
	public static final BooleanBinaryOperator GREATER_THAN = new ComparisonBinaryOperator() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((((DateConstant)leftArg).getDate().after(((DateConstant)rightArg).getDate())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((((DurationConstant)leftArg).getDuration().greaterThan(((DurationConstant)rightArg).getDuration())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
	...
	public static final BooleanBinaryOperator GREATER_THAN_OR_EQUALS = new ComparisonBinaryOperator() {
		...
		public Constant evaluate(Constant leftArg, Constant rightArg) throws TypeMismatchException {
			...
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((((DurationConstant)leftArg).getDuration().greaterOrEqualsThan(((DurationConstant)rightArg).getDuration())) ? Constant.BooleanConstant.TRUE : Constant.BooleanConstant.FALSE);
			}
			throw new TypeMismatchException(this,leftArg.getEvaluationType(),rightArg.getEvaluationType(),EvaluationType.ARITHMETIC_FLOAT,EvaluationType.ARITHMETIC_INTEGER,EvaluationType.DATE,EvaluationType.DURATION);
		}
		@Override
	...
	public static abstract class ComparisonBinaryOperator extends BooleanBinaryOperator
	{
		...
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType) throws TypeMismatchException {
			...
			throw new TypeMismatchException(this,leftOperandType,rightOperandType,EvaluationType.ARITHMETIC_INTEGER,EvaluationType.ARITHMETIC_FLOAT,EvaluationType.DATE,EvaluationType.DURATION,EvaluationType.LITERAL);
		}
	}
