...
{
	private static final String[] ACCEPTABLEDATEFORMAT = {"d/M/y", "d/M/y H'h'm", "d/M/y H:m", "d-M-y", "d-M-y H'h'm", "d-M-y H:m", "M/d/y", "M/d/y H'h'm", "M/d/y H:m", "M-d-y", "M-d-y H'h'm", "M-d-y H:m"};
	
	/**
	 * Parse all specified String values and returns them as a date array. This method try to detect the date format to use and ensure the same will be used for all values. <br>
