 ...
 * </p>
 * This class allow you to decode object to an XML string or streams according
 * to a mapping you define externaly (see {@link XMLMapping}). Objects are
 * automatically instancied from XML strings or streams.<br>
 * Supposing you have your data in an object myData (a string or a stream
 * object), decoding process is as simpler as this:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * where <code>myData</code> is either a <code>String</code> or an
 * <code>mInputStream</code> and <br>
 * In this example, a new instance of <code>MyClass</code> class is instancied
 * and automatically sets with values and newly created instances of others
 * sub-classes.
 * 
...
public class XMLDecoder
{
    ...
    /**
     * Creates a new <code>XMLDecoder</code> instance given an XMLMapping
     * object
     * 
     * @param anXmlMapping
     ...
     *                if an error occurs
     */
    public XMLDecoder(File modelFile, StringEncoder stringEncoder) throws IOException, SAXException, ParserConfigurationException, InvalidModelException
    {
     ...
     *                if an error occurs
     */
    public XMLDecoder(File modelFile, Object aBuilder) throws IOException, SAXException, ParserConfigurationException, InvalidModelException
    {
     ...
     *                if an error occurs
     */
    public XMLDecoder(File modelFile, Object aBuilder, StringEncoder stringEncoder) throws IOException, SAXException, ParserConfigurationException, InvalidModelException
    {
     ...
     * @param anXmlMapping
     *            an <code>XMLMapping</code> value
     * @param stringEncoder - the string encoder to use with this decoder
     */
    ...
    /**
     * Decode and returns a newly created object from string
     * <code>xmlString</code> according to mapping <code>xmlMapping</code>.
     * 
     * @param xmlString
    ...
    /**
     * Decode and returns a newly created object from string
     * <code>xmlString</code> according to mapping defined in model file
     * <code>modelFile</code>.
     * 
     * @param xmlString
     *            a <code>String</code> value
    ...
    /**
     * Decode and returns a newly created object from string
     * <code>xmlString</code> according to mapping defined in model stream
     ...
     * @throws JDOMException 
     */
    public static XMLSerializable decodeObjectWithMapping(String xmlString, InputStream modelInputStream) throws InvalidXMLDataException, InvalidObjectSpecificationException, IOException, SAXException, ParserConfigurationException, InvalidModelException, AccessorInvocationException, JDOMException
    {
    ...
    /**
     * Decode and returns a newly created object from input stream
     * <code>xmlStream</code> according to mapping <code>xmlMapping</code>.
     * 
     * @param xmlStream
     *            a <code>InputStream</code> value
     * @param xmlMapping
    ...
    /**
     * Decode and returns a newly created object from input stream
     * <code>xmlStream</code> according to mapping defined in model file
     * <code>modelFile</code>.
     * 
     * @param modelFile
     *            a <code>File</code> value
    ...
    /**
     * Decode and returns a newly created object from string with a builder
     * <code>xmlString</code> according to mapping <code>xmlMapping</code>.
     * 
     * @param xmlString
     *            a <code>String</code> value
     ...
     * @throws InvalidModelException 
     */
    public static XMLSerializable decodeObjectWithMapping(String xmlString, XMLMapping xmlMapping, Object builder, StringEncoder stringEncoder)
    throws InvalidXMLDataException,
            InvalidObjectSpecificationException, IOException, AccessorInvocationException, InvalidModelException, JDOMException
    {
    ...
    /**
     * Decode and returns a newly created object from input stream with a
     * builder <code>xmlStream</code> according to mapping
     ...
     * @throws InvalidModelException 
     */
    public static XMLSerializable decodeObjectWithMapping(InputStream xmlStream, XMLMapping xmlMapping, Object builder) throws InvalidXMLDataException,
            InvalidObjectSpecificationException, IOException, AccessorInvocationException, InvalidModelException, JDOMException
    {
     ...
     * @throws InvalidModelException 
     */
    public static XMLSerializable decodeObjectWithMapping(InputStream xmlStream, XMLMapping xmlMapping, Object builder, StringEncoder stringEncoder) throws InvalidXMLDataException,
            InvalidObjectSpecificationException, IOException, AccessorInvocationException, InvalidModelException, JDOMException
    {
    ...
    /**
     * Decode and returns a newly created object from input stream with a
     * builder <code>xmlStream</code> according to mapping defined in model
    ...
    /**
     * Decode and returns a newly created object from string
     * <code>xmlString</code> according to mapping defined in this
     ...
     * @throws JDOMException 
     */
    public XMLSerializable decodeObject(String xmlString) 
    throws InvalidXMLDataException, InvalidObjectSpecificationException,InvalidModelException, IOException, AccessorInvocationException, JDOMException
    {
    ...
    /**
     * Decode and returns a newly created object from input stream
     * <code>xmlStream</code> according to mapping defined in this
     * <code>XMLDecoder</code> object.
     * 
     * @param xmlStream
     *            a <code>String</code> value
     ...
     * @throws JDOMException 
     */
    public XMLSerializable decodeObject(InputStream xmlStream) 
    throws InvalidXMLDataException, InvalidObjectSpecificationException, InvalidModelException, IOException, AccessorInvocationException, JDOMException
    {
    ...
    /**
     * Returns flag indicating if specified <code>xmlString</code> is well
     * formed.
     * 
     * @param xmlString
     *            a <code>String</code> value
     ...
     * Parse xml data from a string <code>xmlString</code> and returns a newly
    ...
    protected Document parseXMLData(String xmlString) throws IOException, JDOMException
    {
        ...
        xmlStream = new ByteArrayInputStream(bytes, 0, bytes.length);// xmlString.length() is not correct unless the charsets codes every character in a single byte.
        return parseXMLData(xmlStream);
    }

    /**
     * Internally used durinf XML decoding process.<br>
     * Parse xml data from an input stream <code>xmlStream</code> and returns
     ...
     * Build and returns newly created object from an XML document
     ...
     *                if an error occurs during accessor invocation
     */
    protected XMLSerializable buildObjectFromDocument(Document dataDocument) throws InvalidXMLDataException, InvalidObjectSpecificationException,
    ...
    /**
     * Internally used during XML decoding process.<br>
     * Build and returns newly created object from an XML element
     * <code>node</code>.
     * 
     * @param node
     ...
     * Internally used during XML decoding process.<br>
     * Build and returns newly created object from an XML element
     * <code>node</code> and model entity <code>modelEntity</code>.
     * 
     * @param node
     *            an <code>Element</code> value
     * @param modelEntity
            ...
            InvalidObjectSpecificationException
    {
            ...
            if (idrefAttribute != null) {
                ...
                if (referenceObject == null) {
                	...
                	if (xmlMapping.entityWithXMLTag(idRefElement.getName())!=modelEntity)
                		System.err.println("SEVERE: Found a referencing object with a non-corresponding entity tag '"+idRefElement.getName()+"' than the referred object"+node.getName());
        ...
        if ((modelEntity.implementsGenericTypingKVProperty()) 
        		&& (node.getAttribute(XMLMapping.genericTypingClassName) != null)) {
        	...
        	try {
        		...
        		//System.out.println("modelEntity.getParentEntity()="+modelEntity.getParentEntity());
           		...
           		KeyValueCoder.setValueForKey(returnedObject, classNameAttribute.getValue(), modelEntity.getGenericTypingKVProperty(), stringEncoder);
        	}
         }
    ...
    /**
     * Internally used to instanciate new object from known constructors given
     * the declared builder, if necessary
     * 
     * @param modelEntity
     * @return
     */
    protected XMLSerializable instanciateNewObject(ModelEntity modelEntity)
    {
         try {
            ...
            throw new AccessorInvocationException("Class " + modelEntity.getName() + " is not instanciable because an exception raised in object constructor.",
                    e);
    ...
    /**
     * Internally used to instanciate new object which is more specialized than
     * the one defined in the model. In this case, known constructors are not
     * usable !
     * 
     * @param modelEntity
     * @return
    ...
    /**
     * Internally used during XML decoding process.<br>
     * Build and returns newly created object matching the key of current stored
     * object (required for hashtable-like data structures). The key is
     * extracted from the first 'key' element found.
     * 
     * @param node
     *            an <code>Element</code> value
     * @param modelEntity
    ...
    /**
     * Internally used during XML decoding process.<br>
     * Build and returns newly created object matching the specified node,
     * asserting <code>node</code> is the key node.<br>
     * Note that if some attributes are here defined, the first one will be
     * interpreted as a String and returned as the key (eventual other child
     * nodes will be ignored) else the first child node will be interpreted as
     * the key.
     * 
     * @param node
     *            an <code>Element</code> value
    ...
    /**
     * Internally used during XML decoding process.<br>
     * Sets property <code>modelProperty</code> for object <code>object</code>
     * according to node <code>node</code> and class <code>objectClass</code>.
     * 
     * @param node
     *            an <code>Element</code> value
     * @param object
     ...
     *                if an error occurs
     */
    protected void setPropertyForObject(Element node, Object object, Class objectClass, ModelProperty modelProperty,  ModelEntity modelEntity) throws InvalidXMLDataException,
            InvalidObjectSpecificationException
    {
        ...
        if (keyValueProperty instanceof SingleKeyValueProperty) {
                    ...
                    if (primitiveProperty) {
                        ...
                        if (childNodes.size() == 0) {
                            ...
                            if ((childNodes.get(0)) instanceof Text) {
                                KeyValueCoder.setValueForKey(object, ((Text)childNodes.get(0)).getTextTrim(), singleKeyValueProperty, stringEncoder);
                            } else {
                                throw new InvalidXMLDataException("Tag '" + modelProperty.getName() + "' is not well-formed according to model file");
                            }
                        } else {
            ...
            KeyValueCoder.setArrayForKey(object, vectorOfObjectsMatchingHandledXMLTags(node, modelProperty), (ArrayKeyValueProperty) keyValueProperty);
		...
		while (it.hasNext()) {
			...
			if (attributeNameMatchesWildcard(att.getName(),modelProperty.getDefaultXmlTag())) {
				...
				while (!isMapped && currentEntity != null) {
					...
					if (!isMapped) currentEntity = currentEntity.getParentEntity();
				}
				if (!isMapped) returned.add(att);
			}
		}
		return returned;
    }
    ...
    */
    ...
    private class MultipleNameFilter implements Filter{
		...
		@Override
		public boolean matches(Object arg0) {
			if(!(arg0 instanceof Element))return false;
			if(_parent.equals(((Element)arg0).getParentElement())){
				for(int i=0;i<_tags.length;i++){
					if((((Element)arg0).getName()).equals(_tags[i]))return true;
				}
			}
			return false;
		}
    ...
    /**
     * Return a vector of {@link XMLSerializable} objects, decoded from elements
     * matching declared handled XML tag of specified <code>modelProperty</code>
     */
    ...
    /**
     * Return a hashtable of {@link XMLSerializable} objects, decoded from
     * elements matching declared handled XML tag of specified
    ...
    /**
     * Return a properties hashtable decoded from elements matching declared
     * handled XML tag of specified <code>modelProperty</code>
     */
                ...
                if (classNameAttr != null) {
                    ...
                    if (objectType==null || stringEncoder._converterForClass(objectType) == null) {
                    	...
                    	// Object is not instanciated. But, we must keep serialized version
                 		returnedHashtable.put(element.getName(), new PropertiesKeyValueProperty.UndecodableProperty(classNameAttr.getValue(),value));
                     }
                    else {
