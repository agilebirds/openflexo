...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inANotExpr3(ANotExpr3 node)
    {
        defaultIn(node);
    }

    public void outANotExpr3(ANotExpr3 node)
    {
        defaultOut(node);
    }

    @Override
    public void caseANotExpr3(ANotExpr3 node)
    {
        inANotExpr3(node);
        if(node.getNot() != null)
        {
    ...
    public void inACosFunction(ACosFunction node)
    {
        defaultIn(node);
    }

    public void outACosFunction(ACosFunction node)
    {
        defaultOut(node);
    }

    @Override
    public void caseACosFunction(ACosFunction node)
    {
        inACosFunction(node);
        if(node.getCos() != null)
        {
        ...
        outACosFunction(node);
    }

    public void inASinFunction(ASinFunction node)
    {
        defaultIn(node);
    }

    public void outASinFunction(ASinFunction node)
    {
        defaultOut(node);
    }

    @Override
    public void caseASinFunction(ASinFunction node)
    {
        inASinFunction(node);
        if(node.getSin() != null)
        {
        ...
        outASinFunction(node);
    }

    public void inATanFunction(ATanFunction node)
    {
        defaultIn(node);
    }

    public void outATanFunction(ATanFunction node)
    {
        defaultOut(node);
    }

    @Override
    public void caseATanFunction(ATanFunction node)
    {
        inATanFunction(node);
        if(node.getTan() != null)
        {
        ...
        outATanFunction(node);
    }

    public void inAAtanFunction(AAtanFunction node)
    {
        defaultIn(node);
    }

    public void outAAtanFunction(AAtanFunction node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAtanFunction(AAtanFunction node)
    {
        inAAtanFunction(node);
