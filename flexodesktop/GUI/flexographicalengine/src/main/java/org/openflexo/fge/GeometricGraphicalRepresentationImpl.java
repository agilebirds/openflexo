...
public class GeometricGraphicalRepresentationImpl<O> extends GraphicalRepresentationImpl<O> implements GeometricGraphicalRepresentation<O> {
	...
	private static final Logger logger = Logger.getLogger(GeometricGraphicalRepresentationImpl.class.getPackage().getName());
	...
	public String getInspectorName() {
		return "GeometricGraphicalRepresentationUtils.inspector";
	}
