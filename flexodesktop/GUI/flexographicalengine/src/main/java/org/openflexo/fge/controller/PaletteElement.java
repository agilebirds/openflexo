...
public interface PaletteElement extends Serializable {
	...
	public static class PaletteElementGraphicalRepresentation extends ShapeGraphicalRepresentation<PaletteElement>
	{
		...
		public PaletteElementGraphicalRepresentation(ShapeGraphicalRepresentation<?> shapeGR, PaletteElement paletteElement, PaletteDrawing paletteDrawing)
		{
	...
	public static class PaletteElementView extends ShapeView<PaletteElement>
	{
		...
		protected void enableDragging()
		{
			...
			/**
			 * FIX for bug where element is not draggable when initial click
			 * begins on label
			 * 
			 * There is a big trick here: the label view is not a subcomponent of
			 * view, so dragging on this component will not be seen by palette element
			 * view, so we need here to force disable mouse listeners registered for 
			 * this palette view
			 */
		...
		protected void disableDragging()
		{
			...
			if (getLabelView() != null) getLabelView().enableMouseListeners();
		}
