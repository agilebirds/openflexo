...
public class FGEIconLibrary {
	...
	public static final ImageIconResource START_NONE_ICON = new ImageIconResource("Icons/ConnectorSymbols/StartNone.gif");
	...
	public static final ImageIconResource START_FILLED_SQUARE_ICON = new ImageIconResource("Icons/ConnectorSymbols/StartFilledSquare.gif");
	public static final ImageIconResource START_PLAIN_DIAMOND_ICON = new ImageIconResource("Icons/ConnectorSymbols/StartPlainDiamond.gif");
	public static final ImageIconResource START_FILLED_DIAMOND_ICON = new ImageIconResource("Icons/ConnectorSymbols/StartFilledDiamond.gif");
	public static final ImageIconResource DEFAULT_FLOW_ICON = START_ARROW_ICON;
	public static final ImageIconResource END_NONE_ICON = new ImageIconResource("Icons/ConnectorSymbols/EndNone.gif");
	...
	public static final ImageIconResource END_FILLED_SQUARE_ICON = new ImageIconResource("Icons/ConnectorSymbols/EndFilledSquare.gif");
	public static final ImageIconResource END_PLAIN_DIAMOND_ICON = new ImageIconResource("Icons/ConnectorSymbols/EndPlainDiamond.gif");
	public static final ImageIconResource END_FILLED_DIAMOND_ICON = new ImageIconResource("Icons/ConnectorSymbols/EndFilledDiamond.gif");
	public static final ImageIconResource MIDDLE_NONE_ICON = new ImageIconResource("Icons/ConnectorSymbols/MiddleNone.gif");
	...
	public static final ImageIconResource CAP_SQUARE_ICON = new ImageIconResource("Icons/CapSquare.gif");
	public static final ImageIconResource JOIN_MITER_ICON = new ImageIconResource("Icons/JoinMiter.gif");
	public static final ImageIconResource JOIN_ROUND_ICON = new ImageIconResource("Icons/JoinRound.gif");
	public static final ImageIconResource JOIN_BEVEL_ICON = new ImageIconResource("Icons/JoinBevel.gif");
	public static final ImageIconResource PLAIN_STROKE_ICON = new ImageIconResource("Icons/PlainStroke.gif");
	public static final ImageIconResource SMALL_DASHES_ICON = new ImageIconResource("Icons/SmallDashes.gif");
	public static final ImageIconResource MEDIUM_DASHES_ICON = new ImageIconResource("Icons/MediumDashes.gif");
	public static final ImageIconResource MEDIUM_SPACED_DASHES_ICON = new ImageIconResource("Icons/MediumSpacedDashes.gif");
