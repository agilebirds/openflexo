...
public class MouseClickControl extends MouseControl {
	...
	public MouseClickControl(String aName, MouseButton button, int clickCount, boolean shiftPressed, boolean ctrlPressed,
	...
	public MouseClickControl(String aName, MouseButton button, int clickCount, MouseClickControlAction action, boolean shiftPressed,
	...
	public MouseClickControl(String aName, MouseButton button, int clickCount, MouseClickControlActionType actionType,
