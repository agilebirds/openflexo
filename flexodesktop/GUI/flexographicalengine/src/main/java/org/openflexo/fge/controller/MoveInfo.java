...
public class MoveInfo {
	...
	public MoveInfo(ShapeNode<?> shapeNode, DrawingController<?> controller) {
	...
	public MoveInfo(ShapeNode<?> shapeNode, MouseEvent e, FGEView<?> view, DrawingController<?> controller) {
