...
/**
 * Swing implementation for the controller of the DrawShape tool<br>
 * As swing component, this controller is driven by {@link MouseEvent}
 * 
 * @author sylvain
 */
public class JDrawShapeToolController extends DrawShapeToolController<MouseEvent> {

	private static final Logger logger = Logger.getLogger(JDrawShapeToolController.class.getPackage().getName());

	public JDrawShapeToolController(DianaInteractiveEditor<?, ?, ?> controller, DrawShapeAction control) {
