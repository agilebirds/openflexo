...
public class MoveInfo {
	...
	public MoveInfo(ShapeNode<?> shapeNode, DrawingControllerImpl<?> controller) {
	...
	public MoveInfo(ShapeNode<?> shapeNode, MouseEvent e, FGEView<?> view, DrawingControllerImpl<?> controller) {
