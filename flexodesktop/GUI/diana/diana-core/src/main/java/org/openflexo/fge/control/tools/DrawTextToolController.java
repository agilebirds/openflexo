 ...
 * @param <ME>
 */
public abstract class DrawTextToolController<ME> extends ToolController<ME> {

	private static final Logger logger = Logger.getLogger(DrawTextToolController.class.getPackage().getName());

	public DrawTextToolController(DianaInteractiveEditor<?, ?, ?> controller, DrawShapeAction toolAction) {
	...
	public void delete() {
		logger.warning("Please implement deletion for DrawTextToolController");
		super.delete();
	}

	public boolean mouseClicked(ME e) {
		System.out.println("DrawTextToolController: mouseClicked() on " + getPoint(e));
		return false;
	}
