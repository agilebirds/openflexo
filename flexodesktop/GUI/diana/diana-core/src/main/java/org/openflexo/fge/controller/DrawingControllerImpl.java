...
public class DrawingControllerImpl<M> extends Observable implements DrawingController<M>, Observer {

	private static final Logger logger = Logger.getLogger(DrawingControllerImpl.class.getPackage().getName());
	...
	public DrawingControllerImpl(Drawing<M> aDrawing, FGEModelFactory factory) {
		super();
		...
		if (logger.isLoggable(Level.FINE)) {
			logger.fine("Building DrawingControllerImpl: " + this);
		}
	}
