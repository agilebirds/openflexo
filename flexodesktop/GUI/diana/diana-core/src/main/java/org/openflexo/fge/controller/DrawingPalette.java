...
public class DrawingPalette {
	...
	protected void makePalettePanel() {
		...
		paletteController = new DrawingControllerImpl<DrawingPalette>(paletteDrawing, factory) {
			@Override
	...
	public PaletteDropListener buildPaletteDropListener(JComponent dropContainer, DrawingControllerImpl<?> controller) {
	...
	public class PaletteDropListener implements DropTargetListener {
		...
		private final DrawingControllerImpl<?> _controller;

		public PaletteDropListener(JComponent dropContainer, DrawingControllerImpl<?> controller) {
			super();
	...
	protected void registerController(DrawingControllerImpl<?> controller) {
		_controller = controller;
	}
