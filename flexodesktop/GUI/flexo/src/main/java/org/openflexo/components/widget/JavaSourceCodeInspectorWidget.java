...
/**
 * This widget may be used to represent source code that can be edited
 * (a diff-view shows differences between edited code and default computed code)
 * Parsing errors are also shown in this widget
 * This widget requires a <pre>AbstractSourceCode</pre> object.
 * 
 * @author sylvain
 * 
 */
public class JavaSourceCodeInspectorWidget extends CustomInspectorWidget<AbstractSourceCode>
{
    ...
    protected class SourceCodePanel extends JPanel
    {
        ...
        public SourceCodePanel(PropertyModel model)
        {
            ...
            resetImplementationLabel = new JLabel("<html><u>"+FlexoLocalization.localizedForKey("reset_to_default_implementation")+"</u>"+"</html>",SwingConstants.RIGHT);
            ...
            editCodeLabel = new JLabel("<html><u>"+FlexoLocalization.localizedForKey("edit_code")+"</u>"+"</html>",SwingConstants.RIGHT);
            ...
            showDiffLabel = new JLabel("<html><u>"+FlexoLocalization.localizedForKey("show_diffs")+"</u>"+"</html>",SwingConstants.RIGHT);
        ...
        private void switchToDiffMode()
        {
        	diffPanel = new DiffPanel(
        			getSourceCode().getDiffReport(),
        			TokenMarkerStyle.Java,
        			FlexoLocalization.localizedForKey("edited_code"),
        			FlexoLocalization.localizedForKey("default_implementation"),
           			FlexoLocalization.localizedForKey("no_differences"),
           			true);       	
        	remove(_textArea);
        ...
        {
        	if (showDiffMode) switchToNormalMode();
        	showDiffMode = false;
        	editionRequested = false;
        }
        ...
        protected void refreshPanel()
        {
        	...
        	if (!showDiffMode) {
        		if (getSourceCode().isEdited() || editionRequested) {
        			...
        			if (!_textArea.isEditable()) _textArea.setEditable(true);
        			...
        			if (_textArea.isEditable()) _textArea.setEditable(false);
