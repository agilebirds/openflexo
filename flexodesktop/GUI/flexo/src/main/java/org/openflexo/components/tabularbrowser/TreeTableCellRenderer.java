...
public class TreeTableCellRenderer extends JTree implements TableCellRenderer {
   ...
   public void treeStructureChanged()
    ...
    {
        if (object == null) return getRowHeight();
...
public TreePath getClosestPathForLocation(int x, int y)
   ...
   protected BrowserElement getElementAt(int row)
    ...
    public class JTreeCellRenderer extends BrowserViewCellRenderer
    {
        ...
        @Override
		public Component getTreeCellRendererComponent(JTree arg0, Object object, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus)
        {
            super.getTreeCellRendererComponent(arg0, object, selected, expanded, leaf, row, hasFocus);
            _row = row;
            if ((object instanceof BrowserElement)
                    && (((BrowserElement)object).getObject() != null)) {
