		...
		private void update()
		{
			...
			/*else if (_representedExpression instanceof Variable || _representedExpression instanceof Constant) {
				...
				if (binding != null) {
					...
					_bindingSelector.setBindingDefinition(new BindingDefinition("common",DMType.makeObjectDMType(getProject()),_bindingExpression,BindingDefinitionType.GET, true));
				}
