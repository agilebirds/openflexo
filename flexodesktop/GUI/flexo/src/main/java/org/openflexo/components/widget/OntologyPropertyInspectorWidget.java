 ...
 *
 */
public class OntologyPropertyInspectorWidget extends CustomInspectorWidget<OntologyProperty>
{

    protected static final Logger logger = Logger.getLogger(OntologyPropertyInspectorWidget.class.getPackage().getName());

    protected OntologyPropertySelector _selector;

    public OntologyPropertyInspectorWidget(PropertyModel model, AbstractController controller)
    {
        super(model,controller);
        _selector = new OntologyPropertySelector(null) {
            @Override
			public void apply()
            {
                super.apply();
	...
	public OntologyPropertySelector getSelector()
	{
		return _selector;
	}
