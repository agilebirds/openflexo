...
public class BindingSelectorInspectorWidget extends CustomInspectorWidget<AbstractBinding>
{
    ...
    {
    	if (logger.isLoggable(Level.FINE))
            logger.fine("BindingSelectorInspectorWidget, updateWidgetFromModel() for "+getObjectValue()+" isUpdatingModel="+isUpdatingEditedBinding+" _selector.getIsUpdatingModel()="+_selector.getIsUpdatingModel());
	...
	public synchronized void updateModelFromWidget()
    {
    	...
    	} finally { isUpdatingEditedBinding = false;}
    ...
    BindingVariable performCreatesEntry(String name, DMType type, DMPropertyImplementationType implementationType, DMEntity newEntryEntity, BindingValue editedObject)
    {
        if (getCreatesEntryMethod() != null) {
            ...
            try {
            	if(newEntryEntity==null){
            		...
            		if(newProperty!=null) editedObject.addBindingPathElement(newProperty);
