...
/**
 * FlexoClipboard is intented to be the object working with the SelectionManager
 ...
 * This class is abstract and must be subclassed depending on the context (WKF
 * or IE).
 * 
 * @author sguerin
 */
public abstract class FlexoClipboard
{
    ...
    {
        //aBoolean = ((FlexoActionType)_copyMenuItem.getAction()).isEnabled(_selectionManager.getFocusedObject(), _selectionManager.getSelection());
    ...
    {
        //aBoolean = ((FlexoActionType)_pasteMenuItem.getAction()).isEnabled(_selectionManager.getFocusedObject(), _selectionManager.getSelection());
    ...
    {
        //aBoolean = ((FlexoActionType)_cutMenuItem.getAction()).isEnabled(_selectionManager.getFocusedObject(), _selectionManager.getSelection());
