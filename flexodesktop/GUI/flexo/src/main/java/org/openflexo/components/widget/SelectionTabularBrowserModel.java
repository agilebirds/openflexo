...
class  SelectionTabularBrowserModel<E extends FlexoModelObject> extends TabularBrowserModel
{
    ...
    {
        super(browserConfiguration," ",(browserConfiguration instanceof MultipleObjectSelector.TabularBrowserConfiguration?((MultipleObjectSelector.TabularBrowserConfiguration)browserConfiguration).getBrowsingColumnWidth():200));   
    ...
    public class SelectionColumn extends CheckColumn<E>
    {
        ...
        {
        	if (!isSelectable(object)) return null;
		...
		public void setBooleanValue(E object, Boolean aBoolean)
        {
        	...
        	if (getConfiguration()  instanceof MultipleObjectSelector.TabularBrowserConfiguration) {
            	...
            	if (!bc.isSelectable(object)) return;
            }
        ...
        {
        	if (!isSelectable(element.getObject())) return;
