 ...
 *
 */
public class MultipleObjectInspectorWidget<E extends FlexoModelObject> extends CustomInspectorWidget<Vector<E>> implements ObjectVisibilityDelegate, ObjectSelectabilityDelegate<E>
{
    ...
    public MultipleObjectInspectorWidget(PropertyModel model, AbstractController controller)
    {
        ...
        if (model.hasValueForParameter("isSelectable")) {
        	...
        	for (String key : selectabilityParams.parameters.keySet()) {
        		logger.info("Selectability for "+BrowserElementType.valueOf(key)+"  is "+Boolean.valueOf(selectabilityParams.getValueForParameter(key)));
        ...
        if (model.hasValueForParameter("visibility")) {
        	...
        	for (String key : visibilityParams.parameters.keySet()) {
        		logger.info("Visibility for "+BrowserElementType.valueOf(key)+" is "+BrowserFilterStatus.valueOf(visibilityParams.getValueForParameter(key)));
    ...
    private Hashtable<BrowserElementType,BrowserFilterStatus> visibilities
    = new Hashtable<BrowserElementType,BrowserFilterStatus>();

    private Hashtable<BrowserElementType,Boolean> selectabilities
    = new Hashtable<BrowserElementType,Boolean>();
