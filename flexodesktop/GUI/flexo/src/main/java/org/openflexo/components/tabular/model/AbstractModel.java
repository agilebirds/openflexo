 ...
 * 
 */
public abstract class AbstractModel<M extends FlexoModelObject,D extends FlexoModelObject> extends DefaultTableModel implements DataFlexoObserver
{
    ...
    {
        if (logger.isLoggable(Level.FINE)) logger.fine("Set model for "+getClass().getName()+" with "+model);
        M oldModel = _model;
        _model = model;
   ...
   public class ModelObjectHasChanged extends TableModelEvent
     ...
     *
     * @param editedObject  object that was updated
