 ...
 * 
 */
public class ViewInspectorWidget extends CustomInspectorWidget<ViewDefinition> {

	protected static final Logger logger = Logger.getLogger(ViewInspectorWidget.class.getPackage().getName());

	protected ViewSelector _selector;

	public ViewInspectorWidget(PropertyModel model, AbstractController controller) {
		super(model, controller);
		_selector = new ViewSelector(null, null) {
			@Override
			public void apply() {
				super.apply();
