...
/**
 * A compound tabular view represents a logical group of tabular views
 * with a specified layout (for example on a JSplitPane), with master/slave
 * relationships.
 * 
 * @author sguerin
 * 
...
public abstract class CompoundTabularView<O extends FlexoModelObject> extends JPanel implements SelectionListener
{
   ...
   /**
    ...
    /**
     * Returns all the objects currently placed in the SelectionManager
     * which are represented (and thus, selected) in this view
     * 
