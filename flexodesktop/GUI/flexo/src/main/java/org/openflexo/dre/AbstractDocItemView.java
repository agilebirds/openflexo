    ...
    public void setCurrentAction(DocItemAction currentAction)
    {
     ...
     protected class EditorPanel extends JPanel
     {
         ...
         protected EditorPanel()
         {
			...
			shortHTMLDescriptionEditor = new FlexoWysiwygHelpDocEditor(FlexoLocalization.localizedForKey("write_documentation_here"), cssFile, ModuleLoader.getUserType() == UserType.DEVELOPER || ModuleLoader.getUserType() == UserType.MAINTAINER) {
             	 @Override
             ...
             fullHTMLDescriptionEditor = new FlexoWysiwygHelpDocEditor(FlexoLocalization.localizedForKey("write_documentation_here"), cssFile, ModuleLoader.getUserType() == UserType.DEVELOPER || ModuleLoader.getUserType() == UserType.MAINTAINER) {
                 @Override
				public void notifyTextChanged() {
...
/*                 if ((historyPanel.getCurrentAction() != null)
                 ...
                 if ((historyPanel != null)
                         && (historyPanel.getCurrentAction() != null)
                         && (historyPanel.getCurrentAction().getVersion() != null)) {
                     DocItemVersion version = historyPanel.getCurrentAction().getVersion();
        ...
        protected HistoryPanel()
             ...
             approveButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
                     if ((getCurrentAction() != null)
                             && (getCurrentAction().isProposal())
                             && (getCurrentAction().isPending())) {
         ...
         class HistoryPanelCellRenderer extends DefaultListCellRenderer
         {
			...
			public Component getListCellRendererComponent(
                 ...
                 if (docItemAction.getActionType() == ActionType.APPROVED) returned.setForeground(GREEN);
                 if (docItemAction.getActionType() == ActionType.REFUSED) returned.setForeground(Color.RED);
                 }
                 else {
