...
public class AskParametersDialog extends FlexoDialog implements ValueListener
{
    ...
    private static final AskParametersDialog _createInstance(FlexoProject project, Frame owner, String windowTitle, String title, ParameterDefinition... parameters) {
    	if (owner!=null)
    ...
    public static final AskParametersDialog createAskParametersDialog(FlexoProject project, String windowTitle, String title, Vector<ParameterDefinition> parameters) {
		return createAskParametersDialog(project, windowTitle, title, toArray(parameters));
	}

    public static final AskParametersDialog createAskParametersDialog(FlexoProject project, String windowTitle, String title, ParameterDefinition... parameters) {
		return createAskParametersDialog(project, null, windowTitle, title, parameters);
	}

	public static final AskParametersDialog createAskParametersDialog(FlexoProject project, Frame owner, String windowTitle, String title, Vector<ParameterDefinition> parameters) {
		return createAskParametersDialog(project, owner, windowTitle, title, toArray(parameters));
	}

	public static final AskParametersDialog createAskParametersDialog(FlexoProject project, Frame owner, String windowTitle, String title, ParameterDefinition... parameters) {
       	AskParametersDialog returned = _createInstance(project, owner, windowTitle, title, parameters);
       	returned.setVisible(true);
 		return returned;
    }

     public static final AskParametersDialog createAskParametersDialog(FlexoProject project, String windowTitle, String title, final ValidationCondition validationCondition, Vector<ParameterDefinition> parameters)
	{
		return createAskParametersDialog(project, windowTitle, title, validationCondition, toArray(parameters));
	}


    public static final AskParametersDialog createAskParametersDialog(FlexoProject project, String windowTitle, String title, final ValidationCondition validationCondition, ParameterDefinition... parameters)
	{
		return createAskParametersDialog(project, null, windowTitle, title, validationCondition, parameters);
	}

	public static final AskParametersDialog createAskParametersDialog(FlexoProject project, Frame owner, String windowTitle, String title, final ValidationCondition validationCondition, Vector<ParameterDefinition> parameters)
    {
		return createAskParametersDialog(project, owner, windowTitle, title, validationCondition, toArray(parameters));
    }

	public static final AskParametersDialog createAskParametersDialog(FlexoProject project, Frame owner, String windowTitle, String title, final ValidationCondition validationCondition, ParameterDefinition... parameters)
    {
    	...
    	LabelParameter labelParameter = new LabelParameter("failure_message","","",false) {
			...
			public String getValue() {
       			if (access.dialog != null) {
       				if (access.dialog.isValidateEnabled()) return "";
       				else return "<html><center><font color=\"red\">"
       				+access.dialog._validationCondition.getErrorMessage()
       				+"</font></center></html>";
       			}
    			return "";
    		}
	...
	public void newValueWasSet(ParameterDefinition param, Object oldValue, Object newValue)
	{
		if (logger.isLoggable(Level.FINE))
            logger.fine("newValueWasSet() "+param+" oldValue="+oldValue+" newValue="+newValue+" isValidateEnabled()="+isValidateEnabled());
	...
	{
		if (_validationCondition != null) return _validationCondition.isValid(_parametersModel);
		return true;
	}
