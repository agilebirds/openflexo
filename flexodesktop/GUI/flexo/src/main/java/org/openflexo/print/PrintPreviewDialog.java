...
public class PrintPreviewDialog extends FlexoDialog {
    ...
    public enum ReturnedStatus { CONTINUE_PRINTING, CANCELLED };
    ...
    public PrintPreviewDialog(PrintManagingController controller, FlexoPrintableComponent printableProcessView)
    {
        ...
        final JCheckBox showPages = new JCheckBox(FlexoLocalization.localizedForKey("show_pages"),_printableComponent.getPrintableDelegate().showPages());
        ...
        final JCheckBox showTitle = new JCheckBox(FlexoLocalization.localizedForKey("show_title"),_printableComponent.getPrintableDelegate().showTitles());
    ...
    protected void update()
    {
        ...
        pagesLabel.setText(_printableComponent.getPrintableDelegate().getWidthPageNb()+" x "
                ...
                +FlexoLocalization.localizedForKey("pages"));
         scrollPane.getViewport().reshape(scrollPane.getViewport().getViewPosition().x, scrollPane.getViewport().getViewPosition().y, _printableComponent.getWidth(), _printableComponent.getHeight());
