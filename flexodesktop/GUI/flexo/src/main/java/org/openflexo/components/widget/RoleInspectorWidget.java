 ...
 * 
 */
public class RoleInspectorWidget extends CustomInspectorWidget<Role> {

	protected static final Logger logger = Logger.getLogger(RoleInspectorWidget.class.getPackage().getName());

	protected RoleSelector _selector;

	public RoleInspectorWidget(PropertyModel model, AbstractController controller) {
		super(model, controller);
		_selector = new RoleSelector(null, null) {
			@Override
			public void apply() {
				super.apply();
