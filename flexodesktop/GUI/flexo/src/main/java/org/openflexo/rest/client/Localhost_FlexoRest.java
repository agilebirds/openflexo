...
}, comments = "wadl2java, http://wadl.java.net", date = "2013-06-27T15:29:18.754+02:00")
    ...
    public static class Accounts {
        ...
        public static class Id {
            ...
            public Account putXmlAsAccount(Account input) {
                ...
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "Account"), Account.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(Account.class);
    ...
    public static class Jobs {
        ...
        public static class Id {
            ...
            public Job putXmlAsJob(Job input) {
                ...
                resourceBuilder = resourceBuilder.type("application/xml");
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "Job"), Job.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(Job.class);
    ...
    public static class Projects {
        ...
        public static class Id {
            ...
            public Project putXmlAsProject(Project input) {
                ...
                resourceBuilder = resourceBuilder.type("application/xml");
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "Project"), Project.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(Project.class);
    ...
    public static class ProjectsProjectIDSessions {
        ...
        public static class Id {
            ...
            public Session putXmlAsSession(Session input) {
                ...
                resourceBuilder = resourceBuilder.type("application/xml");
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "Session"), Session.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(Session.class);
    ...
    public static class ProjectsProjectIDVersions {
        ...
        public static class Id {
            ...
            public ProjectVersion putXmlAsProjectVersion(ProjectVersion input) {
                ...
                resourceBuilder = resourceBuilder.type("application/xml");
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "ProjectVersion"), ProjectVersion.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(ProjectVersion.class);
    ...
    public static class Users {
        ...
        public static class Id {
            ...
            public User putXmlAsUser(User input) {
                ...
                resourceBuilder = resourceBuilder.type("application/xml");
                com.sun.jersey.api.client.ClientResponse response;
                response = resourceBuilder.method("PUT", com.sun.jersey.api.client.ClientResponse.class, new JAXBElement(new QName("http://www.agilebirds.com/openflexo", "User"), User.class, input));
                if (response.getStatus()>= 400) {
                    throw new Localhost_FlexoRest.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
                return response.getEntity(User.class);
