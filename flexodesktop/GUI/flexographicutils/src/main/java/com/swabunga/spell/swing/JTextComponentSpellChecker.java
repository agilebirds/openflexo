...
public class JTextComponentSpellChecker implements SpellCheckListener {
	 ...
	 * @return Either SpellChecker.SPELLCHECK_OK, SpellChecker.SPELLCHECK_CANCEL or the number of errors found. The number of errors are
	 *         those that are found BEFORE any corrections are made.
	 */
