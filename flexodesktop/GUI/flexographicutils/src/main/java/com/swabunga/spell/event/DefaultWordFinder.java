...
public class DefaultWordFinder extends AbstractWordFinder {
	...
	/**
	 * Returns the position in the string <em>after</em> the end of the next word. Note that this return value should not be used as an
	 * index into the string without checking first that it is in range, since it is possible for the value <code>text.length()</code> to be
