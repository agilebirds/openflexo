...
/**
 * The various settings used to control how a spell checker works are read from here. Includes the COST_* constants that decide how to
 * figure the cost of converting one word to another in the EditDistance class.
 * <p/>
...
public abstract class Configuration {
	...
	/**
	 * used by EditDistance: the cost of having to swap two adjoinging characters for the swap value to ever be used, it should be smaller
	 * than the COST_REMOVE_CHAR or COST_INSERT_CHAR values <br/>
	 * (integer greater than 0)
	 */
	...
	/**
	 * used by EditDistance: the cost of having to substitute one character for another for the sub value to ever be used, it should be
	 * smaller than the COST_REMOVE_CHAR or COST_INSERT_CHAR values <br/>
	 * (integer greater than 0)
	 */
	...
	/**
	 * the first word of a sentance is expected to start with an upper case letter <br/>
	 * (boolean)
	 */
