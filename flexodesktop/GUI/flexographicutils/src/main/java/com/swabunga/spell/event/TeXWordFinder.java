...
/**
 * A word finder for TeX and LaTeX documents, which searches text for sequences of letters, but ignores any commands and environments as
 * well as Math environments.
 * 
...
public class TeXWordFinder extends AbstractWordFinder {
	 ...
	 * 
	 * @param expressions
	 *            a collection of of Objects whose toString() value should be the expression. Typically String objects.
	 * @param regex
