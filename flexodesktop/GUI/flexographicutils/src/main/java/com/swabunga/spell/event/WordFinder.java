...
public interface WordFinder {
	...
	/**
	 * This method should return the Word object representing the current word in the iteration. This method should not affect the state of
	 * the WordFinder object.
	 * 
	...
	/**
	 * This method should return the Word object representing the next word in the iteration (the first word if next() has not yet been
	 * called.)
	 * 
