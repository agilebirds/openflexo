...
public class FontSelector extends CustomPopup<Font> implements ChangeListener
{
	...
	public FontSelector(FontSelectionModel fsm)
	{
		...
		_fsm = fsm;
		if (fsm.getSelectedFont() == null) fsm.setSelectedFont(DEFAULT_FONT);
	...
	public void setRevertValue(Font oldValue)
	{
		...
		if (oldValue != null) _revertValue = new Font(oldValue.getFontName(),oldValue.getStyle(),oldValue.getSize());
	...
	{
		if (_fsm != null) {
			if (_fsm.getSelectedFont() != null) return _fsm.getSelectedFont();
