...
public class FlexoFileChooser {
    ...
    public void setDialogType(int type){
    	if (getImplementationType() == ImplementationType.JFileChooserImplementation) {
        	...
        	if(type==JFileChooser.SAVE_DIALOG)_fileDialog.setMode(FileDialog.SAVE);
        	if(type==JFileChooser.OPEN_DIALOG)_fileDialog.setMode(FileDialog.LOAD);
        }
    }
    ...
    private static class FilenameFilterAdapter implements FilenameFilter{
		...
		@Override
		public boolean accept(File dir, String name) {
			if(name==null)return _fileFilter.accept(dir);
