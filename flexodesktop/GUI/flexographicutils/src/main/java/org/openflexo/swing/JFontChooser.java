...
public class JFontChooser extends JPanel {
	...
	private static String BOLD_ITALIC = "bold_italic";
  	...
  	private static String[] sizes = new String[]
  	                              	{ "2","4","6","8","9","10","11","12","13","14","16","18","20","22","24","30","36","48","72" };
	...
	{
		if (aFont == null) return "null";
		if (aFont.isBold() && aFont.isItalic()) return BOLD_ITALIC;
		if (aFont.isBold()) return BOLD;
		if (aFont.isItalic()) return ITALIC;
		return PLAIN;
	}

	private static int fontStyle(String style)
	{
		if (PLAIN.equals(style)) return Font.PLAIN;
		if (ITALIC.equals(style)) return Font.ITALIC;
		if (BOLD.equals(style)) return Font.BOLD;
		if (BOLD_ITALIC.equals(style)) return Font.ITALIC | Font.BOLD;
		return Font.PLAIN;
	}
