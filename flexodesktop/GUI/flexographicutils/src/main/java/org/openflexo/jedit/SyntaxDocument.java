 ...
 * 
 * @author Slava Pestov
 * @version $Id: SyntaxDocument.java,v 1.2 2011/09/12 11:47:09 gpolet Exp $
 */
public class SyntaxDocument extends PlainDocument {
	/**
	 * Returns the token marker that is to be used to split lines of this document up into tokens. May return null if this document is not
	 * to be colorized.
	 */
	...
	/**
	 * Sets the token marker that is to be used to split lines of this document up into tokens. May throw an exception if this is not
	...
	/**
	 * Reparses the document, by passing the specified lines to the token marker. This should be called after a large quantity of text is
	 * first inserted.
	 * 
	 * @param start
	...
	/**
	 * Starts a compound edit that can be undone in one operation. Subclasses that implement undo should override this method; this class
	 * has no undo functionality so this method is empty.
	 */
	public void beginCompoundEdit() {
	}

	/**
	 * Ends a compound edit that can be undone in one operation. Subclasses that implement undo should override this method; this class has
	 * no undo functionality so this method is empty.
	 */
