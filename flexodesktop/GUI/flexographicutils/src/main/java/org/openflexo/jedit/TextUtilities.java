 ...
 * 
 * @author Slava Pestov
 * @version $Id: TextUtilities.java,v 1.2 2011/09/12 11:47:08 gpolet Exp $
 */
public class TextUtilities {
	/**
	 * Returns the offset of the bracket matching the one at the specified offset of the document, or -1 if the bracket is unmatched (or if
	 * the character is not a bracket).
	 * 
	 * @param doc
	 *            The document
	 * @param offset
