...
/**
 * A linked list of tokens. Each token has three fields - a token identifier, which is a byte value that can be looked up in the array
 * returned by <code>SyntaxDocument.getColors()</code> to get a color value, a length value which is the length of the token in the text,
 * and a pointer to the next token in the list.
 * 
 * @author Slava Pestov
 * @version $Id: Token.java,v 1.2 2011/09/12 11:47:09 gpolet Exp $
 */
public class Token {
	/**
	 ...
	 * Keyword 3 token id. This can be used to mark a keyword. This should be used for data types.
	 */
	public static final byte WEBOBJECT = 11;
	/**
	 * Keyword 3 token id. This can be used to mark a keyword. This should be used for data types.
	 */
	 ...
	 * Keyword 3 token id. This can be used to mark a keyword. This should be used for data types.
	 */
	public static final byte TD = 14;
	/**
	 * Keyword 4 token id. This can be used to mark a keyword. This should be used for data types.
	 */
	public static final byte KEYWORD4 = 15;

	/**
	 * Keyword token id. This can be used to mark a keyword. This should be used for data types.
	 */
	public static final byte KEYWORD5 = 16;
	/**
	 * Comment 3 token id. This can be used to mark a comment.
	 */
	public static final byte COMMENT3 = 17;

	/**
	 * Comment 4 token id. This can be used to mark a comment.
	 */
	public static final byte COMMENT4 = 18;
