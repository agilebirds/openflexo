...
/**
 * @author bmangez
 * @version $Id: JTextFieldSearch.java,v 1.2 2011/09/12 11:47:23 gpolet Exp $
 *          $Log: JTextFieldSearch.java,v $
 *          Revision 1.2  2011/09/12 11:47:23  gpolet
 *          Converted v2 to v3
 *
 *          Revision 1.1  2011/08/03 10:51:18  sylvain
 *          Code moved from flexoutils to flexographicutils
 *
 *          Revision 1.2  2011/06/21 14:46:34  gpolet
 *          MEDIUM: Added all missing @Override
 *
 *          Revision 1.1  2011/05/24 01:12:47  gpolet
 *          LOW: First import of OpenFlexo
 *
 *          Revision 1.1.2.2  2011/05/20 14:16:21  gpolet
 *          LOW: Added GPL v2 file header
 *
 *          Revision 1.1.2.1  2011/05/19 09:39:54  gpolet
 *          refactored package names
 *
 *          Revision 1.2  2006/02/02 15:51:30  bmangez
 *          merge from bdev
 *
 *          Revision 1.1.2.2  2005/10/03 11:51:56  benoit
 *          *** empty log message ***
 * Revision 1.1.2.1 2005/08/19 16:51:54
 ...
 * Use this component to have a text field with completion assitant provided by
 * a tooltip window.
 */
            ...
            list.addKeyListener(new KeyAdapter() {
				...
				public void keyPressed(KeyEvent e)
                {
                    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        dispose();
                    } else if (e.getKeyCode() != KeyEvent.VK_UP && e.getKeyCode() != KeyEvent.VK_SHIFT && e.getKeyCode() != KeyEvent.VK_DOWN
