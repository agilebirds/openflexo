...
public class FIBBrowserWidget extends FIBWidgetView<FIBBrowser,JTree,Object> implements FIBSelectable, TreeModelListener
{
   ...
   public TreeSelectionModel getTreeSelectionModel()
	...
	{
		if (_tree != null) _tree.removeFocusListener(this);
		if (getTreeSelectionModel() != null) getTreeSelectionModel().removeTreeSelectionListener(getBrowserModel());
		for (MouseListener l : _tree.getMouseListeners()) _tree.removeMouseListener(l);
	}
