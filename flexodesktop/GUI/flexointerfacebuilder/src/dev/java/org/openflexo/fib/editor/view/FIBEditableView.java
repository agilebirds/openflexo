...
public interface FIBEditableView<M extends FIBComponent, J extends JComponent> extends Observer {
	...
	public abstract FIBComponentDynamicModel createDynamicModel();

	public abstract FIBComponentDynamicModel getDynamicModel();

	public abstract void notifyDynamicModelChanged();
