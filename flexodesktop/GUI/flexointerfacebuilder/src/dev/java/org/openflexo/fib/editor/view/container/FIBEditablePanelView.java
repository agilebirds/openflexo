...
public class FIBEditablePanelView extends FIBPanelView<FIBPanel> implements FIBEditableView<FIBPanel,JPanel> {

	private static final Logger logger = FlexoLogger.getLogger(FIBEditablePanelView.class.getPackage().getName());

	private FIBEditableViewDelegate<FIBPanel,JPanel> delegate;
	...
	protected void retrieveContainedJComponentsAndConstraints()
	{
		...
		if (getComponent().getLayout() == Layout.flow) {
			...
			PlaceHolder beginPlaceHolder = new PlaceHolder(this,"<begin>") {
				...
				public void insertComponent(FIBComponent newComponent) {
					FIBEditablePanelView.this.getComponent().addToSubComponents(newComponent,beginPlaceHolderConstraints);
				}
			};
		...
		if (getComponent().getLayout() == Layout.twocols) {
			...
			PlaceHolder beginCenterPlaceHolder = new PlaceHolder(this,"<center>") {
				@Override
				public void insertComponent(FIBComponent newComponent) {
					FIBEditablePanelView.this.getComponent().addToSubComponents(newComponent,beginCenterPlaceHolderConstraints);
				}
			};
			...
			PlaceHolder beginLeftPlaceHolder = new PlaceHolder(this,"<left>") {
				@Override
				public void insertComponent(FIBComponent newComponent) {
					FIBEditablePanelView.this.getComponent().addToSubComponents(new FIBLabel("<right>"),beginRightPlaceHolderConstraints);
					FIBEditablePanelView.this.getComponent().addToSubComponents(newComponent,beginLeftPlaceHolderConstraints);
				}
			};
			...
			PlaceHolder beginRightPlaceHolder = new PlaceHolder(this,"<right>") {
				@Override
				public void insertComponent(FIBComponent newComponent) {
					FIBEditablePanelView.this.getComponent().addToSubComponents(newComponent,beginRightPlaceHolderConstraints);
					FIBEditablePanelView.this.getComponent().addToSubComponents(new FIBLabel("<left>"),beginLeftPlaceHolderConstraints);
				}
			};
			...
			PlaceHolder endLeftPlaceHolder = new PlaceHolder(this,"<left>") {
				...
				public void insertComponent(FIBComponent newComponent) {
					...
					FIBEditablePanelView.this.getComponent().addToSubComponents(new FIBLabel("<right>"),endRightPlaceHolderConstraints);
				}
			};
			...
			PlaceHolder endRightPlaceHolder = new PlaceHolder(this,"<right>") {
				@Override
				public void insertComponent(FIBComponent newComponent) {
					FIBEditablePanelView.this.getComponent().addToSubComponents(new FIBLabel("<left>"),endLeftPlaceHolderConstraints);
