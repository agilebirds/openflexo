 ...
 * 
 */
public class TOCEntryView extends FIBModuleView<TOCEntry> {

	public static File TOC_ENTRY_VIEW_FIB = new FileResource("Fib/TOCEntryView.fib");

	public TOCEntryView(TOCEntry tocEntry, DEController controller) {
		super(tocEntry, controller, TOC_ENTRY_VIEW_FIB);
	}
