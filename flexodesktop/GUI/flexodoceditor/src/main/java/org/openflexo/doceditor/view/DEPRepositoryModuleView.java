 ...
 * @author MOSTAFA
 */
public class DEPRepositoryModuleView extends JPanel implements ModuleView<PTOCRepository>, FlexoObserver
{
    ...
    private PTOCRepository codeRepository;
     ...
     *
     */
    public DEPRepositoryModuleView(PTOCRepository repository, DEController ctrl, FlexoPerspective perspective)
    {
    ...
    {
        if (observable instanceof PTOCEntry && ((PTOCEntry)observable).getRepository()==codeRepository)
        	requestRefresh();
     ...
     */
    @Override
	public PTOCRepository getRepresentedObject()
    {
