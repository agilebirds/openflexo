 ...
 * @author MOSTAFA
 */
public class DEPTOCDataModuleView extends JPanel implements ModuleView<PTOCData>, FlexoObserver, FlexoActionSource {
	private PTOCData _gc;
	private DEController _controller;
	private JComponent component;
	private JPanel topPanel;
	private JPanel panel;

	public DEPTOCDataModuleView(PTOCData gc, DEController controller) {
	...
	private void updateView() {
		...
		if (_gc.getRepositories().size() == 0) {
			panel.add(component = new FlexoActionButton(AddPTOCRepository.actionType, this, _controller.getEditor()));
		} else {
	...
	@Override
	public PTOCData getRepresentedObject() {
		return _gc;
	}
