 ...
 * 
 */
public class NormalSectionView extends FIBModuleView<NormalSection> {

	public static File FIB_FILE = new FileResource("Fib/NormalSectionView.fib");

	public NormalSectionView(NormalSection normalSection, DEController controller) {
		super(normalSection, controller, FIB_FILE);
	}
	...
	/*public static void main(String[] args) {
		...
		FIBAbstractEditor editor = new FIBAbstractEditor() {
			...
			public Object[] getData() {
				return makeArray(project.getTOCData().getRepositories().firstElement().getTocEntries().firstElement());
			}
