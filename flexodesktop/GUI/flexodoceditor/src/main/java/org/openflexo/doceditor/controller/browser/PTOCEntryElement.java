...
public class PTOCEntryElement extends DEBrowserElement {

	public PTOCEntryElement(PTOCEntry entry, ProjectBrowser browser, BrowserElement parent) {
		super(entry, BrowserElementType.PTOC_ENTRY, browser,parent);
	}
	...
	public PTOCEntry getEntry() {
		return  ((PTOCEntry)getObject());
	}
}
