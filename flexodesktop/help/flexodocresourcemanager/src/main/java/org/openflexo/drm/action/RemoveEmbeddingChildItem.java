...
public class RemoveEmbeddingChildItem extends FlexoAction 
{
    ...
    public static FlexoActionType actionType = new FlexoActionType ("remove_embedding_child",FlexoActionType.defaultGroup,FlexoActionType.NORMAL_ACTION_TYPE) {
		...
		protected boolean isEnabledForSelection(FlexoModelObject object, Vector globalSelection) 
        {
            return ((object != null) 
                    ...
                    && (((DocItem)object).getEmbeddingParentItem() != null));
        }
