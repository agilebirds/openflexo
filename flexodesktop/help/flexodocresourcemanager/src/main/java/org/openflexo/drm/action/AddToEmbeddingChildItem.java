...
public class AddToEmbeddingChildItem extends FlexoAction 
{
    ...
    public static FlexoActionType actionType = new FlexoActionType ("add_embedding_child",FlexoActionType.newMenu,FlexoActionType.defaultGroup,FlexoActionType.ADD_ACTION_TYPE) {
    ...
    AddToEmbeddingChildItem (FlexoModelObject focusedObject, Vector globalSelection, FlexoEditor editor)
    {
