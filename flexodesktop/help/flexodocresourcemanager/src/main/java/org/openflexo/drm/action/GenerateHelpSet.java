...
public class GenerateHelpSet extends FlexoAction<GenerateHelpSet,FlexoModelObject,FlexoModelObject>
{
    ...
    public static FlexoActionType<GenerateHelpSet, FlexoModelObject, FlexoModelObject> actionType = new FlexoActionType<GenerateHelpSet, FlexoModelObject, FlexoModelObject>("generate_helpset",FlexoActionType.defaultGroup,FlexoActionType.NORMAL_ACTION_TYPE) {
	...
	protected void doAction(Object context) 
    {
        ...
        for (HelpSetConfiguration config : configurations) {
            DRMHelpSet helpSet = new DRMHelpSet(DocResourceManager.instance().getDocResourceCenter(),getHelpsetDirectory(),getBaseName(),config);
