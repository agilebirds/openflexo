...
public class DocItem extends DRMObject implements InspectableObject
{
    ...
    public boolean isPublished() {
    	...
    	&& hasBeenApproved()
    	&& (getFolder()==null 
    		|| getFolder().getPrimaryDocItem() ==this
    		|| getFolder().isPublished());
    }
    ...
    /**
     * Returns direct childs relating to inheritance Take isHidden property
     * under account by searching deeply
     * 
     * @return
     */
    ...
    {
    	if (getFolder() != null) getFolder().reorderItems();
    ...
    public static class DocItemComparator implements Comparator<DocItem>
    {
		...
		public int compare(DocItem docItem1, DocItem docItem2)
        {
        	if (currentLanguage != null) {
        		...
        		if (string1 == null) string1 = docItem1.getIdentifier();
        		String string2 = docItem2.getTitle(currentLanguage);
        		if (string2 == null) string2 = docItem2.getIdentifier();
       		return (string1.compareTo(string2));
        	}
        	else return (docItem1.getIdentifier().compareTo(docItem2.getIdentifier()));
        }
