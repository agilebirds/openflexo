 ...
 * @author gbesancon
 */
public class EMFMetaModelResourceReaderWriter implements
		IFlexoOntologyReaderWriter<Resource, EMFMetaModel, EMFMetaModelBuilder, EMFMetaModelConverter> {
	/** Converter. */
	 ...
	 * Constructor.
	 */
	public EMFMetaModelResourceReaderWriter() {
	}
	 ...
	 */
	@Override
	public EMFMetaModel load(Resource input) {
	 ...
	 */
	@Override
	public void save(EMFMetaModel ontology, Resource output) {
		try {
			output.save(null);
		} catch (IOException e) {
			e.printStackTrace();
