 ...
 * 
 */
public class RemoveEMFObjectIndividualReferenceObjectPropertyValue<T> extends
	 ...
	 * @param builder
	 */
	public RemoveEMFObjectIndividualReferenceObjectPropertyValue(ViewPointBuilder builder) {
		super(builder);
	}
