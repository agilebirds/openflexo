...
public class XSOntAttributeAssociation extends XSOntFeatureAssociation{


	private final XSOntDataProperty attributeProperty;
	private final XSAttributeUse attributeUse;
	
	protected XSOntAttributeAssociation(XSOntology ontology,
	...
	protected XSOntAttributeAssociation(XSOntology ontology, XSOntClass domainClass, XSAttributeUse attributeUse,
	...
	protected XSOntAttributeAssociation(XSOntology ontology, XSOntClass domainClass, XSOntDataProperty property, XSDTechnologyAdapter adapter) {
		super(ontology,domainClass,adapter);
		this.attributeProperty = property;
