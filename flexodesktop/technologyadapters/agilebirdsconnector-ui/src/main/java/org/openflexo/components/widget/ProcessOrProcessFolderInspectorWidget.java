 ...
 * 
 */
public class ProcessOrProcessFolderInspectorWidget extends CustomInspectorWidget<RepresentableFlexoModelObject> {

	protected static final Logger logger = Logger.getLogger(ProcessOrProcessFolderInspectorWidget.class.getPackage().getName());

	protected ProcessOrProcessFolderSelector _selector;

	public ProcessOrProcessFolderInspectorWidget(PropertyModel model, AbstractController controller) {
		super(model, controller);
		_selector = new ProcessOrProcessFolderSelector(null, (FlexoProcess) null) {
			@Override
			public void apply() {
				super.apply();
