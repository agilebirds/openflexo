...
public class TestDropWKFElement extends FlexoWKFTestCase {
	...
	public void test1NodeCompountConnexity() {
		...
		Collection<AgileBirdsObject> allEmbedded = actA.getAllRecursivelyEmbeddedObjects();
		...
		Collection<AgileBirdsObject> allEmbeddedRestricted = actA.getXMLMapping().getRestrictedEmbeddedObjectsForObject(actA,
				AgileBirdsObject.class, false, true);
		...
		Collection<AgileBirdsObject> copyAllEmbedded = compound.getAllRecursivelyEmbeddedObjects();
		for (AgileBirdsObject object : copyAllEmbedded) {
