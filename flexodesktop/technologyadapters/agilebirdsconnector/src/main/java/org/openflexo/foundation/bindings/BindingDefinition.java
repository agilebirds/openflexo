 ...
 * 
 */
public class BindingDefinition extends AgileBirdsObject implements InspectableObject, Typed {

	static final Logger logger = Logger.getLogger(BindingDefinition.class.getPackage().getName());

	private AgileBirdsObject _owner;
	...
	public BindingDefinition(AgileBirdsObject owner) {
		super(owner != null ? owner.getProject() : null);
		_owner = owner;
	}

	/*public BindingDefinition(String variableName, DMEntity type, AgileBirdsObject owner, boolean mandatory)
	{
	    this(variableName,(type != null ? DMType.makeResolvedDMType(type) : null) ,owner,mandatory);
	}

	public BindingDefinition(String variableName, DMEntity type, AgileBirdsObject owner, DMCardinality cardinality, boolean mandatory)
	{
	    this(variableName,(type != null ? DMType.makeResolvedDMType(type) : null) ,owner,cardinality,mandatory);
	}*/

	public BindingDefinition(String variableName, DMType type, AgileBirdsObject owner, BindingDefinitionType bindingType, boolean mandatory) {
		this(owner);
	...
	/*public BindingDefinition(String variableName, DMType type, AgileBirdsObject owner, DMCardinality cardinality, boolean mandatory)
	{
	...
	public AgileBirdsObject getOwner() {
		return _owner;
	}
