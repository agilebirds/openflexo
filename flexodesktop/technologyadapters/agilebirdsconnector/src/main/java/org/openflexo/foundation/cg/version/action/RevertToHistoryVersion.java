...
public class RevertToHistoryVersion extends AbstractGCAction<RevertToHistoryVersion, CGObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(RevertToHistoryVersion.actionType, CGFile.class);
		AgileBirdsObject.addActionForClass(RevertToHistoryVersion.actionType, AbstractCGFileVersion.class);
	}
