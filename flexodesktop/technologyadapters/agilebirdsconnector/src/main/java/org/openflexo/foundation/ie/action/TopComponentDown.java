...
public class TopComponentDown extends FlexoAction<TopComponentDown, IEWidget, IEWidget> {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, IEBlocWidget.class);
		AgileBirdsObject.addActionForClass(actionType, IEHTMLTableWidget.class);
		AgileBirdsObject.addActionForClass(actionType, IESequenceTab.class);
		AgileBirdsObject.addActionForClass(actionType, IESequenceTopComponent.class);
		AgileBirdsObject.addActionForClass(actionType, IETabContainerWidget.class);
		AgileBirdsObject.addActionForClass(actionType, TopComponentReusableWidget.class);
	}
