...
public class AddSubProcess extends FlexoAction<AddSubProcess, AgileBirdsObject, AgileBirdsObject> {

	private static final Logger logger = Logger.getLogger(AddSubProcess.class.getPackage().getName());

	public static FlexoActionType<AddSubProcess, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<AddSubProcess, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public AddSubProcess makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
		...
		public boolean isVisibleForSelection(AgileBirdsObject object, Vector<AgileBirdsObject> globalSelection) {
			return object instanceof FlexoProcess || object instanceof ProcessFolder || object instanceof FlexoWorkflow;
		}
	...
	static {
		AgileBirdsObject.addActionForClass(AddSubProcess.actionType, FlexoWorkflow.class);
		AgileBirdsObject.addActionForClass(AddSubProcess.actionType, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(AddSubProcess.actionType, ProcessFolder.class);
	}

	AddSubProcess(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
