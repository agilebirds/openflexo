...
public class WSPortType extends WSObject implements FlexoObserver {
	...
	private static final Logger logger = FlexoLogger.getLogger(WSPortType.class.getPackage().getName());
	...
	/**
	 * deletes the WSPortType BUT do not delete the underlying FlexoProcess. it is the wsgroup's responsibility to decide wheither the
	...
	@Override
	public Vector<? extends AgileBirdsObject> getOrderedChildren() {
		return null;
	}
