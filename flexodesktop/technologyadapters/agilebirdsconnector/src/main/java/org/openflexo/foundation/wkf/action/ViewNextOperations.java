...
public class ViewNextOperations extends FlexoGUIAction {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, ActionNode.class);
	}
	 ...
	 */
	protected ViewNextOperations(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
