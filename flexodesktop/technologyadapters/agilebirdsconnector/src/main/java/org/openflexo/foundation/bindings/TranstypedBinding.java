...
public class TranstypedBinding extends AbstractBinding {
	...
	public class TranstypedBindingValue extends AgileBirdsObject implements InspectableObject {
		...
		@Override
		public int hashCode() {
			return (getEntry() == null ? 0 : getEntry().hashCode()) + (getBindingValue() == null ? 0 : getBindingValue().hashCode());
		}
	...
	public TranstypedBinding(BindingDefinition bindingDefinition, AgileBirdsObject owner) {
	...
	public static TranstypedBinding makeTranstypedBinding(String value, AgileBirdsObject owner) {
	...
	public static class TranstypedBindingStringConverter extends AbstractBindingStringConverter<TranstypedBinding> {
		...
		public TranstypedBinding convertFromString(String aValue) {
			...
			DMEntity declaringEntity = ((AgileBirdsObject) _bindable).getProject().getDataModel().getEntityNamed(fullyQualifiedEntityName);
