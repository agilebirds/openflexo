...
public class ImportImage extends FlexoAction<ImportImage, AgileBirdsObject, AgileBirdsObject> {
	private FlexoWebServerFileResource _res = null;
	private File _fileToImport;

	public static FlexoActionType<ImportImage, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<ImportImage, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public ImportImage makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, FlexoProject.class);
	}
	...
	ImportImage(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
