...
public class AddServiceInterface extends FlexoAction<AddServiceInterface, AgileBirdsObject, AgileBirdsObject> {

	private static final Logger logger = Logger.getLogger(AddServiceInterface.class.getPackage().getName());

	public static FlexoActionType<AddServiceInterface, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<AddServiceInterface, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public AddServiceInterface makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection,
				FlexoEditor editor) {
	...
	AddServiceInterface(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
