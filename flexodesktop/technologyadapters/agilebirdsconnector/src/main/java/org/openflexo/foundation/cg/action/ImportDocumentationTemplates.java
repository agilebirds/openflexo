...
public class ImportDocumentationTemplates extends FlexoAction<ImportDocumentationTemplates, AgileBirdsObject, AgileBirdsObject> {

	public static final FlexoActionType<ImportDocumentationTemplates, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<ImportDocumentationTemplates, AgileBirdsObject, AgileBirdsObject>(
		...
		@Override
		public ImportDocumentationTemplates makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection,
				FlexoEditor editor) {
	...
	static {
		AgileBirdsObject.addActionForClass(ImportDocumentationTemplates.actionType, FlexoProject.class);
		AgileBirdsObject.addActionForClass(ImportDocumentationTemplates.actionType, GeneratedDoc.class);
	}
	 ...
	 */
	protected ImportDocumentationTemplates(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
