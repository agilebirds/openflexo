...
public class UpdateLoadableDMEntity extends FlexoAction<UpdateLoadableDMEntity, DMObject, DMObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, DMModel.class);
		AgileBirdsObject.addActionForClass(actionType, DMPackage.class);
		AgileBirdsObject.addActionForClass(actionType, LoadableDMEntity.class);
	}
	...
	static List<LoadableDMEntity> getAllLoadableDMEntities(AgileBirdsObject focusedObject, Vector<DMObject> globalSelection) {
	...
	private static void computeLoadableDMEntitiesListWith(AgileBirdsObject object, List<LoadableDMEntity> list) {
