...
public abstract class StaticBinding<T> extends AbstractBinding {
	...
	public StaticBinding(BindingDefinition bindingDefinition, AgileBirdsObject owner) {
	...
	public static StaticBinding makeStaticBinding(String value, AgileBirdsObject owner) {
