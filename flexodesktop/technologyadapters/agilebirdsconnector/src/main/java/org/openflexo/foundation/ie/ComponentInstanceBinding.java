 ...
 * 
 */
public class ComponentInstanceBinding extends AgileBirdsObject implements InspectableObject, Bindable {
	...
	/**
	 * Constructor used by XMLCoDe in the context of navigation menu deserialization
	 * 
	 * @param builder
	 */
