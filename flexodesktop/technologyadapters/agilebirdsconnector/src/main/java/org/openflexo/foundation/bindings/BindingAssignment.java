...
public class BindingAssignment extends AgileBirdsObject implements Bindable, InspectableObject, StringConvertable {
	static final Logger logger = Logger.getLogger(BindingAssignment.class.getPackage().getName());

	protected AgileBirdsObject _owner;
	...
	public BindingAssignment(AgileBirdsObject owner) {
		super();
		_owner = owner;
	...
	public BindingAssignment(BindingValue receiver, AbstractBinding value, AgileBirdsObject owner) {
		this(owner);
	...
	public final AgileBirdsObject getOwner() {
		return _owner;
	}
	...
	protected class ReceiverBindingDefinition extends BindingDefinition {
		...
		public ReceiverBindingDefinition(AgileBirdsObject owner) {
	...
	protected class ValueBindingDefinition extends BindingDefinition {
		...
		public ValueBindingDefinition(AgileBirdsObject owner) {
		...
		public BindingAssignment convertFromString(String aString) {
			...
			if (decodedExpression != null) {
				if (decodedExpression.getExpression() != null && decodedExpression.getExpression() instanceof BinaryOperatorExpression
					...
					return new BindingAssignment(receiver, value, (AgileBirdsObject) _bindable);
				}
			}
