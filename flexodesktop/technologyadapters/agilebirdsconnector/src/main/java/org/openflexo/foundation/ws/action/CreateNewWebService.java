...
public class CreateNewWebService extends AbstractCreateNewWebService<CreateNewWebService> {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, FlexoWSLibrary.class);
		AgileBirdsObject.addActionForClass(actionType, WSFolder.class);
		AgileBirdsObject.addActionForClass(actionType, ExternalWSService.class);
		AgileBirdsObject.addActionForClass(actionType, InternalWSService.class);
	}
