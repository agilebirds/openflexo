...
public class FlexoWorkflow extends FlexoFolderContainerNode implements XMLStorageResourceData<FlexoWorkflow>, InspectableObject {
	 ...
	 */
	public Vector<AgileBirdsObject> getAllEmbeddedWKFObjects() {
		Vector<AgileBirdsObject> returned = new Vector<AgileBirdsObject>();
		returned.add(this);
	...
	public List<ApplicationHelpEntryPoint> getAllHelpEntryPoints() {
		...
		Enumeration<AgileBirdsObject> en = getAllEmbeddedWKFObjects().elements();
		while (en.hasMoreElements()) {
			AgileBirdsObject p = en.nextElement();
