 ...
 * 
 */
public class WSDelete extends FlexoUndoableAction<WSDelete, AgileBirdsObject, AgileBirdsObject> {

	private static final Logger logger = Logger.getLogger(WSDelete.class.getPackage().getName());

	public static FlexoActionType<WSDelete, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<WSDelete, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public WSDelete makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
			return new WSDelete(focusedObject, globalSelection, editor);
		}

		@Override
		public boolean isVisibleForSelection(AgileBirdsObject object, Vector globalSelection) {
			return true;
		}

		@Override
		public boolean isEnabledForSelection(AgileBirdsObject object, Vector globalSelection) {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, WSService.class);
		AgileBirdsObject.addActionForClass(actionType, ServiceInterface.class);
	}

	WSDelete(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
	...
	protected void doAction(Object context) {
		...
		for (AgileBirdsObject object : getObjectsToDelete()) {
			deleteObject(object);
		}
	}
	...
	private Vector<AgileBirdsObject> _objectsToDelete;
	 ...
	 * @return
	 */
	public Vector<AgileBirdsObject> getObjectsToDelete() {
		if (_objectsToDelete == null) {
			_objectsToDelete = new Vector<AgileBirdsObject>();
			for (AgileBirdsObject object : getGlobalSelection()) {
	...
	private void deleteObject(AgileBirdsObject object) {
