...
public class ShowExecutionControlGraphs extends FlexoGUIAction<ShowExecutionControlGraphs, WKFObject, WKFObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(ShowExecutionControlGraphs.actionType, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(ShowExecutionControlGraphs.actionType, PetriGraphNode.class);
		AgileBirdsObject.addActionForClass(ShowExecutionControlGraphs.actionType, OperatorNode.class);
		AgileBirdsObject.addActionForClass(ShowExecutionControlGraphs.actionType, FlexoPreCondition.class);
		AgileBirdsObject.addActionForClass(ShowExecutionControlGraphs.actionType, FlexoPostCondition.class);
	}
