...
import org.openflexo.foundation.FlexoProject.ImageFile;
...
public class TOCRepository extends TOCEntry {
	...
	public TOCEntry createObjectEntry(AgileBirdsObject modelObject) {
		TOCEntry reply = new TOCEntry(getData(), modelObject);
		return reply;
	}

	public TOCEntry createObjectEntry(AgileBirdsObject modelObject, PredefinedSection.PredefinedSectionType identifier) {
