...
public class AddRole extends FlexoAction<AddRole, WorkflowModelObject, WorkflowModelObject> {
	...
	public static FlexoActionType<AddRole, WorkflowModelObject, WorkflowModelObject> actionType = new FlexoActionType<AddRole, WorkflowModelObject, WorkflowModelObject>(
		...
		public boolean isVisibleForSelection(WorkflowModelObject object, Vector<WorkflowModelObject> globalSelection) {
			return object instanceof RoleList || object instanceof Role;
		}
	...
	static {
		...
		AgileBirdsObject.addActionForClass(actionType, RoleList.class);
		AgileBirdsObject.addActionForClass(actionType, Role.class);
	}
