...
public class FlexoWSDLResource extends FlexoImportedResource<WSDLResourceData> {
	...
	public FlexoWSDLResource(FlexoProject aProject, WSDLResourceData anWSDLResourceData, FlexoDMResource dmResource,
			FlexoProjectFile wsdlFile) throws InvalidFileNameException {
	...
	/**
	 * Returns boolean indicating if custom disk update scheme is implemented for this kind of resource. In this case, since a custom
	 * resource disk update scheme is implemented in method #performDiskUpdate(), returns true
	 * 
	 * @return true
	 */
