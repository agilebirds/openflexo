...
public class DropWKFElement extends FlexoUndoableAction<DropWKFElement, FlexoPetriGraph, WKFObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, FlexoPetriGraph.class);
	}

	DropWKFElement(FlexoPetriGraph focusedObject, Vector<WKFObject> globalSelection, FlexoEditor editor) {
		super(actionType, focusedObject, globalSelection, editor);
		parameters = new Hashtable<String, AgileBirdsObject>();
	}
	...
	private Hashtable<String, AgileBirdsObject> parameters;
	...
	public void setParameter(String key, AgileBirdsObject value) {
	...
	private void setProcessOnNode(FlexoProcess process, WKFNode node) {
		...
		Collection<AgileBirdsObject> embedded = node.getAllRecursivelyEmbeddedObjects();
		Iterator<AgileBirdsObject> i = embedded.iterator();
		while (i.hasNext()) {
			AgileBirdsObject o = i.next();
