...
public class ShowDifferences extends FlexoGUIAction<ShowDifferences, CGObject, CGObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(ShowDifferences.actionType, CGFile.class);
		AgileBirdsObject.addActionForClass(ShowDifferences.actionType, AbstractCGFileVersion.class);
	}
