 ...
 * 
 */
public abstract class FlexoDocFormat extends KVCFlexoObject implements StringConvertable, ChoiceList {
	public static final StringEncoder.Converter<FlexoDocFormat> flexoDocFormatConverter = new Converter<FlexoDocFormat>(
			FlexoDocFormat.class) {
