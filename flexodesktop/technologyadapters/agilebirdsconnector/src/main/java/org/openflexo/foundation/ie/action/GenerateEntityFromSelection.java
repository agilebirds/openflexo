...
public class GenerateEntityFromSelection extends FlexoAction<GenerateEntityFromSelection, AgileBirdsObject, AgileBirdsObject> {
	...
	public static FlexoActionType<GenerateEntityFromSelection, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<GenerateEntityFromSelection, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public GenerateEntityFromSelection makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection,
				FlexoEditor editor) {
	...
	GenerateEntityFromSelection(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection, FlexoEditor editor) {
		super(actionType, focusedObject, globalSelection, editor);
	}

	public List<AgileBirdsObject> getSelection() {
		ArrayList<AgileBirdsObject> reply = new ArrayList<AgileBirdsObject>();
