...
public class ImportDMEOModel extends FlexoAction {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, ExternalDatabaseRepository.class);
		AgileBirdsObject.addActionForClass(actionType, ProjectDatabaseRepository.class);
	}

	ImportDMEOModel(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
