...
public class AddActivityMetricsDefinition extends AddMetricsDefinition {
	...
	public static FlexoActionType<AddMetricsDefinition, FlexoWorkflow, WorkflowModelObject> actionType = new FlexoActionType<AddMetricsDefinition, FlexoWorkflow, WorkflowModelObject>(
			"add_activty_metrics_definition", FlexoActionType.newMenu, FlexoActionType.newMenuGroup1, FlexoActionType.ADD_ACTION_TYPE) {
		...
		public AddMetricsDefinition makeNewAction(FlexoWorkflow focusedObject, Vector<WorkflowModelObject> globalSelection,
				FlexoEditor editor) {
			return new AddActivityMetricsDefinition(focusedObject, globalSelection, editor);
		}
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, FlexoWorkflow.class);
	}

	protected AddActivityMetricsDefinition(FlexoWorkflow focusedObject, Vector<WorkflowModelObject> globalSelection, FlexoEditor editor) {
		super(actionType, focusedObject, globalSelection, editor);
	}

	@Override
	protected void doAction(Object context) throws FlexoException {
		getFocusedObject().addToActivityMetricsDefinitions(createMetricsDefinition());
	}
