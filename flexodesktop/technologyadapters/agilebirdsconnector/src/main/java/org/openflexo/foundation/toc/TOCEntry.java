...
public class TOCEntry extends TOCObject implements Sortable, InspectableObject, ReferenceOwner, Bindable {
	...
	public TOCEntry(TOCData generatedCode, AgileBirdsObject modelObject, PredefinedSection.PredefinedSectionType identifier) {
	...
	public TOCEntry getTOCEntryForObject(AgileBirdsObject object) {
		if (object == null) {
			return null;
		}
		for (TOCEntry entry : tocEntries) {
	...
	@Deprecated
	public AgileBirdsObject getObject(boolean forceResourceLoad) {
	...
	@Deprecated
	public void setObject(AgileBirdsObject object) {
		if (objectReference != null) {
			objectReference.delete();
