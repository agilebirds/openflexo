...
public class ExportDocumentationTemplates extends FlexoAction<ExportDocumentationTemplates, DGRepository, CGObject> {
	...
	public static final FlexoActionType<ExportDocumentationTemplates, DGRepository, CGObject> actionType = new FlexoActionType<ExportDocumentationTemplates, DGRepository, CGObject>(
		...
		@Override
		public boolean isEnabledForSelection(DGRepository object, Vector<CGObject> globalSelection) {
			return object != null;
		}

		@Override
		public boolean isVisibleForSelection(DGRepository object, Vector<CGObject> globalSelection) {
	...
	static {
		AgileBirdsObject.addActionForClass(ExportDocumentationTemplates.actionType, DGRepository.class);
	}
