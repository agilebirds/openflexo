...
public class MoveTabLeft extends FlexoUndoableAction {
	...
	static {
		...
		AgileBirdsObject.addActionForClass(actionType, IETabWidget.class);
	}

	protected MoveTabLeft(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
