...
public class AddPort extends FlexoAction<AddPort, WKFObject, WKFObject> {
	...
	public static class AddPortActionType extends FlexoActionType<AddPort, WKFObject, WKFObject> {
		...
		protected AddPortActionType(String actionName, CreatedPortType type) {
			super(actionName, FlexoActionType.newMenu, FlexoActionType.newMenuGroup4, FlexoActionType.ADD_ACTION_TYPE);
			_type = type;
		}
		...
		public boolean isVisibleForSelection(WKFObject focusedObject, Vector<WKFObject> globalSelection) {
			return !(focusedObject instanceof FlexoProcess);
		}
	...
	public static final AddPortActionType createDeletePort = new AddPortActionType("create_delete_instance_port",
			CreatedPortType.DELETE_PORT);
	...
	static {
		AgileBirdsObject.addActionForClass(createPort, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(createNewPort, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(createDeletePort, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(createInPort, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(createOutPort, FlexoProcess.class);
		AgileBirdsObject.addActionForClass(createInOutPort, FlexoProcess.class);

		AgileBirdsObject.addActionForClass(createPort, PortRegistery.class);
		AgileBirdsObject.addActionForClass(createNewPort, PortRegistery.class);
		AgileBirdsObject.addActionForClass(createDeletePort, PortRegistery.class);
		AgileBirdsObject.addActionForClass(createInPort, PortRegistery.class);
		AgileBirdsObject.addActionForClass(createOutPort, PortRegistery.class);
		AgileBirdsObject.addActionForClass(createInOutPort, PortRegistery.class);

		AgileBirdsObject.addActionForClass(createPort, FlexoPort.class);
		AgileBirdsObject.addActionForClass(createNewPort, FlexoPort.class);
		AgileBirdsObject.addActionForClass(createDeletePort, FlexoPort.class);
		AgileBirdsObject.addActionForClass(createInPort, FlexoPort.class);
		AgileBirdsObject.addActionForClass(createOutPort, FlexoPort.class);
		AgileBirdsObject.addActionForClass(createInOutPort, FlexoPort.class);
	}
