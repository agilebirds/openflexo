...
public abstract class ComponentInstance extends IEObject implements Bindable, FlexoObserver, Validable {
	...
	/**
	 * Returns owner for this component instance, if it has been set. The owner of a ComponentInstance is the AgileBirdsObject which emmbed
	 * this instance.
	 */
	...
	/**
	 * Sets owner for this component instance. The owner of a ComponentInstance is the AgileBirdsObject which emmbed this instance.
	 * 
	 * @param owner
	 */
	...
	public abstract static class CheckAllBindingsRule extends ValidationRule<CheckAllBindingsRule, ComponentInstance> {
		...
		public class MissingRequiredBinding extends ValidationError<CheckAllBindingsRule, ComponentInstance> {
			...
			public MissingRequiredBinding(ComponentInstance ci, ComponentInstanceBinding aComponentInstanceBinding) {
				...
				ownerIdentifier = componentInstanceBinding.getComponentInstance().getOwner() != null ? ((AgileBirdsObject) componentInstanceBinding
			...
			@Override
			public AgileBirdsObject getSelectableObject() {
				return (AgileBirdsObject) componentInstanceBinding.getComponentInstance().getOwner();
			}
		}
