...
public class DKVBinding extends StaticBinding<Key> {
	...
	public DKVBinding(BindingDefinition bindingDefinition, AgileBirdsObject owner) {
		super(bindingDefinition, owner);
	}

	public DKVBinding(BindingDefinition bindingDefinition, AgileBirdsObject owner, Key aValue) {
