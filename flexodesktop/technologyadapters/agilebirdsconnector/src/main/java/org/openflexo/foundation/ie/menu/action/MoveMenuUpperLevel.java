...
public class MoveMenuUpperLevel extends FlexoAction {
	...
	static {
		AgileBirdsObject.addActionForClass(actionType, FlexoItemMenu.class);
	}
	 ...
	 */
	protected MoveMenuUpperLevel(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
