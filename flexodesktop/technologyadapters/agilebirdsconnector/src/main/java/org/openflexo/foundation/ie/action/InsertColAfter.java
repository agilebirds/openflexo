...
public class InsertColAfter extends FlexoAction {
	private static final Logger logger = FlexoLogger.getLogger(InsertColAfter.class.getPackage().getName());

	public static FlexoActionType actionType = new FlexoActionType("insert_col_after", FlexoActionType.defaultGroup,
		...
		public FlexoAction makeNewAction(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
			return new InsertColAfter(focusedObject, globalSelection, editor);
		}
	...
	InsertColAfter(FlexoObject focusedObject, Vector globalSelection, FlexoEditor editor) {
	...
	protected void doAction(Object context) {
		if (getFocusedTD() != null && getFocusedTD().htmlTable() != null) {
			...
			getFocusedTD().htmlTable().insertCol(getFocusedTD().getXLocation() + 1);
		}
	}
