...
public class AddServiceOperation extends FlexoAction<AddServiceOperation, AgileBirdsObject, AgileBirdsObject> {

	private static final Logger logger = Logger.getLogger(AddServiceOperation.class.getPackage().getName());

	public static FlexoActionType<AddServiceOperation, AgileBirdsObject, AgileBirdsObject> actionType = new FlexoActionType<AddServiceOperation, AgileBirdsObject, AgileBirdsObject>(
		 ...
		 */
		@Override
		public AddServiceOperation makeNewAction(AgileBirdsObject focusedObject, Vector<AgileBirdsObject> globalSelection,
				FlexoEditor editor) {
	...
	AddServiceOperation(AgileBirdsObject focusedObject, Vector globalSelection, FlexoEditor editor) {
