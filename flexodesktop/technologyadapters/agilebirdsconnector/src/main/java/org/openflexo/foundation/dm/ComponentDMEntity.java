...
public class ComponentDMEntity extends DMEntity {
	...
	public ComponentDMEntity(DMModel dmModel, ComponentDefinition componentDefinition) {
		super(dmModel, componentDefinition.getName(), dmModel.getComponentRepository().getDefaultComponentPackage().getName(),
				componentDefinition.getName(), DMType.makeResolvedDMType(dmModel.getWORepository().getCustomComponentEntity()));
		_bindingDefinitions = new Vector<ComponentBindingDefinition>();
		_mandatoryBindingProperties = new Vector<DMProperty>();
		_settableBindingProperties = new Vector<DMProperty>();
		_bindableProperties = new Vector<DMProperty>();
	...
	/**
	 * Stores in an hashtable ComponentBindingDefinition related to a DMProperty Ensure that no new ComponentBindingDefinition is created
	 * once a property is renamed
	 */
