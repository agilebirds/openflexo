...
public class OpenExecutionPetriGraph extends FlexoUndoableAction<OpenExecutionPetriGraph, PetriGraphNode, WKFObject> {
	...
	static {
		AgileBirdsObject.addActionForClass(OpenExecutionPetriGraph.actionType, SelfExecutableActivityNode.class);
		AgileBirdsObject.addActionForClass(OpenExecutionPetriGraph.actionType, SelfExecutableOperationNode.class);
		AgileBirdsObject.addActionForClass(OpenExecutionPetriGraph.actionType, SelfExecutableActionNode.class);
	}
