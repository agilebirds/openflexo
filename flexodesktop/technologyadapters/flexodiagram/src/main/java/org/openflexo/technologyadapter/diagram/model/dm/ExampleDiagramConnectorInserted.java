 ...
 * 
 */
public class ExampleDiagramConnectorInserted extends ViewPointDataModification {

	private ExampleDiagramObject _parent;

	public ExampleDiagramConnectorInserted(ExampleDiagramConnector connector, ExampleDiagramObject parent) {
