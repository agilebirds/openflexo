...
import org.openflexo.technologyadapter.owl.rm.FlexoProjectOntologyResource;
...
public class OWLModel extends OWLOntology implements FlexoModel<OWLMetaModel> {
	...
	/**
	 * Creates and returns a newly created OWL model with resource management (creates the resource)
	 * 
	 * @return a newly created DMModel
	 */
	public static OWLModel createNewOWLModel(FlexoProject project, OWLMetaModel metaModel) {
		...
		OWLModel newProjectOntology = createNewOWLModel(project.getURI(), owlFile, project.getProjectOntologyLibrary());
	...
	private static OWLModel createNewOWLModel(String anURI, File owlFile, ProjectOntologyLibrary ontologyLibrary) {
		OWLModel returned = new OWLModel(anURI, owlFile, ontologyLibrary);
	...
	@Override
	public OWLMetaModel getMetaModel() {
