...
public interface ExcelMetaModelResource extends FlexoFileResource<ExcelMetaModel>,
		FlexoMetaModelResource<ExcelModel, ExcelMetaModel, ExcelTechnologyAdapter> {
