 ...
 * 
 */
public abstract class ExcelModelResourceImpl extends FlexoFileResourceImpl<XMLModel> implements ExcelModelResource {
	 ...
	 * @return
	 */
	public static ExcelModelResource makeXMLModelResource(String modelURI, File modelFile, ExcelMetaModelResource xsdMetaModelResource,
	 ...
	 * @return
	 */
	public static ExcelModelResource retrieveXMLModelResource(File modelFile, ExcelMetaModelResource xsdMetaModelResource,
			XSDTechnologyContextManager technologyContextManager) {
		try {
			ModelFactory factory = new ModelFactory(ExcelModelResource.class);
			ExcelModelResourceImpl returned = (ExcelModelResourceImpl) factory.newInstance(ExcelModelResource.class);
