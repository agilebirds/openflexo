    ...
    public ComponentLibraryBrowserView(IEController controller)
    {
        ...
        treeView.setCellRenderer(new BrowserViewCellRenderer() {
                    ...
                    boolean hasFocus)
            {
                ...
                if (_controller.getCurrentModuleView()!=null && (((BrowserElement)value).getObject() == _controller.getCurrentModuleView().getRepresentedObject() ||(_controller.getCurrentModuleView().getRepresentedObject() instanceof ComponentInstance &&((ComponentInstance)_controller.getCurrentModuleView().getRepresentedObject()).getComponentDefinition()==(((BrowserElement)value).getObject())))) {
