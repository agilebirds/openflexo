    ...
    public AskNewTabDialog(FlexoComponentLibrary lib)
    {
        ...
        newTabChoice.getDocument().addDocumentListener(new DocumentListener(){
			...
			public void insertUpdate(DocumentEvent e){
                ...
                if (tabTitle.getText()==null||tabTitle.getText().trim().length()==0||tabTitle.getText().equals(newTabChoice.getText().substring(0,newTabChoice.getText().length()-1)))
			...
			public void removeUpdate(DocumentEvent e){
                ...
                if (tabTitle.getText()==null||tabTitle.getText().trim().length()==0||newTabChoice.getText().equals(tabTitle.getText().substring(0,tabTitle.getText().length()-1)))
                    tabTitle.setText(newTabChoice.getText());
            }
        });
