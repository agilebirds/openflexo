...
public class IEWOComponentView extends IEPanel implements GraphicalFlexoObserver,IEViewManaging,SelectionSynchronizedModuleView<ComponentInstance>, ChangeListener, Layoutable {
...
//	        }
    ...
    /**
     * Return all the views representing current selection represented IN THIS
     * VIEW (this is not the selection of the selection manager), as a Vector of
     * IESelectable
     *
	...
	public void fireObjectSelected(FlexoModelObject object)
    {
        if (object instanceof IEWidget && !(object instanceof IETRWidget)) {
            ...
            if (view != null) {
            	...
            	if(logger.isLoggable(Level.FINE))
            		logger.fine("model " + object + " is selected, but I cannot find it's view...:-( in " + this+" this message is normal if the view is located in a PartialComponent");
            }
        }
    }
