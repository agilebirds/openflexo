	...
	protected FlexoActionInitializer<AddCVSRepository> getDefaultInitializer() 
	{
		return new FlexoActionInitializer<AddCVSRepository>() {
			...
			public boolean run(ActionEvent e, AddCVSRepository action)
            {
                ...
                TextFieldParameter hostName = new TextFieldParameter("hostName", "host_name", 
                		(action.getHostName() == null ? "" : action.getHostName()));
                TextFieldParameter repository = new TextFieldParameter("cvsRepositoryPath", "cvs_repository_path", 
       			...
       			EnumDropDownParameter<CVSRepository.ConnectionType> connectionTypeParam 
    			= new EnumDropDownParameter<CVSRepository.ConnectionType> (
    					"connectionType",
    					"connection_type",
    					CVSRepository.ConnectionType.PServer,
    					CVSRepository.ConnectionType.values());
       			...
       			TextFieldParameter userName = new TextFieldParameter("userName", "user_name", 
                ...
                AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(getProject(), null, 
                		FlexoLocalization
						        		.localizedForKey("declare_new_cvs_repository"), FlexoLocalization
                		.localizedForKey("enter_parameters_for_the_new_cvs_repository"), paramName, hostName, port, repository, connectionTypeParam, userName, passwd, storePasswd);
