...
public class OpenSharedProjectInitializer extends ActionInitializer {
	...
	protected FlexoActionInitializer<OpenSharedProject> getDefaultInitializer() 
	{
		return new FlexoActionInitializer<OpenSharedProject>() {
            @Override
			public boolean run(ActionEvent e, OpenSharedProject action)
            {
            			...
            			int returned = FlexoController.selectOption(
              			...
              			if (returned == 0) {
              				...
              				repository = createNewRepository.getNewCVSRepository();
                   			...
                   			= new CVSRepositoryParameter("CVSRepository", "cvs_repository",null);
                                 
                			AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(
                					getProject(), null, 
                					FlexoLocalization
                					.localizedForKey("share_project"), FlexoLocalization
                					.localizedForKey("please_chooose_a_cvs_repository_in_which_to_import_project"), repositoryChoice);
