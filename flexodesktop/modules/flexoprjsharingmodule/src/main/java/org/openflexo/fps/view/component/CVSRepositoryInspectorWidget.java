 ...
 * 
 */
public class CVSRepositoryInspectorWidget extends CustomInspectorWidget<CVSRepository>
{

    protected static final Logger logger = Logger.getLogger(CVSRepositoryInspectorWidget.class.getPackage().getName());

    protected CVSRepositorySelector _selector;

    public CVSRepositoryInspectorWidget(PropertyModel model, AbstractController controller)
    {
        super(model,controller);
        _selector = new CVSRepositorySelector(FPSController.getInstance().getRepositories(), null) {
            @Override
			public void apply()
            {
                super.apply();
