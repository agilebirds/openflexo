...
public class ViewPointPerspective extends FlexoPerspective {
    ...
    public JComponent getHeader() {
        if (_controller.getCurrentModuleView() instanceof CalcDrawingShemaModuleView) {
            return ((CalcDrawingShemaModuleView) _controller.getCurrentModuleView()).getController().getScalePanel();
        }
        return null;
    }
    ...
    public ModuleView<? extends FlexoModelObject> createModuleViewForObject(FlexoModelObject object, FlexoController controller) {
        ...
        /*
         * if (object instanceof ImportedOWLOntology) { ((ImportedOWLOntology) object).loadWhenUnloaded(); return new
         * OntologyView((ImportedOWLOntology) object, (VPMController) controller, this); }
         */
        if (object instanceof ViewPoint) {
