...
public class StandardEditionPatternView extends EditionPatternView<EditionPattern> {
	...
	public StandardEditionPatternView(EditionPattern editionPattern, VPMController controller) {
		super(editionPattern, controller, VPMCst.STANDARD_EDITION_PATTERN_VIEW_FIB);
	}
