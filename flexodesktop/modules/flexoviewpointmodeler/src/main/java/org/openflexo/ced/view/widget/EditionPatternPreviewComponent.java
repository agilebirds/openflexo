...
public class EditionPatternPreviewComponent extends JPanel 
implements FIBCustomComponent<EditionPattern,JPanel>, FIBSelectable {
	...
	public void setEditedObject(EditionPattern object)
	{
		if (object != editionPattern) {
			...
			if (previewController != null && object != null) {
				if (previewController.getDrawingView() != null) remove(previewController.getDrawingView());
	...
	public void setSelectionManager(SelectionManager selectionManager)
	{
		...
		if (previewController != null) previewController.setSelectionManager(selectionManager);
	}
	...
	public Object getSelectedObject()
	{
		if (previewController != null) {
			if (previewController.getSelectedObjects() == null) return null;
