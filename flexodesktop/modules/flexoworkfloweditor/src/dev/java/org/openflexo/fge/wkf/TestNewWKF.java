...
public class TestNewWKF {

	private static final Logger logger = FlexoLogger.getLogger(TestNewWKF.class.getPackage().getName());
	...
	public static ProcessEditorController makeProcessRepresentation(FlexoProcess process)
	{
		return new ProcessEditorController(
				process,
	...
	public static void showPanel(final FlexoProcess process)
	{
		...
		ProcessEditorController controller = makeProcessRepresentation(process);
