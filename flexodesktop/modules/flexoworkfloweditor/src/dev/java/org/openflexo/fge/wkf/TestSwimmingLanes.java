...
public class TestSwimmingLanes {

	private static final Logger logger = FlexoLogger.getLogger(TestSwimmingLanes.class.getPackage().getName());
	...
	public static FlexoProject loadProject()
	{
		...
		FlexoEditor editor;
		File projectFile = new File("/Users/sylvain/Documents/TestsFlexo/BC/TestSWLLayout.prj");
		//FileResource projectFile = new FileResource("src/dev/resources/TestFGE.prj");
		//File projectFile = new File("/Users/sylvain/Documents/TestsFlexo/BC/TestNewConnectors.prj");
		//File projectFile = new File("/Users/sylvain/Documents/TestsFlexo/BA/TestOperatorConversion/TestOperator.prj");
		//File projectFile = new File("/Users/sylvain/Documents/TestsFlexo/BA/FlexoReleaseLifeCycle.prj");
	...
	public static void main(String[] args) 
	{
		...
		showPanel(project.getRootFlexoProcess());
		//showPanel(project.getFlexoProcess("NewProcess2"));
		//showPanel(project.getFlexoProcess("NewProcess3"));
		//showPanel(project.getFlexoProcess("NewProcess4"));
		
	}


	public static SwimmingLaneEditorController makeProcessRepresentation(FlexoProcess process)
	{
		return new SwimmingLaneEditorController(
				process,
				new InteractiveFlexoEditor(process.getProject()) {
					@Override
	...
	public static void showPanel(final FlexoProcess process)
	{
		final TestWKFInspector inspector = new TestWKFInspector();

		final SwimmingLaneEditorController controller = makeProcessRepresentation(process);
