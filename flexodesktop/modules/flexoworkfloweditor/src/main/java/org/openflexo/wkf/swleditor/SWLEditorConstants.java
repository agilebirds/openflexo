...
public interface SWLEditorConstants {

	public static final String SWIMMING_LANE_EDITOR = "swl";

	public static final int SWIMMING_LANE_BORDER = 10;

	public static final int DEFAULT_BEGIN_Y_OFFSET = 10;

	static final int DEFAULT_SWIMMING_LANE_HEIGHT = 120;

	static final int DEFAULT_SWIMMING_LANE_MARGIN = 40;
	...
	public static final int ROLE_LAYER = 1;
