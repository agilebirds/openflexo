...
public class ImportRolesInitializer extends ActionInitializer
{
	...
	private Vector<PPMRole> selectRolesToImport(PPMRole[] roles) {
		...
		AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(getProject(), FlexoLocalization.localizedForKey("import_roles"), FlexoLocalization.localizedForKey("select_roles_to_import"), parameters);
