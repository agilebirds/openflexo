	...
	protected FlexoActionInitializer<AddServiceInterface> getDefaultInitializer() 
	{
		return new FlexoActionInitializer<AddServiceInterface>() {
			...
			public boolean run(ActionEvent e, AddServiceInterface action)
            {
                ...
                parameters[1] = new InfoLabelParameter("infoLabel", "description", FlexoLocalization
                        .localizedForKey("add_service_interface_description"));
                AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(getProject(), null, FlexoLocalization
								                .localizedForKey("add_service_interface"), FlexoLocalization.localizedForKey("add_service_interface"), parameters);
