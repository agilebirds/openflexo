...
public class AssociateActionsWithButtons extends FlexoDialog
{
    ...
    // out buttons are also Hyperlink
    {
        ...
        if (getSize().height > Toolkit.getDefaultToolkit().getScreenSize().height
            ...
            JScrollPane pane = new JScrollPane(mainPane, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    public class ButtonPanel extends JPanel
    {
        ...
        private void initPanel()
        {
            ...
            if (button instanceof IEButtonWidget) {
                ...
                icon = WRLocator.locate(b.getProject().getProjectDirectory(), b.getImageName(), css == null ? FlexoCSS.CONTENTO.getName() : css.getName());
            } else {
