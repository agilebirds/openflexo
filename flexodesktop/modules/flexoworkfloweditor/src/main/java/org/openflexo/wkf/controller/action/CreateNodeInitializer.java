...
public class CreateNodeInitializer extends ActionInitializer {
		...
		return new FlexoActionInitializer<CreateNode>() {
			...
			public boolean run(ActionEvent e, CreateNode action)
            {
             	if (!action.isNewNodeNameInitialized()) {
            		TextFieldParameter newNodeNameParam = new TextFieldParameter(
							"newBeginNodeName", "new_node_name", action.getNewNodeName());
					AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(
							getProject(), 
							null,
							action.getLocalizedName(), FlexoLocalization.localizedForKey("please_enter_name_for_newly_created_node"), newNodeNameParam);
	...
	public void init()
	{
		initActionType(CreateNode.createActivityBeginNode,
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.BEGIN_ACTIVITY_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createActivityEndNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.END_ACTIVITY_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createActivityNormalNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.ACTIVITY_NODE_ICON, 
				getDisabledIcon());

		initActionType(CreateNode.createOperationBeginNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.BEGIN_OPERATION_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createOperationEndNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.END_OPERATION_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createOperationNormalNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.OPERATION_NODE_ICON, 
				getDisabledIcon());

		initActionType(CreateNode.createActionBeginNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.BEGIN_ACTION_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createActionEndNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.END_ACTION_ICON, 
				getDisabledIcon());
		initActionType(CreateNode.createActionNormalNode,
				getDefaultInitializer(), 
				getDefaultFinalizer(), 
				getDefaultUndoInitializer(), 
				getDefaultUndoFinalizer(), 
				...
				getVisibleCondition(),
				getShortcut(), 
				WKFIconLibrary.ACTION_NODE_ICON, 
				getDisabledIcon());
	}
