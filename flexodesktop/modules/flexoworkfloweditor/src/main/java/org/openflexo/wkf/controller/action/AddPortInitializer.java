...
public class AddPortInitializer extends ActionInitializer<AddPort, WKFObject, WKFObject> {

	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());
	private final Icon icon;

	AddPortInitializer(FlexoActionType<AddPort, WKFObject, WKFObject> actionType, Icon icon,
