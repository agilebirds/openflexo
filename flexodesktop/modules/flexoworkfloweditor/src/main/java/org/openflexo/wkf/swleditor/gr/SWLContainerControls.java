...
public class SWLContainerControls extends ControlArea<FGERectangle> implements SWLEditorConstants {
	...
	private static FGERectangle makeRoundRect(SWLContainerGR containerGR)
	{
		...
		return new FGERectangle(
				x/containerGR.getWidth(),
				y/containerGR.getHeight(),
				width/containerGR.getWidth(),
				height/containerGR.getHeight(),
				Filling.FILLED);
	}
	...
	public SWLContainerControls(SWLContainerGR containerGR)
	{
		...
		upDownIconsRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER-5,containerGR.getHeight()-31,WKFIconLibrary.MINUS.getImage().getWidth(null),29+WKFIconLibrary.MINUS.getImage().getHeight(null),Filling.FILLED)).transform(at);
		otherIconsRect  = (FGERoundRectangle)(new FGERoundRectangle(SWIMMING_LANE_BORDER+7,containerGR.getHeight()-31,37,37,20,20,Filling.FILLED)).transform(at);;

		upIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER+18,_containerGR.getHeight()-30,WKFIconLibrary.TRIANGLE_UP.getImage().getWidth(null),WKFIconLibrary.TRIANGLE_UP.getImage().getHeight(null),Filling.FILLED)).transform(at);
		downIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER+18,_containerGR.getHeight()-10,WKFIconLibrary.TRIANGLE_DOWN.getImage().getWidth(null),WKFIconLibrary.TRIANGLE_DOWN.getImage().getHeight(null),Filling.FILLED)).transform(at);
		leftIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER+8,_containerGR.getHeight()-20,WKFIconLibrary.TRIANGLE_LEFT.getImage().getWidth(null),WKFIconLibrary.TRIANGLE_UP.getImage().getHeight(null),Filling.FILLED)).transform(at);
		rightIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER+29,_containerGR.getHeight()-20,WKFIconLibrary.TRIANGLE_RIGHT.getImage().getWidth(null),WKFIconLibrary.TRIANGLE_DOWN.getImage().getHeight(null),Filling.FILLED)).transform(at);
		minusIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER-5,_containerGR.getHeight()-31,WKFIconLibrary.MINUS.getImage().getWidth(null),WKFIconLibrary.MINUS.getImage().getHeight(null),Filling.FILLED)).transform(at);
		plusIconRect = (FGERectangle)(new FGERectangle(SWIMMING_LANE_BORDER-5,_containerGR.getHeight()-2,WKFIconLibrary.PLUS.getImage().getWidth(null),WKFIconLibrary.PLUS.getImage().getHeight(null),Filling.FILLED)).transform(at);
	...
	{
		AffineTransform at = GraphicalRepresentation.convertNormalizedCoordinatesAT((GraphicalRepresentation)_containerGR, drawingGraphics.getGraphicalRepresentation());				
