...
import org.openflexo.oe.shema.DrawEdgeControl.DrawEdgeAction;


public class OEShemaView extends DrawingView<OEShemaRepresentation> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(OEShemaView.class.getPackage().getName());

	public OEShemaView(OEShemaRepresentation aDrawing,OEShemaController controller)
	{
