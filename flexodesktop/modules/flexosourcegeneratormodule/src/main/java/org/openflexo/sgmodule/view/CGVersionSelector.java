 ...
 * 
 */
public class CGVersionSelector extends AbstractBrowserSelector<AbstractCGFileVersion> {
	...
	public CGVersionSelector(CGFile aFile, AbstractCGFileVersion version, int cols) {
		super(aFile.getProject(), version, AbstractCGFileVersion.class, cols);
		setFile(aFile);
	}

	@Override
	protected CGVersionSelectorPanel makeCustomPanel(AbstractCGFileVersion editedObject) {
		return new CGVersionSelectorPanel();
	}
	...
	@Override
	public CGVersionSelectorPanel getSelectorPanel() {
		return (CGVersionSelectorPanel) super.getSelectorPanel();
	}

	protected class CGVersionSelectorPanel extends AbstractSelectorPanel<AbstractCGFileVersion> {
		protected CGVersionSelectorPanel() {
			super(CGVersionSelector.this);
		}
	...
	protected class CGVersionBrowser extends ConfigurableProjectBrowser {
		protected CGVersionBrowser() {
			super(SGBrowser.makeBrowserConfigurationForFileHistory(file));
		}
