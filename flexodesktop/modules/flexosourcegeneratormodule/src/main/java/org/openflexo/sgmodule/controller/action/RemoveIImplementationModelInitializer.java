...
public class RemoveIImplementationModelInitializer extends ActionInitializer {

	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());

	RemoveIImplementationModelInitializer(SGControllerActionInitializer actionInitializer)
	{
