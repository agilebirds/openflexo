				...
				if (_cgFile.getResource() instanceof GenerationAvailableFileResource) {
					...
					if (resource.getGenerator() != null) {
						if (resource.getGenerator().hasFormattingException()) {
							addInfoPanel(CGIconLibrary.UNFIXABLE_WARNING_ICON, FlexoLocalization.localizedForKey("formatting_warning_title"), FlexoLocalization
									.localizedForKey("formatting_warning_description"));
						}
						if (resource.getGenerator().hasAppendingException()) {
							addInfoPanel(CGIconLibrary.UNFIXABLE_WARNING_ICON, FlexoLocalization.localizedForKey("appending_warning_title"), FlexoLocalization
									.localizedForKey("appending_warning_description"));
						}
					}
				}
