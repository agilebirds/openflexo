...
public class CGSymbolicDirectoryElement extends SGBrowserElement {
	public CGSymbolicDirectoryElement(CGSymbolicDirectory dir, ProjectBrowser browser, BrowserElement parent) {
