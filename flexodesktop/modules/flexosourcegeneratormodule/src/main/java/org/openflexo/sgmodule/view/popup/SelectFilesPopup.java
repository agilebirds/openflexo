...
public class SelectFilesPopup extends MultipleObjectSelectorPopup {
    ...
    public SelectFilesPopup(String label, String description, String unlocalizedValidateButtonLabel, Vector<AbstractCGFile> files, FlexoProject project, SGController controller)
    {
