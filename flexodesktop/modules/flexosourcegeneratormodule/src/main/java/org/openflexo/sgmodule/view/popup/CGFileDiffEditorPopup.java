...
public class CGFileDiffEditorPopup extends FlexoDialog {
	...
	public CGFileDiffEditorPopup(CGFile file, ContentSource leftSource, ContentSource rightSource, SGController controller) {
		...
		customDiffCodeDisplayer = new CustomDiffCodeDisplayer((GenerationAvailableFileResource) file.getResource(), _leftSource,
				_rightSource, controller);
	...
	protected class ViewHeader extends JPanel {
		...
		protected ViewHeader() {
			...
			subTitle1.setFont(SGCst.SUB_TITLE_FONT);
			...
			subTitle2.setFont(SGCst.SUB_TITLE_FONT);
	...
	protected void selectedSourcesChanged() {
		...
		customDiffCodeDisplayer = new CustomDiffCodeDisplayer((GenerationAvailableFileResource) _cgFile.getResource(), _leftSource,
