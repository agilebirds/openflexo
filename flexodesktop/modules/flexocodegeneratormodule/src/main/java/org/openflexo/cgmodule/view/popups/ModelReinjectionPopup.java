...
public class ModelReinjectionPopup extends MultipleObjectSelectorPopup {
    ...
    public ModelReinjectionPopup(String title, String label,
    		Vector<CGJavaFile> javaFiles, FlexoProject project, GeneratorController controller) throws FJPParseException
    {
        super(title,
        		label,
        		FlexoLocalization.localizedForKey("model_reinjection_description"),
        		"update_model",
        		new ModelReinjectionBrowserConfiguration(javaFiles,project),
        		project,
        ...
        for (CGJavaFile javaFile : javaFiles) {
        	if (javaFile.getParseException() != null) throw javaFile.getParseException().getParseException();
    ...
    protected static class ModelReinjectionBrowserConfiguration implements TabularBrowserConfiguration 
    {
        ...
        protected ModelReinjectionBrowserConfiguration(Vector<CGJavaFile> javaFiles, FlexoProject project)
        {
        	_project = project;
