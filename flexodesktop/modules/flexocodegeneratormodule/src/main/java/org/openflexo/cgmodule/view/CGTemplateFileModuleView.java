 ...
 * @author sylvain
 */
public class CGTemplateFileModuleView extends JPanel implements ModuleView<CGTemplate>, FlexoActionSource, FlexoObserver,
	...
	public CGTemplateFileModuleView(CGTemplate CGTemplate, GeneratorController controller) {
