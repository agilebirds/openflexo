...
import org.openflexo.cgmodule.controller.browser.GeneratedCodeFileElement;
import org.openflexo.cgmodule.controller.browser.GeneratedCodeFolderElement;
...
public class SelectFilesPopup extends MultipleObjectSelectorPopup {
    ...
    public SelectFilesPopup(String label, String description, String unlocalizedValidateButtonLabel, Vector<AbstractCGFile> files, FlexoProject project, GeneratorController controller)
    {
        super(FlexoLocalization.localizedForKey("file_selection"),
        		label,
        		description,
        		unlocalizedValidateButtonLabel,
        		new SelectFilesPopupBrowserConfiguration(files,project),
        		project,
                    ...
                    return new GeneratedCodeFolderElement((CGFolder)object,browser,parent) {
                        ...
                        public ImageIcon getBaseIcon()
                    	{
                    		if (getFolder().getParent() == null) {
								return CGIconLibrary.SYMBOLIC_FOLDER_ICON;
							}
