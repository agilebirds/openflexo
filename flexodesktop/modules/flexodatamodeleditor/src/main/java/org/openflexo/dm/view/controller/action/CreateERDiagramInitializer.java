		...
		return new FlexoActionInitializer<CreateERDiagram>() {
			...
			public boolean run(EventObject e, final CreateERDiagram action) {
				...
				MultipleObjectParameter<DMEntity> entitiesParam = new MultipleObjectParameter<DMEntity>("entities",
						"select_entities_to_put_in_the_diagram", action.getEntitiesToPutInTheDiagram());
				...
				AskParametersDialog dialog = AskParametersDialog.createAskParametersDialog(getProject(), null, action.getLocalizedName(),
						FlexoLocalization.localizedForKey("please_define_new_entities_relationship_parameters"), nameParam,
						/*repositoryParam,*/
						entitiesParam);
