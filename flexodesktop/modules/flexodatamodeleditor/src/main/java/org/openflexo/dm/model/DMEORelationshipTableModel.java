    ...
    public DMEORelationshipTableModel(DMEOEntity entity, DMController ctrl)
    {
        ...
        addToColumns(new ToggleIconColumn<DMEORelationship>("read_only", 25) {
            ...
            public String getLocalizedTooltip(DMEORelationship relationship) {
            	return (relationship.getIsReadOnly() ? FlexoLocalization.localizedForKey("is_read_only") : FlexoLocalization.localizedForKey("is_not_read_only"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEORelationship>("settable", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEORelationship relationship) {
            	return (relationship.getIsSettable() ? FlexoLocalization.localizedForKey("can_be_set"):FlexoLocalization.localizedForKey("cannot_be_set"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEORelationship>("class_property", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEORelationship relationship) {
            	return relationship.getIsClassProperty()? FlexoLocalization.localizedForKey("is_class_property") : FlexoLocalization.localizedForKey("is_not_class_property");
            }
        });
        addToColumns(new ToggleIconColumn<DMEORelationship>("is_to_many", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEORelationship relationship) {
            	return (relationship.getIsToMany()? FlexoLocalization.localizedForKey("to_many") : FlexoLocalization.localizedForKey("to_one"));
            }
