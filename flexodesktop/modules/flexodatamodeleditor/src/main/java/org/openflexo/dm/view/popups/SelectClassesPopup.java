...
public class SelectClassesPopup extends MultipleObjectSelectorPopup {
    ...
    public SelectClassesPopup(String title, String label, String description, File jarFile, FlexoProject project, FlexoFrame owner, FlexoProgress progress)
    {
        super(title,label,description,new SelectClassPopupBrowserConfiguration(jarFile,project,progress),project,owner ,owner.getController().getEditor());
    }
    
    public SelectClassesPopup(String title, String label, String description, ExternalRepository externalRepository, FlexoProject project, DMController controller, FlexoProgress progress)
    {
        super(title,label,description,new SelectClassPopupBrowserConfiguration(externalRepository,project,progress),project,controller.getFlexoFrame(),controller.getEditor());
        choicePanel.setSelectedObjects(getDMSet().getSelectedObjects());
    }
    
    public SelectClassesPopup(String title, String label, String description, Vector entities, FlexoProject project, DMController controller, FlexoProgress progress)
    {
        super(title,label,description,new SelectClassPopupBrowserConfiguration(entities,project,progress),project,controller.getFlexoFrame(),controller.getEditor());
        choicePanel.setSelectedObjects(getDMSet().getSelectedObjects());
