...
public class SelectPropertiesAndMethodsPopup extends MultipleObjectSelectorPopup {
    ...
    public SelectPropertiesAndMethodsPopup(String label, String description, String unlocalizedValidateButtonLabel, DMEntity entity, FlexoProject project, DMController controller)
    {
        super(FlexoLocalization.localizedForKey("attribute_selection"),
        		label,
        		description,
        		unlocalizedValidateButtonLabel,
        		new SelectPropertiesPopupBrowserConfiguration(entity),
        		project,
	...
	protected String getPopupTitle()
    {
    	...
    	else return super.getPopupTitle();
    }
