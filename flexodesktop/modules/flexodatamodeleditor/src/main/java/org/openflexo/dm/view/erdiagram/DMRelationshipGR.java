...
public class DMRelationshipGR extends ConnectorGraphicalRepresentation<RelationshipRepresentation> implements ERDiagramConstants {
	...
	public DMRelationshipGR(RelationshipRepresentation aRelationshipRepresentation, Drawing<?> aDrawing) 
	{
		super(ConnectorType.RECT_POLYLIN, 
				(ShapeGraphicalRepresentation<?>)aDrawing.getGraphicalRepresentation(aRelationshipRepresentation.getProperty()),
				(ShapeGraphicalRepresentation<?>)aDrawing.getGraphicalRepresentation(aRelationshipRepresentation.getInverseProperty() != null ? aRelationshipRepresentation.getInverseProperty() : aRelationshipRepresentation.getDestinationEntity()),
				aRelationshipRepresentation, aDrawing);
