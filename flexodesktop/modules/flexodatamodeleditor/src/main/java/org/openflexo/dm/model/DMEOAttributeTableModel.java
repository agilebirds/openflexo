    ...
    public DMEOAttributeTableModel(DMEOEntity entity, DMController ctrl)
    {
        ...
        addToColumns(new ToggleIconColumn<DMEOAttribute>("primary_key", 25) {
            ...
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getIsPrimaryKeyAttribute()?FlexoLocalization.localizedForKey("primary_key") : FlexoLocalization.localizedForKey("not_primary_key"));
            }
        ...
        addToColumns(new ToggleIconColumn<DMEOAttribute>("read_only", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getIsReadOnlyAttribute() ? FlexoLocalization.localizedForKey("is_read_only") : FlexoLocalization.localizedForKey("is_not_read_only"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEOAttribute>("lock", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getIsUsedForLocking() ?FlexoLocalization.localizedForKey("is_used_for_locking"):FlexoLocalization.localizedForKey("is_not_used_for_locking"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEOAttribute>("settable", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getIsSettable() ? FlexoLocalization.localizedForKey("can_be_set"):FlexoLocalization.localizedForKey("cannot_be_set"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEOAttribute>("class_property", 25) {
            ...
            @Override
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getIsClassProperty() ? FlexoLocalization.localizedForKey("is_class_property") : FlexoLocalization.localizedForKey("is_not_class_property"));
            }
        });
        addToColumns(new ToggleIconColumn<DMEOAttribute>("allows_null", 20) {
            ...
            @Override
            public String getLocalizedTooltip(DMEOAttribute attribute) {
            	return (attribute.getAllowsNull() ? FlexoLocalization.localizedForKey("allows_null"): FlexoLocalization.localizedForKey("does_not_allows_null"));
            }
        });
