 ...
 * 
 */
public class DocItemInspectorWidget extends CustomInspectorWidget<DocItem> {

	protected static final Logger logger = Logger.getLogger(DocItemInspectorWidget.class.getPackage().getName());

	protected DocItemSelector _selector;

	public DocItemInspectorWidget(PropertyModel model, AbstractController controller) {
		super(model, controller);
		_selector = new DocItemSelector(null, null) {
			@Override
			public void apply() {
				super.apply();
