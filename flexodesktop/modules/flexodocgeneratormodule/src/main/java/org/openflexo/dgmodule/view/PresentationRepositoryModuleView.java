...
public class PresentationRepositoryModuleView extends JPanel implements ModuleView<PresentationRepository>, FlexoObserver, LogListener, FlexoActionSource
{
    ...
    PresentationRepository codeRepository;
    	...
    	public ConsolePanel(JConsole console) {
    		...
    		clearButton.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
    				PresentationRepositoryModuleView.this.console.clear();
    			}
    		});
     ...
     *
     */
    public PresentationRepositoryModuleView(PresentationRepository repository, DGController ctrl)
    {
        super(new BorderLayout());
...
//        });
     ...
     */
    @Override
	public PresentationRepository getRepresentedObject()
    {
