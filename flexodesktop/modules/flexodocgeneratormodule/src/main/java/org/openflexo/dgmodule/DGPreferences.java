...
public class DGPreferences extends DEPreferences
{
    ...
    /**
     * Returns wheter to automatically dismiss unchanged files after a
     * generation pass or let the user do it manually.
     *
     * @return wheter to automatically dismiss unchanged files after a
     * generation pass or let the user do it manually.
     */
