...
public class GenerateActivityScreenshotInitializer extends ActionInitializer {

	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());

	GenerateActivityScreenshotInitializer(DGControllerActionInitializer actionInitializer)
	{
		super(GenerateActivityScreenshot.actionType,actionInitializer);
	}
	...
	@Override
	protected FlexoActionInitializer<GenerateActivityScreenshot> getDefaultInitializer() 
	{
		return new FlexoActionInitializer<GenerateActivityScreenshot>() {
            @Override
			public boolean run(ActionEvent e, GenerateActivityScreenshot action)
            {
     ...
     @Override
	protected FlexoActionFinalizer<GenerateActivityScreenshot> getDefaultFinalizer() 
	{
		return new FlexoActionFinalizer<GenerateActivityScreenshot>() {
            @Override
			public boolean run(ActionEvent e, GenerateActivityScreenshot action)
            {
