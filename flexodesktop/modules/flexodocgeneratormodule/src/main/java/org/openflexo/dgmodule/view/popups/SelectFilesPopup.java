...
public class SelectFilesPopup extends MultipleObjectSelectorPopup {
    ...
    public SelectFilesPopup(String label, String description, String unlocalizedValidateButtonLabel, Vector<AbstractCGFile> files, FlexoProject project, DGController controller)
    {
        super(FlexoLocalization.localizedForKey("file_selection"),label,description,unlocalizedValidateButtonLabel,new SelectFilesPopupBrowserConfiguration(files,project),project,controller.getFlexoFrame(),controller.getEditor());
                ...
                if (object instanceof DGFilesSet) {
                    ...
                    return new GeneratedDocFolderElement((CGFolder)object,browser,parent) {
                        ...
                        public ImageIcon getBaseIcon()
                    	{
                    		...
                    		return DGIconLibrary.FOLDER_ICON;
                    	}
                    };
                }
