...
public class DGFileHistoryModuleView extends JPanel implements ModuleView<CGFile>, FlexoObserver, FlexoActionSource, SelectionListener
{
	...
	protected class ViewHeader extends JPanel
	{
		...
		protected ViewHeader()
		{
			...
			FlexoActionButton revertToVersionAction = new FlexoActionButton(RevertToHistoryVersion.actionType,"revert_to_version",DGFileHistoryModuleView.this,_controller.getEditor());
			actionButtons.add(revertToVersionAction);
			controlPanel.add(revertToVersionAction);

			FlexoActionButton showDifferencesAction = new FlexoActionButton(ShowDifferences.actionType,"show_differences",DGFileHistoryModuleView.this,_controller.getEditor());
