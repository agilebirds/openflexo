...
/**
 * <p>
 * Class <code>Example2</code> is intented to show an example of xml coding/decoding scheme
 * </p>
 * 
...
public class Example2Test extends TestCase {
	...
	private static final File exampleModelFile = TestFileFinder.findTestFile("example2/ExampleModel.xml");
	private static final File dataFile = TestFileFinder.findTestFile("example2/ExampleSellReport.xml");
	private static final File resultFile = new File(new File(System.getProperty("java.io.tmpdir")), "ResultSellReport.xml");
