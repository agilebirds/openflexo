...
public abstract class KeyValueProperty
{
        ...
        if (field == null) {
            ...
            if (getMethod != null) {
                if (getMethod.getReturnType() != type) {
                    Debugging.warn("Class "+objectClass+" Public field " + lastName + " found, with type " + type.getName() + " found " + " and method " + getMethod.getName()
     ...
     * property type. Don't forget to encapsulate your calls within a synchronized
     * block/method on this KeyValueProperty object.
     */
    	...
    	if (object == null) {
            ...
            if (field != null) {
                ...
                try {
                    ...
                    //e.printStackTrace();
                    throw new InvalidKeyValuePropertyException("InvalidKeyValuePropertyException: class " + getObjectClass().getName() + ": method "
                            + setMethod.getName() + "Argument mismatch: tried to pass a '"+aValue.getClass().getName()+" instead of a "+setMethod.getParameterTypes()[0]+" Exception raised: " + e.toString());
