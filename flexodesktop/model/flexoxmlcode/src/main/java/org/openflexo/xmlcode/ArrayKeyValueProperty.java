...
/**
 * <p>
 * A KeyValue property represents a array property, accessible directly by
...
public class ArrayKeyValueProperty extends KeyValueProperty
{
    ...
    /**
     * Creates a new <code>ArrayKeyValueProperty</code> instance, given an
     * object class.<br>
     ...
     *                if an error occurs
     */
    public ArrayKeyValueProperty(Class anObjectClass, String propertyName, boolean setMethodIsMandatory) throws InvalidKeyValuePropertyException
    {
	...
	protected void init(String propertyName, boolean setMethodIsMandatory) throws InvalidKeyValuePropertyException
    {
        ...
        if (getComponentType().isPrimitive()) {
            throw new InvalidKeyValuePropertyException("Property " + propertyName + " found, but arrays of Java primitives are not yet implemented.");
        }
    }
     ...
     * asserting that this property represents an array property (if not, throw
     * an InvalidKeyValuePropertyException exception)
     *
     * @param aValue
     *            an <code>Object</code> value
     * @exception InvalidKeyValuePropertyException
    ...
    public synchronized void setObjectValueAtIndex(Object aValue, int index, Object object)
    {
        ...
        try {
            ...
            throw new InvalidKeyValuePropertyException("Argument type mismatch: " + aValue.getClass().getName() + " is not a " + getComponentType().getName());
        } catch (Exception e) {
