...
public class ModelEntity
{
    ...
    /**
     * Hashtable of ModelProperty objects (key is the name of the property and
     * value is the ModelEntity related property inherits from)
     */
    protected Hashtable<String, ModelEntity> inheritedModelProperties;

    /**
     * Stores a boolean indicating if this entity is abstract (won't never be
     * instancied directly)
     */
    ...
    /**
     * Stores constructor with parameter (builder class defined in XMLMapping),
     * if any
     */
    ...
    /**
     * Stores decoding finalizing method with parameter (builder class defined
     * in XMLMapping), if any
     */
     ...
     * purposes.<br>
     * Use {@link XMLMapping#registerNewModelEntity(ModelEntity)} to register
     * this new <code>ModelEntity</code> object in an <code>XMLMapping</code>
     * instance. Use {@link #registerNewModelProperty(ModelProperty)} to
     * register new <code>ModelPropery</code> objects.
     * 
     * @param someXMLTags
     *            comma separated strings coding all the values a XML tag could
     *            take
     * @exception InvalidModelException
     *                if an error occurs
     */
    public ModelEntity(String aName, String someXMLTags, boolean abstractFlag, String aFinalizer, XMLMapping anXMLMapping) throws InvalidModelException
    {
    ...
    /**
     * Creates a new <code>ModelEntity</code> instance, given a node
     * <code>anEntityNode</code>
     * 
     * @param anEntityNode
        ...
        try {
            ...
            if (finalizer != null) {
                ...
                if ((!hasFinalizerWithoutParameter()) && (!hasFinalizerWithParameter())) {
                    throw new InvalidModelException("Class " + getName() + " does not implement specified decoding finalizing method : " + finalizer);
                }
            }
        } catch (InvalidModelException e) {
            throw e;
        } catch (Exception e) {
            throw new InvalidModelException("Unexpected error " + e.getClass().getName() + " occurs during model initialization. Please send a bug report.");
        }
    ...
    /**
     * Returns an array of all <code>xmlTag</code> of this
     * <code>ModelEntity</code>
     * 
     * @return a <code>String[]</code> value
     */
    public String[] getXmlTags()
    {
        if (definedXMLTags == null) return null;
        if (derivedXMLTags == null) {
            if (getAvailableContexts().size() == 0) {
                ...
                for (int j=0; j<getAvailableContexts().size(); j++) {
                    for (int i=0; i<definedXMLTags.length; i++) {
                        derivedXMLTags[(j+1)*definedXMLTags.length+i] = (String)getAvailableContexts().elementAt(j)+definedXMLTags[i];
                    }
                }
            }
        }
    ...
    /**
     * Returns an array of all <code>xmlTag</code> of this
     * <code>ModelEntity</code> given a suppliedContext
     * 
     * @return a <code>String[]</code> value
     */
    ...
    /**
     * Returns an ordered enumeration of <code>ModelProperty</code> objects of
     * this <code>ModelEntity</code>
     * 
    ...
    /**
     * Returns <code>ModelProperty</code> object with specified name, null if
	...
	public String toString()
    {
        ...
        String returnedString = "  <entity name=" + '"' + getName() + '"' + " xmlTag=" + '"' + getConcatenedXmlTag() + '"'+ " contexts=" + '"' + getConcatenedContexts() + '"';
    ...
    /**
     * Returns a boolean indicating if this entity is abstract (won't never be
     * instancied directly). An abstract class should be declared in mapping
     * file with abstract XML tag set to true ('YES' value).
     */
    ...
    /**
     * Returns a boolean indicating if entity represents a class which inherits
     * from specified ModelEntity's represented class
     */
    ...
    /**
     * Update this <code>ModelEntity</code> by taking under account specified
     * <code>parentModelEntity</code>
     */
    ...
    /**
     * Returns boolean indicating if related class has a constructor without
     * parameters
     * 
     * @return
     */
    ...
    /**
     * Returns constructor with parameter (builder class defined in XMLMapping),
     * if any
     */
    ...
    /**
     * Returns boolean indicating if related class has a constructor with
     * parameters
     * 
     * @return
     */
    ...
    /**
     * Returns decoding finalizing method with parameter (builder class defined
     * in XMLMapping), if any
     */
    ...
    /**
     * Returns boolean indicating if this entity has a decoding finalizing
     * method without parameter, if any
     */
    ...
    /**
     * Returns boolean indicating if this entity has a decoding finalizing
     * method with parameter (builder class defined in XMLMapping), if any
     */
    ...
    /**
     * Build and returns an Hashtable composed of all ancestors registered in
     * related model, associated with an Integer object representing ancestor
     * level.
     * 
    ...
    {
    	if (genericTypingKVProperty != null) return true;
    	if (getParentEntity() != null) {
	...
	{
    	if (genericTypingKVProperty != null) return genericTypingKVProperty;
    	if (getParentEntity() != null) {
