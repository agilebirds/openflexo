 ...
 * @author sylvain
 */
public class TestMerge extends TestCase { /* here */
	...
	private JavaClass test(File aFile)
	{
		...
		/*for (Method method : type.getMethods()) {
			logger.info(">>>>>> "+method);
			logger.info("PrettyPrintedContent:"+testJava.getOriginalRepresentation(method));
	...
	public String test4 (String param1, long aParamAddedToLeft)
	{
		foo();
	}
	
	public String test5 (String param1, long aParamAddedToLeft)
	{
		foo2();
	}
