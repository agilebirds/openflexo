...
public class KeyValueLibrary {
    ...
    private static Hashtable<Type,Hashtable<String,KeyValueProperty>> properties
    = new Hashtable<Type, Hashtable<String,KeyValueProperty>>();
    
    private static Hashtable<Type,Vector<KeyValueProperty>> declaredKeyValueProperties
    = new Hashtable<Type, Vector<KeyValueProperty>>();
    
    private static Hashtable<Type,Vector<MethodDefinition>> declaredMethods
    = new Hashtable<Type, Vector<MethodDefinition>>();
    
    private static Hashtable<Type,Vector<KeyValueProperty>> accessibleKeyValueProperties
    = new Hashtable<Type, Vector<KeyValueProperty>>();
    
    private static Hashtable<Type,Vector<MethodDefinition>> accessibleMethods
    = new Hashtable<Type, Vector<MethodDefinition>>();
    ...
    private static Vector<KeyValueProperty> searchForProperties(Type declaringTypeType, boolean includesGetOnlyProperties, Vector<String> excludedSignatures)
    {
    ...
    private static boolean containsAPropertyNamed(Vector<KeyValueProperty> properties, String aName)
    {
     ...
     private static KeyValueProperty makeProperty(Type declaringType, Method method, boolean includesGetOnlyProperties, Vector<String> excludedSignatures)
    {
