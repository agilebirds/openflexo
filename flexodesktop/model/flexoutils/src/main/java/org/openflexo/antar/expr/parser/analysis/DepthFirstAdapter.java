...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inABasicTypeReference(ABasicTypeReference node)
    {
        defaultIn(node);
    }

    public void outABasicTypeReference(ABasicTypeReference node)
    {
        defaultOut(node);
    }
    ...
    {
        inABasicTypeReference(node);
        if(node.getDollar() != null)
        {
            node.getDollar().apply(this);
        }
        if(node.getTypeReferencePath() != null)
        {
            node.getTypeReferencePath().apply(this);
        }
        outABasicTypeReference(node);
    }

    public void inAParameteredTypeReference(AParameteredTypeReference node)
    {
        defaultIn(node);
    }

    public void outAParameteredTypeReference(AParameteredTypeReference node)
    {
        defaultOut(node);
    }
    ...
    {
        inAParameteredTypeReference(node);
        if(node.getDollar() != null)
        {
            node.getDollar().apply(this);
        }
        ...
        if(node.getTypeReferenceArgList() != null)
        {
            node.getTypeReferenceArgList().apply(this);
        }
        outAParameteredTypeReference(node);
    }

    public void inAIdentifierTypeReferencePath(AIdentifierTypeReferencePath node)
    {
        defaultIn(node);
    }

    public void outAIdentifierTypeReferencePath(AIdentifierTypeReferencePath node)
    {
        defaultOut(node);
    }
    ...
    {
        inAIdentifierTypeReferencePath(node);
        if(node.getIdentifier() != null)
        {
            node.getIdentifier().apply(this);
        }
        outAIdentifierTypeReferencePath(node);
    }

    public void inATailTypeReferencePath(ATailTypeReferencePath node)
    {
        defaultIn(node);
    }

    public void outATailTypeReferencePath(ATailTypeReferencePath node)
    {
        defaultOut(node);
    }
    ...
    public void caseATailTypeReferencePath(ATailTypeReferencePath node)
    {
        ...
        outATailTypeReferencePath(node);
    }

    public void inATypeReferenceArgList(ATypeReferenceArgList node)
    {
        defaultIn(node);
    }

    public void outATypeReferenceArgList(ATypeReferenceArgList node)
    {
        defaultOut(node);
    }
    ...
    {
        inATypeReferenceArgList(node);
        if(node.getLt() != null)
        {
            node.getLt().apply(this);
        }
        if(node.getTypeReference() != null)
        {
            node.getTypeReference().apply(this);
        }
        {
            List<PTypeReferenceAdditionalArg> copy = new ArrayList<PTypeReferenceAdditionalArg>(node.getTypeReferenceAdditionalArgs());
            for(PTypeReferenceAdditionalArg e : copy)
            {
                e.apply(this);
            }
        }
        ...
        outATypeReferenceArgList(node);
    }

    public void inATypeReferenceAdditionalArg(ATypeReferenceAdditionalArg node)
    {
        defaultIn(node);
    }

    public void outATypeReferenceAdditionalArg(ATypeReferenceAdditionalArg node)
    {
        defaultOut(node);
    }
    ...
    {
        inATypeReferenceAdditionalArg(node);
        ...
        outATypeReferenceAdditionalArg(node);
    }
