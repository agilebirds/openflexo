...
public class DefaultMergedDocumentType implements MergedDocumentType 
{
	...
	public DefaultMergedDocumentType(
			DelimitingMethod delimitingMethod,
	...
	public static final MergedDocumentType LINES = new DefaultMergedDocumentType(
			DelimitingMethod.LINES,
			null,
			new DefaultAutomaticMergeResolvingModel()); 

	public static final MergedDocumentType DEFAULT = new DefaultMergedDocumentType(
			DelimitingMethod.DEFAULT,
			null,
			new DefaultAutomaticMergeResolvingModel()); 

	public static final MergedDocumentType JAVA = new DefaultMergedDocumentType(
...
/*	public static final DefaultAutomaticMergeResolvingModel xmlAMRM
	...
	public static final MergedDocumentType HTML = new DefaultMergedDocumentType(
			DelimitingMethod.HTML,
			TokenMarkerStyle.HTML,
			new DefaultAutomaticMergeResolvingModel()); 

	public static final MergedDocumentType PLIST = new DefaultMergedDocumentType(
			DelimitingMethod.PLIST,
			TokenMarkerStyle.WOD,
			new DefaultAutomaticMergeResolvingModel()); 

	public static final MergedDocumentType TEX = new DefaultMergedDocumentType(
			DelimitingMethod.TEX,
			TokenMarkerStyle.TeX,
			new DefaultAutomaticMergeResolvingModel()); 

	public static final MergedDocumentType SQL = new DefaultMergedDocumentType(
			DelimitingMethod.SQL,
			TokenMarkerStyle.TSQL,
			new DefaultAutomaticMergeResolvingModel() {
				@Override
