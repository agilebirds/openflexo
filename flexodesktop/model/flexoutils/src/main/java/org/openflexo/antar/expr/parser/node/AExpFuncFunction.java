...
public final class AExpFuncFunction extends PFunction {
	...
	public AExpFuncFunction(@SuppressWarnings("hiding") TExp _exp_, @SuppressWarnings("hiding") TLPar _lPar_,
	...
	@Override
	public Object clone() {
		return new AExpFuncFunction(cloneNode(this._exp_), cloneNode(this._lPar_), cloneNode(this._expr2_), cloneNode(this._rPar_));
	}
	...
	public String toString() {
		return "" + toString(this._exp_) + toString(this._lPar_) + toString(this._expr2_) + toString(this._rPar_);
	}
