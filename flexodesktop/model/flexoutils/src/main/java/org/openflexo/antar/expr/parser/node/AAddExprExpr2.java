...
public final class AAddExprExpr2 extends PExpr2 {
	...
	public AAddExprExpr2(@SuppressWarnings("hiding") PExpr2 _left_, @SuppressWarnings("hiding") TPlus _plus_,
	...
	@Override
	public Object clone() {
		return new AAddExprExpr2(cloneNode(this._left_), cloneNode(this._plus_), cloneNode(this._right_));
	}
