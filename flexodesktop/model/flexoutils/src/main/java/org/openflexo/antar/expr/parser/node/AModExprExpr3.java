...
public final class AModExprExpr3 extends PExpr3 {
	...
	public AModExprExpr3(@SuppressWarnings("hiding") PExpr3 _left_, @SuppressWarnings("hiding") TMod _mod_,
	...
	@Override
	public Object clone() {
		return new AModExprExpr3(cloneNode(this._left_), cloneNode(this._mod_), cloneNode(this._right_));
	}
	...
	public String toString() {
		return "" + toString(this._left_) + toString(this._mod_) + toString(this._right_);
	}
