...
public interface Analysis extends Switch
{
    ...
    void caseABasicTypeReference(ABasicTypeReference node);
    void caseAParameteredTypeReference(AParameteredTypeReference node);
    void caseAIdentifierTypeReferencePath(AIdentifierTypeReferencePath node);
    void caseATailTypeReferencePath(ATailTypeReferencePath node);
    void caseATypeReferenceArgList(ATypeReferenceArgList node);
    void caseATypeReferenceAdditionalArg(ATypeReferenceAdditionalArg node);
