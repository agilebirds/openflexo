...
public final class ASubExprExpr2 extends PExpr2 {
	private PExpr2 _left_;
	private TMinus _minus_;
	private PExpr3 _right_;

	public ASubExprExpr2() {
		// Constructor
	}

	public ASubExprExpr2(@SuppressWarnings("hiding") PExpr2 _left_, @SuppressWarnings("hiding") TMinus _minus_,
	...
	@Override
	public Object clone() {
		return new ASubExprExpr2(cloneNode(this._left_), cloneNode(this._minus_), cloneNode(this._right_));
	}

	@Override
	public void apply(Switch sw) {
		((Analysis) sw).caseASubExprExpr2(this);
	}
