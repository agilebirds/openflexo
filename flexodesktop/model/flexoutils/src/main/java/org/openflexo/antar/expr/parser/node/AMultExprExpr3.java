...
public final class AMultExprExpr3 extends PExpr3 {
	private PExpr3 _left_;
	private TMult _mult_;
	private PTerm _right_;

	public AMultExprExpr3() {
		// Constructor
	}

	public AMultExprExpr3(@SuppressWarnings("hiding") PExpr3 _left_, @SuppressWarnings("hiding") TMult _mult_,
	...
	@Override
	public Object clone() {
		return new AMultExprExpr3(cloneNode(this._left_), cloneNode(this._mult_), cloneNode(this._right_));
	}

	@Override
	public void apply(Switch sw) {
		((Analysis) sw).caseAMultExprExpr3(this);
	}
