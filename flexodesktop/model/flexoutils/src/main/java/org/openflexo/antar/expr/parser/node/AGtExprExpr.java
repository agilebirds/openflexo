...
public final class AGtExprExpr extends PExpr {
	...
	public AGtExprExpr(@SuppressWarnings("hiding") PExpr _left_, @SuppressWarnings("hiding") TGt _gt_,
	...
	@Override
	public Object clone() {
		return new AGtExprExpr(cloneNode(this._left_), cloneNode(this._gt_), cloneNode(this._right_));
	}

	@Override
	public void apply(Switch sw) {
		((Analysis) sw).caseAGtExprExpr(this);
	}
