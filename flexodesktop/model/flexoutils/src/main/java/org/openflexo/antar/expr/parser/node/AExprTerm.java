...
public final class AExprTerm extends PTerm {
	...
	public AExprTerm(@SuppressWarnings("hiding") TLPar _lPar_, @SuppressWarnings("hiding") PExpr _expr_,
	...
	@Override
	public Object clone() {
		return new AExprTerm(cloneNode(this._lPar_), cloneNode(this._expr_), cloneNode(this._rPar_));
	}
