...
public class ManualTesting {
	 ...
	 */
	public static void main(String[] args) throws NoSuchAlgorithmException, PPMWebServiceAuthentificationException, RemoteException,
			ServiceException {
		String encriptedPWD = getMd5Hash("wstest");
		String login = "wstest";
		PPMWebServiceClient ws = new PPMWebServiceClient(
				"http://BenMacBook.local:3301/Flexo/WebObjects/DNLServerApplication.woa/ws/PPMWebService", login, encriptedPWD);
