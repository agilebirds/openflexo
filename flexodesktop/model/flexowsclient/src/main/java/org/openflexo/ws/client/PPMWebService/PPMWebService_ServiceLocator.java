...
public class PPMWebService_ServiceLocator extends org.apache.axis.client.Service implements
		org.openflexo.ws.client.PPMWebService.PPMWebService_Service {
	...
	public org.openflexo.ws.client.PPMWebService.PPMWebService_PortType getPPMWebService(java.net.URL portAddress)
		...
		try {
			org.openflexo.ws.client.PPMWebService.PPMWebServiceSoapBindingStub _stub = new org.openflexo.ws.client.PPMWebService.PPMWebServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (org.openflexo.ws.client.PPMWebService.PPMWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
				org.openflexo.ws.client.PPMWebService.PPMWebServiceSoapBindingStub _stub = new org.openflexo.ws.client.PPMWebService.PPMWebServiceSoapBindingStub(
						new java.net.URL(PPMWebService_address), this);
				_stub.setPortName(getPPMWebServiceWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://BenMacBook.local:3001/cgi-bin/WebObjects/DNLServerApplication.woa/ws/PPMWebService",
				"PPMWebService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://BenMacBook.local:3001/cgi-bin/WebObjects/DNLServerApplication.woa/ws/PPMWebService", "PPMWebService"));
		}
