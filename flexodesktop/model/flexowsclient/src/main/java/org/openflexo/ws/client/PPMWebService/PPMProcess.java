...
public class PPMProcess extends PPMObject implements java.io.Serializable {
    ...
    public PPMProcess(
           ...
           org.openflexo.ws.client.PPMWebService.PPMProcess parentProcess,
           byte[] screenshoot,
           org.openflexo.ws.client.PPMWebService.PPMProcess[] subProcesses,
           java.lang.String technicalDescription,
           java.lang.String uri,
           java.lang.String userManualDescription,
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PPMProcess)) return false;
	...
	public synchronized int hashCode() {
        ...
        if (getScreenshoot() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getScreenshoot());
                 i++) {
        ...
        if (getSubProcesses() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSubProcesses());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PPMProcess.class, true);
