...
public class InspectorInspector extends InspectorController {

	private static final Logger logger = FlexoLogger.getLogger(InspectorInspector.class.getPackage().getName());

	private InspectorWindow window;
	
	public InspectorInspector()
	{
		super(null,null);
		logger.info("Load inspectors...");
		try {
			importInspectorFile(new FileResource("Inspectors/Inspector.inspector"));
