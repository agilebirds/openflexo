...
public class JavaCodeWidget extends DenaliWidget<String>
{
    ...
    {
        widgetUpdating = true;
        if (logger.isLoggable(Level.FINE)) logger.fine("updateWidgetFromModel() in JavaCodeWidget with "+getStringValue());
    ...
    {
        modelUpdating = true;
        if (logger.isLoggable(Level.FINE)) logger.fine("updateModelFromWidget() in JavaCodeWidget with "+_textArea.getText());
