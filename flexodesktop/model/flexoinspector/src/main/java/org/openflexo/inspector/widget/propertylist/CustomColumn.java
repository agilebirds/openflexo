...
public abstract class CustomColumn extends AbstractColumn implements EditableColumn, ApplyCancelListener
{
    ...
    public CustomColumn(PropertyListColumn propertyListColumn, String title, int defaultWidth, boolean isResizable, AbstractController controller)
    {
        this(propertyListColumn, title, defaultWidth, isResizable, true, controller);
    }

    public CustomColumn(PropertyListColumn propertyListColumn, String title, int defaultWidth, boolean isResizable, boolean displayTitle, AbstractController controller)
    {
