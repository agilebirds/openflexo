 ...
 * Usage:
 * 
 * <property name="xxx" label="a_label" widget="LABEL"> ... <param name="displayLabel" value="true"/> <!-- Label will be displayed -->
 * <param name="expandHorizontally" value="true"/> <!-- Available horizontal space is "taken" by the dynamic component, when possible -->
 * <param name="expandVertically" value="true"/> <!-- Available vertical space is "taken" by the dynamic component, when possible --> <param
 * name="widgetLayout" value="2COL"/> <!-- 2COL means that label will be let left to the dynamic component, 1COL means that the label is
 * laid above dynamic component --> <param name="align" value="CENTER"/> <!-- horizontal alignment : LEFT / RIGHT / CENTER --> </property>
 * 
 * @author sguerin
 */
