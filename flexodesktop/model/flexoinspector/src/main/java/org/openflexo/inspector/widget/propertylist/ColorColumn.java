...
public abstract class ColorColumn extends AbstractColumn
{
    ...
    protected class ColorCellEditor extends AbstractCellEditor implements TableCellEditor,
                ...
                addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e)
                    {
                         if (inspectableObject != currentlyInspectedRow)
                            return;
                        // get the new color
                        Color selectedColor = JColorChooser.showDialog(ColorButton.this, FlexoLocalization
                                .localizedForKey("select_a_color"), getBackground());
