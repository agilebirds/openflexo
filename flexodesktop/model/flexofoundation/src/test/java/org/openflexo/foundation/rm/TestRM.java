...
public class TestRM extends FlexoTestCase {
	...
	/**
	 * Sets bloc2 in operation component 1 to be partial,
	 * Check resource dependancies
	 */
	...
	/**
	 * Use partial component in operation component 2
	 * Check resource dependancies
	 */
	...
	/**
	 * Reload project, check dependancies
	 * Assert all resources are not modified
	 */
	...
	/**
	 * Reload project again, but not the components yet, only load processes
	...
	/**
	 * Touch partial component
	 * Check that back-synchro are called and performed
	 */
	...
	/**
	 * Load project again
	 * Check that there is no more back-synchronization to be performed
	 */
	...
	/**
	 * Load project again
	 * Check that validation passes and does not throw exceptions
	 */
