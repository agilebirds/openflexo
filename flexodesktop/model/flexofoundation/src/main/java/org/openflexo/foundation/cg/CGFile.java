   ...
   /**
	...
	public String getFileName()
	{
		if ((getResource() != null) 
				...
				&& (getResource().getResourceFile().getFile() != null)) {
	...
	public void writeModifiedFile() throws SaveResourceException, FlexoException
    {
		...
		if (isMarkedForDeletion()) {
 			...
 			if(logger.isLoggable(Level.INFO)) {
				logger.info ("Write modified file: "+(getResource()!=null?(getResource().getFile()!=null?getResource().getFile().getAbsolutePath():"file is null"):"resource is null"));
			}
 			...
 			if (getResource().isForceRegenerate() || 
 				...
 				!getResource().doesGenerationKeepFileUnchanged() ||
 				!getResource().getFile().exists()) {
	...
	{
		if ((getResource() != null)
				&& (getResource().getGeneratedResourceData() != null)&& (getResource().getGeneratedResourceData() instanceof AbstractGeneratedFile)) {
	...
	/**
	 * Return flag indicating if this file has been explicitely marked as merged
	 * (in case of this file has merges). This flag is volontary non-persistent.
	 * 
	...
	/**
	 * Sets flag indicating if this file has been explicitely marked as merged
	 * (in case of this file has merges). This flag is volontary non-persistent.
	 */
	...
	{
		return ((getGenerationStatus() == GenerationStatus.ConflictingUnMerged)
				&& (getResource() != null)
	...
	{
		if ((getResource() != null)
				&& (getResource().getGeneratedResourceData() != null) && (getGeneratedResourceData() instanceof AbstractGeneratedFile)) {
            ((AbstractGeneratedFile)getGeneratedResourceData()).getHistory().storeCurrentFileInHistoryAs(newCGRelease.getVersionIdentifier());
			setChanged();
