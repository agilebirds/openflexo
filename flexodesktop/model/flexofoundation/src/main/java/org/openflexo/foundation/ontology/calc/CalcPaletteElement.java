...
public class CalcPaletteElement extends CalcObject {

	private static final Logger logger = Logger.getLogger(CalcPaletteElement.class.getPackage().getName());
	...
	private CalcPalette _palette;
	
	public CalcPaletteElement() 
	{
	...
	public void setPalette(CalcPalette palette) 
	{
		_palette = palette;
	}
