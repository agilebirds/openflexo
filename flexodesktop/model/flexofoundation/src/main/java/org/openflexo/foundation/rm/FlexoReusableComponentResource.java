...
public class FlexoReusableComponentResource extends FlexoComponentResource implements Serializable {
	...
	public FlexoReusableComponentResource(FlexoProject aProject, String aName, FlexoComponentLibraryResource clResource,
			...
			if (_componentDefinition == null) {
				...
				try {
					_componentDefinition = new ReusableComponentDefinition(getName(), getProject().getFlexoComponentLibrary(),
							rootFolder.getFolderTyped(FolderType.PARTIAL_COMPONENT_FOLDER), getProject());
