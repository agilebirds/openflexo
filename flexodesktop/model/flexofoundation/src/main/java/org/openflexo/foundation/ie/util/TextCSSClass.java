...
public enum TextCSSClass implements StringConvertable/*extends FlexoObject implements StringConvertable, ChoiceList, Serializable*/
{
	...
	BLOC_BODY_CONTENT ("DLBlockBodyContent",new Font("SansSerif", Font.PLAIN, 10)),
	BLOC_BODY_TITLE("DLBlockBodyTitle",new Font("SansSerif", Font.BOLD, 11)),
	BLOC_BODY_COMMENT("DLBlockBodyComment",new Font("SansSerif", Font.PLAIN, 9)),
	BLOC_BODY_EXTRA("DLBlockBodyExtra",new Font("SansSerif", Font.ITALIC, 10));
	...
	public static final StringEncoder.EnumerationConverter<TextCSSClass> textCSSClassConverter = new StringEncoder.EnumerationConverter<TextCSSClass>(TextCSSClass.class,"getName");
