...
public class DenaliFoundationRepository extends DMEORepository
{
     ...
     * @return
     */
    public static DenaliFoundationRepository createNewDenaliFoundationRepository(DMModel dmModel, File aDenaliFoundationDirectory) throws InvalidFileException
    {
     ...
     * @return
     */
    public static DenaliFoundationRepository createNewDenaliFoundationRepository(DMModel dmModel, File aDenaliFoundationDirectory, FlexoProgress progress) throws InvalidFileException
    {
        ...
        for (int i = 0; i < eoModelArray.length; i++) {
            ...
            try {
                ...
                if (logger.isLoggable(Level.WARNING))
                    logger.warning("Could not copy directory " + aDenaliFoundationDirectory.getAbsolutePath() + " to " + copiedDirectory.getAbsolutePath());
            } catch (Exception e) {
                e.printStackTrace();
            }
