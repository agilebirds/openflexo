...
public class FlexoTabComponentResource extends FlexoComponentResource
{
    ...
    public FlexoTabComponentResource(FlexoProject aProject, String aName, FlexoComponentLibraryResource clResource, FlexoProjectFile componentFile) throws InvalidFileNameException
    {
	...
	public TabComponentDefinition getComponentDefinition()
    {
        if (_componentDefinition == null) {
            ...
            if (_componentDefinition == null) {
                ...
                try {
                    _componentDefinition = new TabComponentDefinition(getName(), getProject().getFlexoComponentLibrary(), rootFolder, getProject(), false);
