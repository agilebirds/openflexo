...
public class IESequenceTR extends IESequence<ITableRow> implements ITableRow
{
    ...
    /**
     * Returns the number of column in this sequence. It will locate the first
     * TR in this sequence or subsequence and will return the number of TD's
     * that are located inside of it.
     * 
    ...
    /**
     * Returns wheter the specified td is located in this sequence (or one of
     * its subsequence), or not.
     * 
    ...
    /**
     * This method calls setTRRowIndex on each of its children. (Therefore, if
     * the child is a IESequenceTR, the call will be a recusrive call, if the
     * child is a IETRWidget, the currentIndex parameter will be set as its
     * yLocation and will be incremented.
     * 
     * @param currentIndex
     */
    @Override
    ...
    public IETRWidget getTRAtRow(int row)
    {
        ...
        while (en.hasMoreElements()) {
            ...
            if (tr instanceof IESequenceTR) {
            	...
            	retval = ((IESequenceTR)((ITableRowReusableWidget) tr).getRootObject()).getTRAtRow(row-((ITableRowReusableWidget) tr).getRowIndex());
                if (retval != null)
                    return retval;
            } else {
    ...
    /**
     * Returns the number of rows located within this sequence and all its
     * subsequence.
     * 
    ...
    /**
     * Returns all TR located in this sequence and all its subsequence.
     * Overrides getAllTR
