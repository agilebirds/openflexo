...
public class FlexoWorkflowResource extends FlexoXMLStorageResource<FlexoWorkflow> implements Serializable
{
    ...
    @Override
	public FlexoWorkflow performLoadResourceData(FlexoProgress progress, ProjectLoadingHandler loadingHandler) throws LoadXMLResourceException, FlexoFileNotFoundException, ProjectLoadingCancelledException, MalformedXMLException
    {
        ...
        for (Enumeration<FlexoProcessNode> e = workflow.allLocalProcessNodes(); e.hasMoreElements();) {
            ...
            if (next != null) {
                ...
                if (logger.isLoggable(Level.SEVERE))
                    logger.severe("No FlexoProcess linked with processsNode : '"+nextProcessNode.getName()+"' !!! Could not load process, removing process node !");
     ...
     * method implements conversion from v0.1 to v1.0
     * 
     * @param v1
     * @param v2
