...
public class ApplicationDGTemplateRepository extends CGTemplateRepository {

	private static final FileResource flexoTemplatesDirectory = new FileResource(FileCst.DOC_GENERATOR_TEMPLATES_REL_PATH);

	public ApplicationDGTemplateRepository(CGDocTemplates templates, Vector<TargetType> availableTargets)
	{
	...
	{
		return "DOC_APPLICATION_TEMPLATES";
	}
	...
	{
		return Inspectors.DG.DG_APPLICATION_TEMPLATE_REPOSITORY;
	}
