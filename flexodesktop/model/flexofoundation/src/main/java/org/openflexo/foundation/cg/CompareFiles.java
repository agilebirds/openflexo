...
public class CompareFiles extends FlexoGUIAction<CompareFiles, CGFile, CGFile> {
	...
	public static FlexoActionType<CompareFiles, CGFile, CGFile> actionType = new FlexoActionType<CompareFiles, CGFile, CGFile>(
		...
		@Override
		protected boolean isVisibleForSelection(CGFile object, Vector<CGFile> globalSelection) {
			return isEnabledForSelection(object, globalSelection);
		}

		@Override
		protected boolean isEnabledForSelection(CGFile object, Vector<CGFile> globalSelection) {
	...
	static {
		FlexoModelObject.addActionForClass(CompareFiles.actionType, CGFile.class);
	}
