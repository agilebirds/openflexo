 ...
 * 
 */
public abstract class DMPropertyImplementationType extends KVCFlexoObject implements StringConvertable, ChoiceList, Serializable {
	...
	public static final StringEncoder.Converter<DMPropertyImplementationType> propertyImplementationTypeConverter = new Converter<DMPropertyImplementationType>(
			DMPropertyImplementationType.class) {
