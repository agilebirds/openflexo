...
public class CreateDataProperty extends FlexoAction<CreateDataProperty, OntologyObject, OntologyObject> {
	...
	public static FlexoActionType<CreateDataProperty, OntologyObject, OntologyObject> actionType = new FlexoActionType<CreateDataProperty, OntologyObject, OntologyObject>(
