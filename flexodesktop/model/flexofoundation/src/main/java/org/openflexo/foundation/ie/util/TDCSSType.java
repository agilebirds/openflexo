...
/**
 * Represents type of a TD CSS (DL_LIST_CELL,DL_LIST_ROW_TITLE,DL_LIST_LAST_CELL)
 * 
 * @author sguerin
 * 
 */
public enum TDCSSType implements StringConvertable {
	...
	public static final StringEncoder.EnumerationConverter<TDCSSType> tdCSSTypeConverter = new StringEncoder.EnumerationConverter<TDCSSType>(
			TDCSSType.class, "getName");
