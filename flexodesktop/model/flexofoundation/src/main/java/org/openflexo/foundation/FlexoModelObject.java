...
import org.openflexo.foundation.ontology.calc.EditionPatternInspector;
...
public abstract class FlexoModelObject extends FlexoXMLSerializableObject implements FlexoActionnable
{
    ...
    public static void setCurrentUserIdentifier(String aUserIdentifier)
    {
        ...
        FlexoModelObject.currentUserIdentifier = aUserIdentifier;
    }
   ...
   /**
    ...
    public void undelete()
    {
        ...
        referencers = new Vector<FlexoModelObjectReference>();
        setChanged();
    	if (getProject() != null) getProject().notifyObjectCreated(this);
    }
    ...
    {
    	if (getProject() != null && !isDeserializing()) getProject().notifyObjectChanged(this);
    	super.setChanged();
    }
   ...
   public static class FlexoNameComparator<E extends FlexoModelObject> implements Comparator<E>
   {
	...
	{
		if (editionPatternId == null) return null;
		if (_editionPatternReferences == null) return null;
	...
	{
		if (editionPattern == null) return null;
		for (EditionPatternReference r : _editionPatternReferences) {
