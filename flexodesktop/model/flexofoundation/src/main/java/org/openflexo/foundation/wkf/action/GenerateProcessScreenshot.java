...
public class GenerateProcessScreenshot extends FlexoAction<GenerateProcessScreenshot, FlexoProcess, FlexoProcess>
{
    ...
    public static FlexoActionType<GenerateProcessScreenshot, FlexoProcess, FlexoProcess> actionType = new FlexoActionType<GenerateProcessScreenshot, FlexoProcess, FlexoProcess> ("generate_screenshot",FlexoActionType.docGroup,FlexoActionType.ADD_ACTION_TYPE) {
