...
public class JarLoader implements ImportedResourceData
{
    ...
    Hashtable jarEntriesForClassName = new Hashtable();
    ...
    {
    	if (_jarResource != null) return _jarResource.getJarRepository();
    ...
    private JarLoader(File aJarFile, ExternalRepository jarRepository, FlexoJarResource jarResource, FlexoProject project, FlexoProgress progress)
    {
        ...
        jarEntriesForClassName = new Hashtable();
    ...
    public Hashtable getContainedClasses()
    {
        return classes;
    }
    ...
    {
        return (Class)classes.get(aName);
    }
    ...
    private void loadJarFile(FlexoProgress progress)
    {
        ...
        int i=0;
        for (Enumeration en = jarEntriesForClassName.elements(); en.hasMoreElements();) {
            JarEntry entry = (JarEntry) en.nextElement();
    ...
    public class JarClassLoader extends ClassLoader
    {
        ...
        public Class<?> findClass(String className, boolean searchInAllJarsInProject)
        {
            ...
            if (tryToLookup != null) {
                ...
                JarEntry foundJar = (JarEntry) jarEntriesForClassName.get(className);
                if (foundJar != null) {
