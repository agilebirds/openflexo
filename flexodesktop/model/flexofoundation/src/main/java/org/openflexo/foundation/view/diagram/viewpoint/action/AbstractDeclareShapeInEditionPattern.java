		...
		if (isValid()) {
			...
			case CREATES_EDITION_PATTERN:
				if (getFocusedObject() instanceof ExampleDiagramShape) {
					ExampleDiagramShape exampleDiagramShape = (ExampleDiagramShape) getFocusedObject();

					VirtualModel.VirtualModelBuilder builder = new VirtualModel.VirtualModelBuilder(
							exampleDiagramShape.getViewPointLibrary(), exampleDiagramShape.getViewPoint(), exampleDiagramShape
