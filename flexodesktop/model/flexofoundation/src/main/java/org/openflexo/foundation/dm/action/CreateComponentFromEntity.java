...
public class CreateComponentFromEntity extends FlexoAction<CreateComponentFromEntity, DMEntity, DMEntity> 
{
    ...
    public static FlexoActionType<CreateComponentFromEntity,DMEntity,DMEntity> actionType = new FlexoActionType<CreateComponentFromEntity,DMEntity,DMEntity> (
    		"create_component_from_entity",
    		FlexoActionType.exportMenu,FlexoActionType.defaultGroup) {
        ...
        {
            return object!=null && (globalSelection==null || globalSelection.size()==0 || (globalSelection.size()==1 && globalSelection.firstElement()==object));
         }
    ...
    protected void doAction(Object context) throws FlexoException, ColumnIsNotEmpty, RowIsNotEmpty
    {
        ...
        AddComponent addComponent = AddComponent.actionType.makeNewEmbeddedAction(getFocusedObject().getProject().getFlexoComponentLibrary().getRootFolder(), null , this);
        ...
        DropIEElement dropBlock = DropIEElement.actionType.makeNewEmbeddedAction(addComponent.getNewComponent().getWOComponent(), null, this);
        ...
        for (int i = 0; i < getWidgets().size(); i++) {
            ...
            DropIEElement dropLabel = DropIEElement.actionType.makeNewEmbeddedAction(addComponent.getNewComponent().getWOComponent(), null, this);
            ...
            DropIEElement dropWidget = DropIEElement.actionType.makeNewEmbeddedAction(addComponent.getNewComponent().getWOComponent(), null, this);
