...
public class EditionPatternPropertyModel extends PropertyModel {
	...
	{
		if (label.equals("newProperty")) {
			System.out.println("data="+getData());
			System.out.println("inspector="+getInspector());
			if (getInspector() != null) System.out.println("property="+getInspector().getEditionPattern().getOntologyLibrary().getProperty(getData()));
		}
	...
	private Vector<String> availableWidgetValues = null;
	
	public Vector<String> getAvailableWidgetValues()
	{
		if (availableWidgetValues == null) {
			availableWidgetValues = new Vector<String>();
			availableWidgetValues.add(DenaliWidget.TEXT_FIELD); 
			availableWidgetValues.add(DenaliWidget.TEXT_AREA); 
			availableWidgetValues.add(DenaliWidget.CHECKBOX); 
			availableWidgetValues.add(DenaliWidget.DROPDOWN); 
			availableWidgetValues.add(DenaliWidget.INTEGER); 
		}
