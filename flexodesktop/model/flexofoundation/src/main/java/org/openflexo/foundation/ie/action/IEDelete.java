...
public class IEDelete extends FlexoUndoableAction<IEDelete, IEObject, IEObject>
{
    ...
    public static FlexoActionType<IEDelete, IEObject, IEObject> actionType = new FlexoActionType<IEDelete, IEObject, IEObject>("delete", FlexoActionType.editGroup, FlexoActionType.DELETE_ACTION_TYPE) {
        ...
        {
            return ((object != null) || ((globalSelection != null) && (globalSelection.size() > 0))) && !((object instanceof IESequenceTopComponent) && !((IESequenceTopComponent)object).isSubsequence());
        }
