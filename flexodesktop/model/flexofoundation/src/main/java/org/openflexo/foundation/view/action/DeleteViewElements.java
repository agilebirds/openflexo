...
public class DeleteViewElements extends FlexoUndoableAction<DeleteViewElements,ViewElement,ViewElement>
{
    ...
    public static FlexoActionType<DeleteViewElements,ViewElement,ViewElement> actionType 
    = new FlexoActionType<DeleteViewElements,ViewElement,ViewElement>(
    ...
    private void addAllEmbeddedObjects(ViewElement o, Vector<ViewElement> v)
    {
    	...
    	for (ViewObject child : o.getChilds()) {
    		if (child instanceof ViewElement) addAllEmbeddedObjects((ViewElement)child,v);
    	}
    }
