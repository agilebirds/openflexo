...
public abstract class ObjectPropertyStatementPathElement<T> extends StatementPathElement<T>
{
	...
	public static ObjectPropertyStatementPathElement makeObjectPropertyStatementPathElement(BindingPathElement aParent, OntologyObjectProperty anOntologyProperty)
	{
	...
	public static class ObjectPropertyStatementAccessingLiteralPathElement extends ObjectPropertyStatementPathElement<Literal>
	{
		...
		public ObjectPropertyStatementAccessingLiteralPathElement(BindingPathElement aParent, OntologyObjectProperty anOntologyProperty) 
		{
			...
			asStringProperty = new SimpleBindingPathElementImpl<String>("asString",Literal.class,String.class,true,"string_value_for_literal") {
				@Override
				public String getBindingValue(Object target, BindingEvaluationContext context) 
				{
			...
			asBooleanProperty = new SimpleBindingPathElementImpl<Boolean>("asBoolean",Literal.class,Boolean.class,true,"boolean_value_for_literal") {
				@Override
			...
			asIntegerProperty = new SimpleBindingPathElementImpl<Integer>("asInteger",Literal.class,Integer.class,true,"int_value_for_literal") {
				@Override
			...
			asShortProperty = new SimpleBindingPathElementImpl<Short>("asShort",Literal.class,Short.class,true,"short_value_for_literal") {
				@Override
			...
			asCharProperty = new SimpleBindingPathElementImpl<Character>("asChar",Literal.class,Character.class,true,"char_value_for_literal") {
				@Override
			...
			asFloatProperty = new SimpleBindingPathElementImpl<Float>("asFloat",Literal.class,Float.class,true,"float_value_for_literal") {
				@Override
			...
			asDoubleProperty = new SimpleBindingPathElementImpl<Double>("asDouble",Literal.class,Double.class,true,"string_value_for_literal") {
				@Override
		...
		public Literal getBindingValue(Object target, BindingEvaluationContext context) 
		{
			if (target instanceof OntologyIndividual) {
				OntologyIndividual individual = (OntologyIndividual)target;
				PropertyStatement statement = individual.getPropertyStatement(getOntologyProperty());
				if (statement != null) return statement.getLiteral();
				return null;
			}
			else {
				logger.warning("Unexpected target "+target+" while evaluateBinding()");
