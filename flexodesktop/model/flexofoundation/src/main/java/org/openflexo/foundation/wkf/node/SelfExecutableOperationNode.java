 ...
 *
 */
public final class SelfExecutableOperationNode extends OperationNode implements SelfExecutableNode
{

    @SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(SelfExecutableOperationNode.class.getPackage().getName());

    /**
     * Constructor used during deserialization
     */
    public SelfExecutableOperationNode(FlexoProcessBuilder builder)
    {
     ...
     * Default constructor
     */
    public SelfExecutableOperationNode(FlexoProcess process)
    {
        super(process);
    ...
    {
        return Inspectors.WKF.SELF_EXECUTABLE_OPERATION_INSPECTOR;
    }
	...
	private OperationPetriGraph _executionPetriGraph = null;
	...
	@Override
	public OperationPetriGraph getExecutionPetriGraph() 
	{
		return _executionPetriGraph;
	}

	public void setExecutionPetriGraph(OperationPetriGraph executionPetriGraph) 
	{
