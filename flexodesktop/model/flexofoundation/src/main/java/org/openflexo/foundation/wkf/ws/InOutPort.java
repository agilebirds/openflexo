...
/**
 * Input/output data port associated to a PortRegistery associated to a
 * SubProcessNode This kind of port is used to modelize synchronous call.
 *
 * @author sguerin
 *
 */
public final class InOutPort extends AbstractInPort implements OutputPort
{
    ...
    public static class InOutPortMustBeLinkedToAtLeastAnActivityNode extends ValidationRule<InOutPortMustBeLinkedToAtLeastAnActivityNode, InOutPort>
    {
        ...
        public ValidationIssue<InOutPortMustBeLinkedToAtLeastAnActivityNode, InOutPort> applyValidation(InOutPort port)
        {
            if (!port.isCorrectelyLinked()) {
                ...
                if (invalidEdges.size() == 0) {
                    error = new ValidationWarning<InOutPortMustBeLinkedToAtLeastAnActivityNode, InOutPort>(this, port, "port_has_no_outgoing_edges");
                } else {
                    error = new ValidationWarning<InOutPortMustBeLinkedToAtLeastAnActivityNode, InOutPort>(this, port, "port_has_invalid_outgoing_edges");
