...
/**
 * This class intented to be root class for all objects representing data (in
 * the context of Model/View/Controller scheme) in Flexo<br>
 * Instances if this class implements Key/Value-coding and wrapers String values
 * to some objects of Flexo Foundation
 * 
 * @author sguerin
 */
public abstract class FlexoObject extends KVCObject
{
