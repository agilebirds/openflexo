...
public class LOOPOperator extends CommonOutputOperatorNode {
	 ...
	 */
	public LOOPOperator(FlexoProcessBuilder builder)
	{
	 ...
	 * Default constructor
	 */
	public LOOPOperator(FlexoProcess process)
	{
		super(process);
	}
	...
	public String getDefaultName() {
		return FlexoLocalization.localizedForKey("LOOP");
	}

	@Override
	public String getInspectorName()
	{
		return Inspectors.WKF.OPERATOR_LOOP_INSPECTOR;
	}

	private FlexoPetriGraph _executionPetriGraph = null;
	...
	public void setExecutionPetriGraph(FlexoPetriGraph executionPetriGraph)
	{
