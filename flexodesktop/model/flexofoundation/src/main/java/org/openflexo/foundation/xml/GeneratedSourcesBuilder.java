 ...
 * @author bmangez
 */
public class GeneratedSourcesBuilder extends FlexoBuilder<FlexoGeneratedOutputResource<GeneratedSources>> {
	...
	public GeneratedSourcesBuilder(FlexoGeneratedOutputResource<GeneratedSources> resource) {
		super(resource);
	}
