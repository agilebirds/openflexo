...
/**
 * <p>Stores all the information needed to create a new {@link ModelSlot}.
 * </br>Provides a {@link #Create()} method to do so.
 * 
 * @author Luka Le Roux
 *
 */
public class ModelSlotParameters extends AbstractModelSlot <FlexoOntology> {
	...
	/**
	 * <p>Creates a new ModelSlotParameters object with default values.
	 * </br>Note both name and meta-model don't have default values.
	 */
	...
	/**
	 * <p>Check if both the name and the meta-model aren't null.
	 * 
	 * @return a boolean
	 */
	...
	/**
	 * <p>The created {@link ModelSlot} will match the provided {@link TechnologicalSpace} and other parameters.
	 * </br>It will return null if some parameters are still missing.
	 * 
