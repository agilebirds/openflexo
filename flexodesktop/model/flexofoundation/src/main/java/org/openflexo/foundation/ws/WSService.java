...
public abstract class WSService extends WSObject implements FlexoObserver
	{
	    ...
	    private static final Logger logger = FlexoLogger.getLogger(WSService.class.getPackage()
	            .getName());
	  ...
	  */  
	    ...
	    public WSPortType addServiceInterfaceAsPortType(ServiceInterface serviceInterface) throws FlexoException
	    {
		    ...
		    if (getWSLibrary().getParentOfServiceInterface(serviceInterface)!=null){
	    	   		throw new InvalidArgumentException("This serviceInterface "+serviceInterface.getName()+" is already used in a WSService","ws_service_interface_already_used_in_a_ws_service");
		    }
		...
		public void delete(){
	    		...
	    		//remove wsdl file ?
	    		if(wsdlFile!=null&&wsdlFile.getFile()!=null)FileUtils.recursiveDeleteFile(getWSDLFile().getFile());
	    		wsdlFile=null;
