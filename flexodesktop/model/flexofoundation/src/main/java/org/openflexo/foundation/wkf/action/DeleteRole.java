...
public class DeleteRole extends FlexoAction<DeleteRole,Role,WorkflowModelObject> 
{
    ...
    public static FlexoActionType<DeleteRole,Role,WorkflowModelObject>  actionType 
    = new FlexoActionType<DeleteRole,Role,WorkflowModelObject> (
    		"delete_role",
	...
	protected void doAction(Object context)
    {
     ...
     public Vector<Role> getRoleToDelete()
     {
         ...
         if (!roleToDelete.contains(getFocusedObject())) roleToDelete.add(getFocusedObject());
         return roleToDelete;
    }
