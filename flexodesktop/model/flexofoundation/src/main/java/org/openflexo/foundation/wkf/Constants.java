...
public class Constants
{
    ...
    /**
     * Default size in pixel for a FlexoNode It should be an odd number so that
     * we get a proper centre
     */
    public static final int FLEXONODE_SIZE = 49;

    /**
     * A gap between the drawing area (including precondition) and the edge of
     * the flexo node
     */
    ...
    /**
     * The distance from the edge of the node's circle to the centre of a
     * precondition
     */
    public static final int FLEXOPRECONDITION_OFFSET = 1;

    /**
     * The radius of a precondition It should be an odd number so that we get a
     * proper centre
     */
    ...
    /**
     * The distance from the flexnode drawing area (excluding precondition) and
     * the edge of the flexo node
     */
     ...
     */
    public static final int FLEXONODE_OUTER_RADIUS = (FLEXONODE_SIZE / 2) - (FLEXOPRECONDITION_RADIUS + FLEXOPRECONDITION_OFFSET + FLEXONODE_BORDER);
