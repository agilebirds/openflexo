...
public class GeneratorUtils
{
     ...
     * @param name
     * @return a java name ( starts with a minuscule, and no blanks, dot,...,
    ...
    public static String getJavascriptComment(String comment)
    {
        ...
        return ToolBox.replaceStringByStringInString("\r", " ", ToolBox.replaceStringByStringInString("\n", " ", ToolBox
                .replaceStringByStringInString("\"", " ", ToolBox.replaceStringByStringInString("'", " ", comment))));
    }
    ...
    public static String getJavascriptComment2(String comment)
    {
        if (comment == null)
            return null;
        return ToolBox.replaceStringByStringInString("\r", " ", ToolBox.replaceStringByStringInString("\n", " ", ToolBox
                .replaceStringByStringInString("\"", " ", comment)));
    }
    ...
    public static String evaluateConditions(String value, Map replacement)
    {
        ...
        if (condBegin != -1) {
            ...
            String conditionKey = value.substring(condBegin + condBeginString.length(), value.indexOf(")", condBegin
                    + condBeginString.length()));
    ...
    /**
     * 
     * Remove the code generator comments. A code generator comment is a line
     * starting with ##.
     * 
     * @param template
    ...
    public static String getHiddenValueAccessorName(OperationNode targetNode, ActionNode startNode){
    	return ToolBox.getJavaName(new StringBuffer(targetNode.getName()).append("_FROM_").append(startNode.getName()).append("_").append(startNode.getFlexoID()));
    }
