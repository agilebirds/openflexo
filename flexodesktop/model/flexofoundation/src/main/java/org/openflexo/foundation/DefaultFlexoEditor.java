...
public class DefaultFlexoEditor implements FlexoEditor {
	...
	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerFinalizerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionFinalizer<? super A> finalizer) {
		_finalizers.put(actionType, finalizer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerInitializerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionInitializer<? super A> initializer) {
		_initializers.put(actionType, initializer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerUndoFinalizerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionUndoFinalizer<? super A> undoFinalizer) {
		_undoFinalizers.put(actionType, undoFinalizer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerUndoInitializerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionUndoInitializer<? super A> undoInitializer) {
		_undoInitializers.put(actionType, undoInitializer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerRedoFinalizerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionRedoFinalizer<? super A> redoFinalizer) {
		_redoFinalizers.put(actionType, redoFinalizer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerRedoInitializerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionRedoInitializer<? super A> redoInitializer) {
		_redoInitializers.put(actionType, redoInitializer);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerEnableConditionFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionEnableCondition<? super A, T1, T2> enableCondition) {
		_enableConditions.put(actionType, enableCondition);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerVisibleConditionFor(
			FlexoActionType<A, T1, T2> actionType, FlexoActionVisibleCondition<? super A, T1, T2> visibleCondition) {
		_visibleConditions.put(actionType, visibleCondition);
	}

	public <A extends FlexoAction<?, T1, T2>, T1 extends FlexoModelObject, T2 extends FlexoModelObject> void registerExceptionHandlerFor(
			FlexoActionType<A, T1, T2> actionType, FlexoExceptionHandler<? super A> exceptionHandler) {
