...
public static abstract  class AddEditionPatternInstanceParameterImpl extends EditionSchemeObjectImpl implements AddEditionPatternInstanceParameter
{
	...
	public Object evaluateParameterValue(EditionSchemeAction action) {
		if (getValue() == null || getValue().isUnset()) {
			...
			AddEditionPatternInstance.logger.warning("Invalid binding: " + getValue() + " Reason: " + getValue().invalidBindingReason());
		}
		return null;
	}
