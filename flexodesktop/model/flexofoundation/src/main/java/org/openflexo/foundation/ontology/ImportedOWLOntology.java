...
public class ImportedOWLOntology extends OWLOntology implements ImportedOntology {
	...
	private static final Logger logger = Logger.getLogger(ImportedOWLOntology.class.getPackage().getName());

	public ImportedOWLOntology(String anURI, File owlFile, OntologyLibrary library) {
	...
	public static ImportedOWLOntology createNewImportedOntology(String anURI, File owlFile, OntologyLibrary library) {
		ImportedOWLOntology returned = new ImportedOWLOntology(anURI, owlFile, library);
