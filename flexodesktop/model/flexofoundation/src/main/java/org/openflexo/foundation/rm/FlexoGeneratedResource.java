...
public abstract class FlexoGeneratedResource<GRD extends GeneratedResourceData> extends FlexoFileResource<GRD> {
	 ...
	 * 
	 * The date to be considered for generated resources are typically the date when this resource was generated for the last time.
	 * 
	...
	/**
	 * Calling this ensure that generated resource is up-to-date. If re-genereration was necessary, if is performed. If this case, return
	 * true
	 * 
	...
	/**
	 * Calling this assume that when returning, generated resource will be up-to-date. Regenerate or not depending on dependancies computing
	 * 
