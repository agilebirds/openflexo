...
public final class DataImporterLoader
{
    ...
    /**
     * Return supplied data importer, or null if such a data importer
     * was not found
     * @param aDataImporter
     * @return
     */
            ...
            try{
                ...
                if(dataImporter instanceof DataImporter){
                    ...
                    if(logger.isLoggable(Level.WARNING)){
                        logger.warning("Data importer :"+candidate+" cannot be loaded because it doesn't implements org.openflexo.dataimporter.DataImporter.");
                    }
                }
            } catch(Exception e) {
