...
public class IESequenceTab extends IESequence<ITabWidget> implements IETopComponent, ButtonedWidgetInterface, ITabWidget
{
     ...
     * 
     * @see org.openflexo.foundation.ie.widget.IESequence#insertElementAt(org.openflexo.foundation.ie.widget.IWidget,
     *      int)
     */
    @Override
    public void insertElementAt(ITabWidget o, int i)
    {
        ...
        if (o instanceof IETabWidget) {
        	...
        	for(OperationNode opNode : getComponentDefinition().getAllOperationNodesLinkedToThisComponent())
        		((IETabWidget)o).getTabComponentDefinition().getComponentDMEntity().addOrUpdateAccessingBusinessDataMethod(opNode.getProcess());
    ...
    public void removeFromInnerWidgets(ITabWidget w, boolean deleteIfEmpty)
    {
        ...
        if (w instanceof IETabWidget) {
        	...
        	for(OperationComponentInstance operationComponentInstance : ((IETabWidget) w).getTabComponentDefinition().getAllOperationComponentInstances())
        	{
        		if(operationComponentInstance.getComponentDefinition() != getComponentDefinition())
        		{
        			for(OperationNode opNode : operationComponentInstance.getComponentDefinition().getAllOperationNodesLinkedToThisComponent())
