...
public class DMPackage extends DMObject
{
    ...
    {
        if (getName().equals(DEFAULT_PACKAGE_NAME)) return FlexoLocalization.localizedForKey(getName());
        return getName();
    }
    ...
    /**
     * Return all the entities contained in this package, as a Vector of
     * DMEntity
     *
    ...
    public void delete()
    {
        ...
        if (getRepository() != null) getRepository().deletePackage(this);
        name = null;
        repository = null;
        entities.clear();
        entities = null;
    ...
    public String getRelativePath()
    {
        ...
        if (this == getRepository().getDefaultPackage()) return "";
