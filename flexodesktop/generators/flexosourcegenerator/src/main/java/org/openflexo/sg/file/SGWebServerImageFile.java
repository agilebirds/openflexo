...
public class SGWebServerImageFile extends AbstractCGFile {

	public SGWebServerImageFile(GeneratedSourcesBuilder builder) {
		super(builder.generatedSources);
	}

	public SGWebServerImageFile(GeneratedSources generatedSources) {
		super(generatedSources);
	}

	public SGWebServerImageFile(SourceRepository repository, CGRepositoryFileResource resource) {
