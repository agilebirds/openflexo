 ...
 * 
 */
public class TabComponentJavaFileResource extends ComponentJavaFileResource<TabComponentGenerator> implements TabComponentFileResource {
	protected static final Logger logger = FlexoLogger.getLogger(TabComponentJavaFileResource.class.getPackage().getName());
	 ...
	 * @param builder
	 */
	public TabComponentJavaFileResource(FlexoProjectBuilder builder) {
		super(builder);
	}
	 ...
	 * @param aProject
	 */
	public TabComponentJavaFileResource(FlexoProject aProject) {
		super(aProject);
	}
