...
public class UtilsGenerator extends MetaGenerator<FlexoModelObject, CGRepository>
{
	...
	public UtilsGenerator(ProjectGenerator projectGenerator)
    {
        ...
        if(projectGenerator!=null && projectGenerator.getTarget()==CodeType.PROTOTYPE && !projectGenerator.getRepository().includeReader())
	...
	public void buildResourcesAndSetGenerators(CGRepository repository, Vector<CGRepositoryFileResource> resources) 
    {
    	...
    	if(projectGenerator!=null && projectGenerator.getTarget()==CodeType.PROTOTYPE && !projectGenerator.getRepository().includeReader() && helpPopupGenerator!=null)
