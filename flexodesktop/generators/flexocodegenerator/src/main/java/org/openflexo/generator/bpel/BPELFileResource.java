 ...
 * 
 */
public class BPELFileResource extends TextFileResource<BPELFileGenerator, CGTextFile> implements GenerationAvailableFileResource, FlexoObserver
{
   ...
   /**
     ...
     * BPEL file depends of DataModel and all processes
     */
    @Override
