...
public class BPELXSDFileGenerator extends MetaFileGenerator
{
    ...
    {
        super(projectGenerator,FileFormat.XSD,ResourceType.XSD,ToolBox.cleanStringForJava(projectGenerator.getProject().getProjectName())+".xsd",IDENTIFIER+"_"+ToolBox.cleanStringForJava(projectGenerator.getProject().getProjectName()));
    }
	...
	public void generate(boolean forceRegenerate)
    {
    	...
    	try {
    		...
    		if (generatedXSD==null) {
    			throw new GenerationException("The Web Service Definition could not be created. Check the Interface Definition of your Flexo Process");
    		}
	...
	{
    	xsdFileResource = (BPELXSDFileResource)resourceForKeyWithCGFile(ResourceType.WSDL, BPELXSDFileResource.nameForRepositoryAndIdentifier(repository, getIdentifier()));
