...
public class BPELWSDLFileGenerator extends MetaFileGenerator
{
    ...
    {
        super(projectGenerator,FileFormat.WSDL,ResourceType.WSDL,ToolBox.cleanStringForJava(webService.getName())+".wsdl",IDENTIFIER+"_"+ToolBox.cleanStringForJava(webService.getName()));
	...
	{
    	wsdlFileResource = (BPELWSDLFileResource)resourceForKeyWithCGFile(ResourceType.WSDL, BPELWSDLFileResource.nameForRepositoryAndIdentifier(repository, getIdentifier()));
