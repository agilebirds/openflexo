...
public class OverrideWithVersion extends MultipleFileGCAction<OverrideWithVersion>
{
	...
	public static class OverrideWithVersionActionType extends MultipleFileGCActionType<OverrideWithVersion>
	{
		...
		protected OverrideWithVersionActionType (
		...
		protected boolean accept (AbstractCGFile file)
		 {
			 if ((file == null) || (file.getResource() == null)) return false;
	...
	public static final OverrideWithVersionActionType overrideWithPureGeneration = new OverrideWithVersionActionType("override_with_pure_generation",ContentSourceType.PureGeneration);
	public static final OverrideWithVersionActionType overrideWithGeneratedMerge = new OverrideWithVersionActionType("override_with_generated_merge",ContentSourceType.GeneratedMerge);
	public static final OverrideWithVersionActionType overrideWithLastGenerated = new OverrideWithVersionActionType("override_with_last_generated_version",ContentSourceType.LastGenerated);
	public static final OverrideWithVersionActionType overrideWithLastAccepted = new OverrideWithVersionActionType("override_with_last_accepted_version",ContentSourceType.LastAccepted);
...
*/
	OverrideWithVersion (OverrideWithVersionActionType actionType, CGObject focusedObject, Vector<CGObject> globalSelection, FlexoEditor editor)
	{
