...
public abstract class AbstractProjectGenerator<R extends GenerationRepository> extends MetaGenerator<FlexoProject, R> {
	...
	{
        if ((dataModification.propertyName() != null && (dataModification.propertyName().equals("targetType")||dataModification.propertyName().equals("docType"))))
...
//     We validate the dkv model
	 ...
	 * 
	 * @param resources the resources which will be generated
	 */
