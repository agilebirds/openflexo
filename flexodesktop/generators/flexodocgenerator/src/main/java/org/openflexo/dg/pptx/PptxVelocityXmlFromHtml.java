...
public class PptxVelocityXmlFromHtml {

	protected static final Logger logger = FlexoLogger.getLogger(PptxVelocityXmlFromHtml.class.getPackage().getName());
	...
	public PptxVelocityXmlFromHtml(String htmlString, int currentUniqueId, boolean isWithinP, ProjectDocPptxGenerator projectDocxGenerator) {
		if (htmlString != null) {
			Html2PptxVelocityXmlParserCallback callback = new Html2PptxVelocityXmlParserCallback(currentUniqueId, isWithinP,
	...
	private static class Html2PptxVelocityXmlParserCallback extends HTMLEditorKit.ParserCallback {
		...
		private ProjectDocPptxGenerator projectDocxGenerator;

		public Html2PptxVelocityXmlParserCallback(int currentUniqueId, boolean isWithinP, ProjectDocPptxGenerator projectPptxGenerator) {
			super();
