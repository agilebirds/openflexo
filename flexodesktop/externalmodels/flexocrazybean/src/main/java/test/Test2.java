...
/**
 * Create sources for the university model. Also create <a href= "http://barat.sourceforge.net/">Barat</A> class sources from model. In the
 * latter example it shows how to subclass the Generator and Factory in order to adapt them to the behaviour you want.
 * 
...
public class Test2 {
	public static void main(String[] args) throws Exception {
		 ...
		 */
		PetalFile tree = PetalParser.createParser(".." + File.separatorChar + "examples" + File.separatorChar + "uni.mdl").parse();
		 ...
		 */
		tree = PetalParser.createParser(".." + File.separatorChar + "examples" + File.separatorChar + "Barat.mdl").parse();
		Factory f = new Factory() {
			@Override
			public void addAssociation(cb.generator.Class class1, Role role1, cb.generator.Class class2, Role role2,
