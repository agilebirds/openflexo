...
/**
 * Convert Rose file into XMI format. You'll need to install <a href="http://nsuml.sourceforge.net/">NSUML</a> to run this example. It also
 * shows how to reduce memory consumption by omitting certain nodes when parsing the petal file.
 * 
...
public class Test4 {
	public static void main(String[] args) throws Exception {
		...
		parser.setIgnoredNodes(new Class[] { cb.petal.Diagram.class, cb.petal.View.class });
