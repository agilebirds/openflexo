...
public void visit(cb.petal.Class obj){
  ...
  public static String getSuperClassLabel(cb.petal.Class obj){
      ...
      if(superClasses==null || superClasses.getChildCount()==0)return "";
      if(superClasses.getChildCount()>1)return "MoreThanOne";
...
public void visit(Association obj){
      ...
      if(roleList!=null && roleList.getChildCount()>0){
          if(roleList.getChildCount()==2){
              ...
              System.out.println("Relationship : "+getLabel(role1)+"("+getSupplierShortName(role2)+(isRole1ToOne?"-->":"-->>")+getSupplierShortName(role1)+")");
              System.out.println("Relationship : "+getLabel(role2)+"("+getSupplierShortName(role1)+(isRole2ToOne?"-->":"-->>")+getSupplierShortName(role2)+")");
