...
/**
 * Represents ClassDiagram object contained within a LogicalCategory object. Items to the view can be added with the addToView() methods
 * which call init() on the given Petal Object after adding them to the items list.
 * 
...
public class ClassDiagram extends Diagram {
	...
	private static HashSet set = new HashSet(Arrays.asList(new java.lang.Object[] { ClassView.class }));
	...
	/**
	 * Classes and the according views must have been added to the model already. Sets tag as well as client and supplier tags.
	 */
	...
	/**
	 * Class and interface and the according views must have been added to the model already. Sets tag as well as client and supplier tags.
	 */
