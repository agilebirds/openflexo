...
/**
 * Visitor interface. The problem with this is that we may find further petal objects in future versions which must be added then. So it's
 * safer to inherit from EmptyVisitor or DescendingVisitor, because all methods are garantueed to be implemented.
 * 
