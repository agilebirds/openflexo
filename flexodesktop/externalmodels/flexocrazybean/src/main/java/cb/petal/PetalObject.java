...
public abstract class PetalObject implements PetalNode {
  ...
  /**
   * @param parent node in the petal tree, either another PetalObject or PetalFile
   * @param name of the object, e.g., "ClassCategory"
   * @param params list of parameters, e.g., "Class" "Logical View::templates::Class"
   */
...
public java.lang.Object clone() {
  ...
  public void      setParent(PetalNode p) { parent = p; }
  public PetalNode getParent()            { return parent; }
  @Override
public String    getKind()              { return "object"; }
   ...
   */
  public int getNoProperties() { return names.size(); }

  /** @return number of properties
   */
  @Override
public int getChildCount() { return names.size(); }
  ...
  /**
   * Get fully qualified name for an object that must implement the Named interface
