...
public void init() {
  ...
  public void    isAssociationClass(boolean i) { isAssociationClass = i; }

  public boolean isAssociationClass()          { return isAssociationClass; }
  ...
  public RealizeRelationship addImplementedInterface(Class inter) {
    RealizeRelationship rel =
      PetalObjectFactory.getInstance().createRealizeRelationship(this, inter);
  ...
  public UsesRelationship addUsedClass(Class inter) {
    UsesRelationship rel =
      PetalObjectFactory.getInstance().createUsesRelationship(this, inter);
  ...
  /** @return list of associations related to this class if any. this requires that the
