 ...
 * 
 * @version $Id: Literal.java,v 1.3 2011/09/12 11:46:48 gpolet Exp $
...
public abstract class Literal implements PetalNode {
	...
	/**
	 * @return object corresponding to the usual Java hierarchy, e.g., an Integer for an IntegerLiteral.
	 */
