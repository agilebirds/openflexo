...
public abstract class Diagram extends QuidObject implements Named {
	...
	/**
	 * Add a association view to the presentation view, set location and tags and call init(). Automatically adds AssocAttachView, if the
	 * association has an association class.
	 */
	...
	private void setupLabels(SegLabeled view) {
		...
		for (Iterator i = ((PetalObject) view).getProperties("label").iterator(); i.hasNext();) {
