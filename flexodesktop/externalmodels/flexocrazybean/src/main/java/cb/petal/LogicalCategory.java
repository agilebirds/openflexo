...
/**
 * The Logical category contains class diagrams. The interesting part are the two lists "logical_models" and "logical_presentations" where
 * the former contains the data model and the latter contains class diagrams. One can add items to the model with addToModel() methods.
 * Items to the view can be added with the addToView() methods in ClassDiagram. Both types of methods call init() on the given Petal Object
 * after adding them to the appropriate list.
 * 
