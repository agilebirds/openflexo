...
public class RMAutomergeInitializer {
	...
	protected static final XMLAutomaticMergeResolvingRule MAX_LAST_UNIQUE_ID_SELECTING = new XMLAutomaticMergeResolvingRule() {
		@Override
	...
	protected static final XMLAutomaticMergeResolvingRule IGNORE_RESOURCES_COUNT = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
			int leftValue = getLeftIntAttributeValue(change);
			int rightValue = getRightIntAttributeValue(change);
	...
	protected static final XMLAutomaticMergeResolvingRule OLDEST_LAST_IMPORT_DATE = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
	...
	protected static final XMLAutomaticMergeResolvingRule OLDEST_LAST_GENERATION_DATE = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
	...
	protected static final XMLAutomaticMergeResolvingRule OLDEST_LAST_ACCEPTING_DATE = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
	...
	protected static final XMLAutomaticMergeResolvingRule OLDEST_LAST_GENERATION_CHECKED_DATE = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
	...
	protected static final XMLAutomaticMergeResolvingRule OLDEST_LAST_MODEL_REINJECTING_DATE = new XMLAutomaticMergeResolvingRule() {
		@Override
		public String getMergedResult(MergeChange change) {
	...
	public static void initialize() {
		DefaultAutomaticMergeResolvingModel rmxmlAutomergeModel = new FlexoAutomaticMergeResolvingModel();
		...
		ResourceType.RM
				.setMergedDocumentType(new DefaultMergedDocumentType(DelimitingMethod.XML, TokenMarkerStyle.XML, rmxmlAutomergeModel));
