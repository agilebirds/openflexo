...
public abstract class FPSTestCase extends FlexoTestCase  {
	...
	public static FlexoEditor createFPSProject(String projectName)
	{
		...
		DropWKFElement dropSubProcessNode = DropWKFElement.actionType.makeNewAction(_rootProcessResource.getFlexoProcess().getActivityPetriGraph(), null, editor);
		...
		SetAndOpenOperationComponent setOperationComponent = SetAndOpenOperationComponent.actionType.makeNewAction(_operationNode, null, editor);
		...
		DropWKFElement addActivity = DropWKFElement.actionType.makeNewAction(_subProcessResource.getFlexoProcess().getActivityPetriGraph(), null, editor);
		...
		= SetAndOpenOperationComponent.actionType.makeNewAction(operationNode2, null, editor);
		...
		= SetAndOpenOperationComponent.actionType.makeNewAction(operationNode3, null, editor);
