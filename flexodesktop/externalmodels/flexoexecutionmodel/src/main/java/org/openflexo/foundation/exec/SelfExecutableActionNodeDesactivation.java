...
public class SelfExecutableActionNodeDesactivation extends NodeDesactivation<SelfExecutableActionNode> {

	public SelfExecutableActionNodeDesactivation(SelfExecutableActionNode node)
	{
		super(node);
	}
