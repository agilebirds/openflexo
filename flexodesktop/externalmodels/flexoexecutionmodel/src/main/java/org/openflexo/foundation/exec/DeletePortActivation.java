...
public class DeletePortActivation extends PortActivation<DeletePort> {

	protected DeletePortActivation(DeletePort port) {
		super(port);
	}

	@Override
	protected String getProcedureName() {
		return "deleteProcessInstance"+getPort().getFlexoID();
	}
