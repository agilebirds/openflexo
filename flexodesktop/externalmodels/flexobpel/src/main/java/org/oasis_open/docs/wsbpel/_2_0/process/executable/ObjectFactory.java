 ...
 * org.oasis_open.docs.wsbpel._2_0.process.executable package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _CorrelationSets_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"correlationSets");
	...
	private final static QName _MessageExchanges_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"messageExchanges");
	...
	private final static QName _FinalCounterValue_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"finalCounterValue");
	...
	private final static QName _CompletionCondition_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"completionCondition");
	...
	private final static QName _ExtensionActivity_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"extensionActivity");
	...
	private final static QName _CompensationHandler_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"compensationHandler");
	private final static QName _Assign_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable", "assign");
	private final static QName _CompensateScope_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"compensateScope");
	...
	private final static QName _CorrelationSet_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"correlationSet");
	private final static QName _ExtensionAssignOperation_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
	...
	private final static QName _StartCounterValue_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"startCounterValue");
	...
	private final static QName _TerminationHandler_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"terminationHandler");
	private final static QName _MessageExchange_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"messageExchange");
	...
	private final static QName _TransitionCondition_QNAME = new QName("http://docs.oasis-open.org/wsbpel/2.0/process/executable",
			"transitionCondition");
	 ...
	 * org.oasis_open.docs.wsbpel._2_0.process.executable
	 * 
	 */
