...
@XmlType(name = "tActivityContainer", propOrder = { "assign", "compensate", "compensateScope", "empty", "exit", "extensionActivity",
		"flow", "forEach", "_if", "invoke", "pick", "receive", "repeatUntil", "reply", "rethrow", "scope", "sequence", "_throw",
		"validate", "wait", "_while" })
@XmlSeeAlso({ TCatch.class })
public class TActivityContainer extends TExtensibleElements {
