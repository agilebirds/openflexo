 ...
 *         &lt;element ref="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}compensationHandler" minOccurs="0"/>
 *         &lt;element ref="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}terminationHandler" minOccurs="0"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="isolated" type="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}tBoolean" default="no" />
 *       &lt;attribute name="exitOnStandardFault" type="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}tBoolean" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "tScope", propOrder = { "partnerLinks", "messageExchanges", "variables", "correlationSets", "faultHandlers",
		"compensationHandler", "terminationHandler", "eventHandlers", "assign", "compensate", "compensateScope", "empty", "exit",
		"extensionActivity", "flow", "forEach", "_if", "invoke", "pick", "receive", "repeatUntil", "reply", "rethrow", "scope", "sequence",
		"_throw", "validate", "wait", "_while", "opaqueActivity" })
public class TScope extends TActivity {
