 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}tOnMsgCommon">
 *       &lt;sequence>
...
@XmlType(name = "tOnMessage", propOrder = { "assign", "compensate", "compensateScope", "empty", "exit", "extensionActivity", "flow",
		"forEach", "_if", "invoke", "pick", "receive", "repeatUntil", "reply", "rethrow", "scope", "sequence", "_throw", "validate",
		"wait", "_while", "opaqueActivity" })
public class TOnMessage extends TOnMsgCommon {
