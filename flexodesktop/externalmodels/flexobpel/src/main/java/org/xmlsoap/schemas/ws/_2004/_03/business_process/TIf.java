 ...
 *         &lt;element ref="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}elseif" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://schemas.xmlsoap.org/ws/2004/03/business-process/}else" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "tIf", propOrder = { "condition", "assign", "compensate", "compensateScope", "empty", "exit", "extensionActivity", "flow",
		...
		"wait", "_while", "opaqueActivity", "elseif", "_else" })
