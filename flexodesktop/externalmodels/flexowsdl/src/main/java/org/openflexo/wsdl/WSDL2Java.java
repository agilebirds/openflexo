...
/**
 * inspired from Jeff Hanson which copy-pasted method from XmlBeans' SchemaCompiler
 * Modified with more options from the original class (for example, more params (for download import)
 *
 * @author <a href="mailto:jeff@jeffhanson.com">Jeff Hanson</a>
 *          <p/>
 *          <p><b>Revisions:</b>
 *          <p/>
 *          <p><b>Aug 3, 2005 jhanson:</b>
 *          <ul>
 *          <li> Created file.
 *          </ul>
 */
...
*/
       ...
       */
	   ...
	   SchemaTypeSystem stsi= loadTypeSystem(name, xsdFiles, wsdlFiles, urlFiles, configFiles, javaFiles, cpResourceLoader, download,noUpa,noPvr, noAnn,noVDoc,mdefNamespaces,baseDir,sourcesToCopyMap,outerErrorListener,
			   schemasDir, entityResolver, classpath,javasource);
    ...
    * @return
    */
   public List generate(String schemaFilesDir,
                        String schemaClassesDir,
                        String schemaSrcDir,
                        String wsdlFileName)
   {
...
/**
   ...
   private SchemaTypeSystem compileSchemas(String schemaFilesDir,
