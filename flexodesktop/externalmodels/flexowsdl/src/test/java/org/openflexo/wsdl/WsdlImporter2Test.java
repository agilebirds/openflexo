...
//		    
//		    
//		   XmlObject[] schemaArray =  new XmlObject[]{ XmlObject.Factory.parse(new File("/Users/dvanvyve/Documents/Projects/FlexoWS/soapEncoding.xml")) };
//		   
//		    
//		
...
//			        	      String attributeType = XMLTypeMapper.getFullJavaNameForType(prop.getType());//getJavaTypeForBuiltInType(prop.getType().getPrimitiveType().getBuiltinTypeCode());
