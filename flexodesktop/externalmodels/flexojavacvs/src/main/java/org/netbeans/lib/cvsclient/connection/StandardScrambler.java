...
/**
 * Scrambles text (the password) using the standard scheme described in the CVS protocol version 1.10. This encoding is trivial and should
 * not be used for security, but rather as a mechanism for avoiding inadvertant compromise.
 * 
 * @author Robert Greig
 */
	...
	public String scramble(String text) {
		...
		if (text != null) {
			for (int i = 0; i < text.length(); ++i) {
				...
				byte newCh = (byte) (shifts[ch & 255] & 255);
