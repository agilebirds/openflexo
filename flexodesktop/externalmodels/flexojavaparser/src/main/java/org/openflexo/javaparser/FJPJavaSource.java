...
public class FJPJavaSource extends FJPJavaElement
{
	...
	/**
	 * Implementation of hashCode() method for JavaMethod in QDox library is unexpectedally
	 * very very slow. Consequence of that was that managing hashtable structures with
	 * JavaMethod keys was a very bad idea and resulted to very poor performances.
	 * I replaced this by a String key, obtained by following computing, and used in hashtable
	 * structures
	 * 
	 * @param entity
	 * @return
