...
public class AntRunner implements BuildListener
{
    ...
    public static void initAndRunTask(AntRunner runner, String buildXmlPath, String runDirPath, HashMap m, String target, Vector<BuildListener> listeners) throws Exception
    {
        if (m == null)
            m = new HashMap();
