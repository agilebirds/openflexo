 ...
 *
 */
package org.openflexo.tm.daoimpl.impl;
...
/**
 * This class defines properties related to a Daoimpl implementation.
 */
public class DaoimplImplementation extends TechnologyModuleImplementation {

    public static final String TECHNOLOGY_MODULE_NAME = "Daoimpl";
    ...
    /**
      * Build a new Daoimpl implementation for the specified implementation model builder.<br/>
      ...
      */
    public DaoimplImplementation(ImplementationModelBuilder builder) throws TechnologyModuleCompatibilityCheckException {
        this(builder.implementationModel);
        initializeDeserialization(builder);
    }

    /**
      * Build a new Daoimpl implementation for the specified implementation model.
      *
      * @param implementationModel
      *            the implementation model where to create this Daoimpl implementation
      * @throws TechnologyModuleCompatibilityCheckException
      */
    public DaoimplImplementation(ImplementationModel implementationModel) throws TechnologyModuleCompatibilityCheckException {
