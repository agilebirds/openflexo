...
import org.openflexo.tm.persistence.gui.controller.HibernateModelController;
...
public class HibernateModelView extends FIBModuleView<HibernateModel> {
	...
	public static String HIBERNATE_MODEL_VIEW_FIB_RESOURCE_PATH = "/Persistence/Fib/ModelView.fib";
