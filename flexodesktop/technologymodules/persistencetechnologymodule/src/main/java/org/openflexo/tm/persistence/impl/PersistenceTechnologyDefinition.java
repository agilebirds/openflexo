 ...
 *
 */
public class PersistenceTechnologyDefinition extends TechnologyModuleDefinition {
    ...
    public TechnologyModuleImplementation createNewImplementation(ImplementationModel implementationModel)
        ...
        return new PersistenceImplementation(implementationModel);
    }
    ...
    protected void loadModule() throws TechnologyModuleInitializationException {
        super.loadModule();
        SGModule.recordTechnologyModuleGUIFactory(PersistenceImplementation.class, new PersistenceGUIFactory());
    }
}
