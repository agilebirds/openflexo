...
/**
 * This class defines properties related to a Persistence implementation.
 */
public class PersistenceImplementation extends TechnologyModuleImplementation {

    public static final String TECHNOLOGY_MODULE_NAME = "Persistence";
    ...
    /**
      * Build a new Persistence implementation for the specified implementation model builder.<br/>
      ...
      */
    public PersistenceImplementation(ImplementationModelBuilder builder) throws TechnologyModuleCompatibilityCheckException {
        this(builder.implementationModel);
        initializeDeserialization(builder);
    }

    /**
      * Build a new Persistence implementation for the specified implementation model.
      *
      * @param implementationModel
      *            the implementation model where to create this Persistence implementation
      * @throws TechnologyModuleCompatibilityCheckException
      */
    public PersistenceImplementation(ImplementationModel implementationModel) throws TechnologyModuleCompatibilityCheckException {
    ...
    public void delete() {
        ...
        setChanged();
        notifyObservers(new SGObjectDeletedModification<PersistenceImplementation>(this));
        super.delete();
        deleteObservers();
    }
    ...
    public void addToModels(HibernateModel model) {
        model.setPersistenceImplementation(this);
        models.add(model);
        Collections.sort(this.models, new FlexoModelObject.FlexoNameComparator<FlexoModelObject>());
        setChanged();
     ...
     */
    public static PersistenceImplementation getHibernateImplementation(ImplementationModel implementationModel) {
        return (PersistenceImplementation) implementationModel.getTechnologyModule(TECHNOLOGY_MODULE_NAME);
    }
}
