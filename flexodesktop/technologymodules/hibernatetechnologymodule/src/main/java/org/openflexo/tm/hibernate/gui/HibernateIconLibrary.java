...
public class HibernateIconLibrary {
	...
	public static final ImageIcon ENTITYAUTO_ICON = new ImageIcon(HibernateIconLibrary.class.getResource("/Hibernate/Icons/SmallEntityAuto.gif"));
	public static final ImageIcon ENTITYMANUAL_ICON = new ImageIcon(HibernateIconLibrary.class.getResource("/Hibernate/Icons/SmallEntityManual.gif"));
	...
	public static final ImageIcon ENUMAUTO_ICON = new ImageIcon(HibernateIconLibrary.class.getResource("/Hibernate/Icons/SmallEnumAuto.gif"));
	public static final ImageIcon ENUMMANUAL_ICON = new ImageIcon(HibernateIconLibrary.class.getResource("/Hibernate/Icons/SmallEnumManual.gif"));
