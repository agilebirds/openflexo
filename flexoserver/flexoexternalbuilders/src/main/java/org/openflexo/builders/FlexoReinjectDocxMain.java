	...
	protected void init(String[] args) throws MissingArgumentException
	{
		...
		if (docxFile == null)
		{
			...
			if (logger.isLoggable(Level.SEVERE)) {
				logger.severe("Missing argument. Usage java " + FlexoReinjectDocxMain.class.getName() + " " + RESOURCE_PATH_ARGUMENT_PREFIX + " " + DOCXFILE_ARGUMENT_PREFIX + " " + "\n" + (args.length > 0 ? sb.toString() : "No arguments !!!"));
			}
	...
	protected void run()
	{
		if (project != null)
		{
			...
			try
			{
				...
				sb.append("\n" + FlexoLocalization.localizedForKey("number_of_updated_description") + ": " + docxAction.getNumberOfDescriptionUpdated());
				sb.append("\n" + FlexoLocalization.localizedForKey("number_of_updated_name") + ": " + docxAction.getNumberOfNameUpdated());
				sb.append("\n" + FlexoLocalization.localizedForKey("number_of_updated_tocentry_title") + ": " + docxAction.getNumberOfTocEntryTitleUpdated());
				sb.append("\n" + FlexoLocalization.localizedForKey("number_of_updated_tocentry_content") + ": " + docxAction.getNumberOfTocEntryContentUpdated());
				sb.append("\n" + FlexoLocalization.localizedForKey("number_of_not_found_object") + ": " + docxAction.getNumberOfObjectNotFound());
